...
type SubscriptionUpdateSubscriptionRenewPreviewPostRequest struct {
	ctx context.Context
	ApiService *SubscriptionUpdateService
	unibeeApiMerchantSubscriptionRenewPreviewReq *UnibeeApiMerchantSubscriptionRenewPreviewReq
}

func (r SubscriptionUpdateSubscriptionRenewPreviewPostRequest) UnibeeApiMerchantSubscriptionRenewPreviewReq(unibeeApiMerchantSubscriptionRenewPreviewReq UnibeeApiMerchantSubscriptionRenewPreviewReq) SubscriptionUpdateSubscriptionRenewPreviewPostRequest {
	r.unibeeApiMerchantSubscriptionRenewPreviewReq = &unibeeApiMerchantSubscriptionRenewPreviewReq
	return r
}

func (r SubscriptionUpdateSubscriptionRenewPreviewPostRequest) Execute() (*MerchantSubscriptionRenewPreviewPost200Response, *http.Response, error) {
	return r.ApiService.SubscriptionRenewPreviewPostExecute(r)
}

/*
SubscriptionRenewPreviewPost Renew Subscription Preview

Preview renew invoice of an existing subscription.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return SubscriptionUpdateSubscriptionRenewPreviewPostRequest
*/
func (a *SubscriptionUpdateService) SubscriptionRenewPreviewPost(ctx context.Context) SubscriptionUpdateSubscriptionRenewPreviewPostRequest {
	return SubscriptionUpdateSubscriptionRenewPreviewPostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return MerchantSubscriptionRenewPreviewPost200Response
func (a *SubscriptionUpdateService) SubscriptionRenewPreviewPostExecute(r SubscriptionUpdateSubscriptionRenewPreviewPostRequest) (*MerchantSubscriptionRenewPreviewPost200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *MerchantSubscriptionRenewPreviewPost200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SubscriptionUpdateService.SubscriptionRenewPreviewPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/merchant/subscription/renew_preview"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.unibeeApiMerchantSubscriptionRenewPreviewReq == nil {
		return localVarReturnValue, nil, reportError("unibeeApiMerchantSubscriptionRenewPreviewReq is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.unibeeApiMerchantSubscriptionRenewPreviewReq
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
