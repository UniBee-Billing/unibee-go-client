...
func (r SubscriptionUpdateSubscriptionActiveTemporarilyPostRequest) Execute() (*MerchantAuthSsoLoginOTPPost200Response, *http.Response, error) {
...
func (a *SubscriptionUpdateService) SubscriptionActiveTemporarilyPostExecute(r SubscriptionUpdateSubscriptionActiveTemporarilyPostRequest) (*MerchantAuthSsoLoginOTPPost200Response, *http.Response, error) {
	var (
