...
// checks if the MerchantSubscriptionNewOnetimeAddonPreviewPost200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantSubscriptionNewOnetimeAddonPreviewPost200Response{}

// MerchantSubscriptionNewOnetimeAddonPreviewPost200Response struct for MerchantSubscriptionNewOnetimeAddonPreviewPost200Response
type MerchantSubscriptionNewOnetimeAddonPreviewPost200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantSubscriptionNewOnetimeAddonPreviewPost200ResponseData `json:"data,omitempty"`
...
func NewMerchantSubscriptionNewOnetimeAddonPreviewPost200Response() *MerchantSubscriptionNewOnetimeAddonPreviewPost200Response {
	this := MerchantSubscriptionNewOnetimeAddonPreviewPost200Response{}
	return &this
}
...
func (o *MerchantSubscriptionNewOnetimeAddonPreviewPost200Response) GetData() MerchantSubscriptionNewOnetimeAddonPreviewPost200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantSubscriptionNewOnetimeAddonPreviewPost200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantSubscriptionNewOnetimeAddonPreviewPost200ResponseData and assigns it to the Data field.
...
func (o *MerchantSubscriptionNewOnetimeAddonPreviewPost200Response) GetMerchantId() int64 {
...
// and a boolean to check if the value has been set.
func (o *MerchantSubscriptionNewOnetimeAddonPreviewPost200Response) GetMerchantIdOk() (*int64, bool) {
	if o == nil || IsNil(o.MerchantId) {
		return nil, false
	}
...
func (o *MerchantSubscriptionNewOnetimeAddonPreviewPost200Response) HasMerchantId() bool {
	if o != nil && !IsNil(o.MerchantId) {
		return true
	}
...
func (o *MerchantSubscriptionNewOnetimeAddonPreviewPost200Response) SetMerchantId(v int64) {
	o.MerchantId = &v
}
...
func (o MerchantSubscriptionNewOnetimeAddonPreviewPost200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantSubscriptionNewOnetimeAddonPreviewPost200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantSubscriptionNewOnetimeAddonPreviewPost200Response struct {
	value *MerchantSubscriptionNewOnetimeAddonPreviewPost200Response
	isSet bool
}

func (v NullableMerchantSubscriptionNewOnetimeAddonPreviewPost200Response) Get() *MerchantSubscriptionNewOnetimeAddonPreviewPost200Response {
	return v.value
}

func (v *NullableMerchantSubscriptionNewOnetimeAddonPreviewPost200Response) Set(val *MerchantSubscriptionNewOnetimeAddonPreviewPost200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantSubscriptionNewOnetimeAddonPreviewPost200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantSubscriptionNewOnetimeAddonPreviewPost200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantSubscriptionNewOnetimeAddonPreviewPost200Response(val *MerchantSubscriptionNewOnetimeAddonPreviewPost200Response) *NullableMerchantSubscriptionNewOnetimeAddonPreviewPost200Response {
	return &NullableMerchantSubscriptionNewOnetimeAddonPreviewPost200Response{value: val, isSet: true}
}

func (v NullableMerchantSubscriptionNewOnetimeAddonPreviewPost200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantSubscriptionNewOnetimeAddonPreviewPost200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
