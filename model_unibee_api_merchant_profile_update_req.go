...
type UnibeeApiMerchantProfileUpdateReq struct {
	...
	CompanyRegistryCode *string `json:"companyRegistryCode,omitempty"`
	// Country Vat Number
	...
	// Merchant default currency, empty string clears explicit setting
...
// GetCompanyRegistryCode returns the CompanyRegistryCode field value if set, zero value otherwise.
func (o *UnibeeApiMerchantProfileUpdateReq) GetCompanyRegistryCode() string {
	if o == nil || IsNil(o.CompanyRegistryCode) {
		var ret string
		return ret
	}
	return *o.CompanyRegistryCode
}

// GetCompanyRegistryCodeOk returns a tuple with the CompanyRegistryCode field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UnibeeApiMerchantProfileUpdateReq) GetCompanyRegistryCodeOk() (*string, bool) {
	if o == nil || IsNil(o.CompanyRegistryCode) {
		return nil, false
	}
	return o.CompanyRegistryCode, true
}
...
// SetCompanyRegistryCode gets a reference to the given string and assigns it to the CompanyRegistryCode field.
func (o *UnibeeApiMerchantProfileUpdateReq) SetCompanyRegistryCode(v string) {
	o.CompanyRegistryCode = &v
}

// GetCompanyVatNumber returns the CompanyVatNumber field value if set, zero value otherwise.
func (o *UnibeeApiMerchantProfileUpdateReq) GetCompanyVatNumber() string {
	if o == nil || IsNil(o.CompanyVatNumber) {
		var ret string
		return ret
	}
...
// GetCompanyVatNumberOk returns a tuple with the CompanyVatNumber field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetCompanyVatNumber gets a reference to the given string and assigns it to the CompanyVatNumber field.
...
func (o UnibeeApiMerchantProfileUpdateReq) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.CompanyRegistryCode) {
		toSerialize["companyRegistryCode"] = o.CompanyRegistryCode
	}
	if !IsNil(o.CompanyVatNumber) {
