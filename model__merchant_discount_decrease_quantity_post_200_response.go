...
// checks if the MerchantDiscountDecreaseQuantityPost200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantDiscountDecreaseQuantityPost200Response{}

// MerchantDiscountDecreaseQuantityPost200Response struct for MerchantDiscountDecreaseQuantityPost200Response
type MerchantDiscountDecreaseQuantityPost200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantDiscountDecreaseQuantityPost200ResponseData `json:"data,omitempty"`
...
func NewMerchantDiscountDecreaseQuantityPost200Response() *MerchantDiscountDecreaseQuantityPost200Response {
	this := MerchantDiscountDecreaseQuantityPost200Response{}
	return &this
}
...
func (o *MerchantDiscountDecreaseQuantityPost200Response) GetData() MerchantDiscountDecreaseQuantityPost200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantDiscountDecreaseQuantityPost200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantDiscountDecreaseQuantityPost200ResponseData and assigns it to the Data field.
...
func (o MerchantDiscountDecreaseQuantityPost200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantDiscountDecreaseQuantityPost200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantDiscountDecreaseQuantityPost200Response struct {
	value *MerchantDiscountDecreaseQuantityPost200Response
	isSet bool
}

func (v NullableMerchantDiscountDecreaseQuantityPost200Response) Get() *MerchantDiscountDecreaseQuantityPost200Response {
	return v.value
}

func (v *NullableMerchantDiscountDecreaseQuantityPost200Response) Set(val *MerchantDiscountDecreaseQuantityPost200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantDiscountDecreaseQuantityPost200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantDiscountDecreaseQuantityPost200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantDiscountDecreaseQuantityPost200Response(val *MerchantDiscountDecreaseQuantityPost200Response) *NullableMerchantDiscountDecreaseQuantityPost200Response {
	return &NullableMerchantDiscountDecreaseQuantityPost200Response{value: val, isSet: true}
}

func (v NullableMerchantDiscountDecreaseQuantityPost200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantDiscountDecreaseQuantityPost200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
