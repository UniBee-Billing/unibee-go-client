...
// checks if the MerchantVatVatNumberValidateHistoryPost200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantVatVatNumberValidateHistoryPost200Response{}

// MerchantVatVatNumberValidateHistoryPost200Response struct for MerchantVatVatNumberValidateHistoryPost200Response
type MerchantVatVatNumberValidateHistoryPost200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantVatVatNumberValidateHistoryPost200ResponseData `json:"data,omitempty"`
...
func NewMerchantVatVatNumberValidateHistoryPost200Response() *MerchantVatVatNumberValidateHistoryPost200Response {
	this := MerchantVatVatNumberValidateHistoryPost200Response{}
	return &this
}
...
func (o *MerchantVatVatNumberValidateHistoryPost200Response) GetData() MerchantVatVatNumberValidateHistoryPost200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantVatVatNumberValidateHistoryPost200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantVatVatNumberValidateHistoryPost200ResponseData and assigns it to the Data field.
...
func (o MerchantVatVatNumberValidateHistoryPost200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantVatVatNumberValidateHistoryPost200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantVatVatNumberValidateHistoryPost200Response struct {
	value *MerchantVatVatNumberValidateHistoryPost200Response
	isSet bool
}

func (v NullableMerchantVatVatNumberValidateHistoryPost200Response) Get() *MerchantVatVatNumberValidateHistoryPost200Response {
	return v.value
}

func (v *NullableMerchantVatVatNumberValidateHistoryPost200Response) Set(val *MerchantVatVatNumberValidateHistoryPost200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantVatVatNumberValidateHistoryPost200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantVatVatNumberValidateHistoryPost200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantVatVatNumberValidateHistoryPost200Response(val *MerchantVatVatNumberValidateHistoryPost200Response) *NullableMerchantVatVatNumberValidateHistoryPost200Response {
	return &NullableMerchantVatVatNumberValidateHistoryPost200Response{value: val, isSet: true}
}

func (v NullableMerchantVatVatNumberValidateHistoryPost200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantVatVatNumberValidateHistoryPost200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
