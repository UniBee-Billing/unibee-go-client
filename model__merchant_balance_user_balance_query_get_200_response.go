...
// checks if the MerchantBalanceUserBalanceQueryGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantBalanceUserBalanceQueryGet200Response{}

// MerchantBalanceUserBalanceQueryGet200Response struct for MerchantBalanceUserBalanceQueryGet200Response
type MerchantBalanceUserBalanceQueryGet200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantBalanceUserBalanceQueryGet200ResponseData `json:"data,omitempty"`
...
func NewMerchantBalanceUserBalanceQueryGet200Response() *MerchantBalanceUserBalanceQueryGet200Response {
	this := MerchantBalanceUserBalanceQueryGet200Response{}
	return &this
}
...
func (o *MerchantBalanceUserBalanceQueryGet200Response) GetData() MerchantBalanceUserBalanceQueryGet200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantBalanceUserBalanceQueryGet200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantBalanceUserBalanceQueryGet200ResponseData and assigns it to the Data field.
...
func (o MerchantBalanceUserBalanceQueryGet200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantBalanceUserBalanceQueryGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantBalanceUserBalanceQueryGet200Response struct {
	value *MerchantBalanceUserBalanceQueryGet200Response
	isSet bool
}

func (v NullableMerchantBalanceUserBalanceQueryGet200Response) Get() *MerchantBalanceUserBalanceQueryGet200Response {
	return v.value
}

func (v *NullableMerchantBalanceUserBalanceQueryGet200Response) Set(val *MerchantBalanceUserBalanceQueryGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantBalanceUserBalanceQueryGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantBalanceUserBalanceQueryGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantBalanceUserBalanceQueryGet200Response(val *MerchantBalanceUserBalanceQueryGet200Response) *NullableMerchantBalanceUserBalanceQueryGet200Response {
	return &NullableMerchantBalanceUserBalanceQueryGet200Response{value: val, isSet: true}
}

func (v NullableMerchantBalanceUserBalanceQueryGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantBalanceUserBalanceQueryGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
