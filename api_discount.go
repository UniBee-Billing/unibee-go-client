...
func (r DiscountDiscountActivatePostRequest) Execute() (*MerchantAuthSsoClearTotpPost200Response, *http.Response, error) {
	return r.ApiService.DiscountActivatePostExecute(r)
}

/*
DiscountActivatePost Activate Discount Code
...
func (a *DiscountService) DiscountActivatePostExecute(r DiscountDiscountActivatePostRequest) (*MerchantAuthSsoClearTotpPost200Response, *http.Response, error) {
	var (
...
func (r DiscountDiscountDeactivatePostRequest) Execute() (*MerchantAuthSsoClearTotpPost200Response, *http.Response, error) {
	return r.ApiService.DiscountDeactivatePostExecute(r)
}

/*
DiscountDeactivatePost Deactivate Discount Code
...
// Execute executes the request
//  @return MerchantAuthSsoClearTotpPost200Response
func (a *DiscountService) DiscountDeactivatePostExecute(r DiscountDiscountDeactivatePostRequest) (*MerchantAuthSsoClearTotpPost200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
type DiscountDiscountDecreaseQuantityPostRequest struct {
	ctx context.Context
	ApiService *DiscountService
	unibeeApiMerchantDiscountQuantityDecrementReq *UnibeeApiMerchantDiscountQuantityDecrementReq
}

func (r DiscountDiscountDecreaseQuantityPostRequest) UnibeeApiMerchantDiscountQuantityDecrementReq(unibeeApiMerchantDiscountQuantityDecrementReq UnibeeApiMerchantDiscountQuantityDecrementReq) DiscountDiscountDecreaseQuantityPostRequest {
	r.unibeeApiMerchantDiscountQuantityDecrementReq = &unibeeApiMerchantDiscountQuantityDecrementReq
	return r
}

func (r DiscountDiscountDecreaseQuantityPostRequest) Execute() (*MerchantDiscountDecreaseQuantityPost200Response, *http.Response, error) {
	return r.ApiService.DiscountDecreaseQuantityPostExecute(r)
}

/*
DiscountDecreaseQuantityPost Quantity Decrement
...
Decrease discount code quantity, the quantity after decreased should greater than 0, the action may disable quantity control if quantity decrease to 0 or lower than quantityUsed after decreased
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return DiscountDiscountDecreaseQuantityPostRequest
*/
func (a *DiscountService) DiscountDecreaseQuantityPost(ctx context.Context) DiscountDiscountDecreaseQuantityPostRequest {
	return DiscountDiscountDecreaseQuantityPostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *DiscountService) DiscountDecreaseQuantityPostExecute(r DiscountDiscountDecreaseQuantityPostRequest) (*MerchantDiscountDecreaseQuantityPost200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *MerchantDiscountDecreaseQuantityPost200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DiscountService.DiscountDecreaseQuantityPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/merchant/discount/decrease_quantity"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.unibeeApiMerchantDiscountQuantityDecrementReq == nil {
		return localVarReturnValue, nil, reportError("unibeeApiMerchantDiscountQuantityDecrementReq is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.unibeeApiMerchantDiscountQuantityDecrementReq
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
func (r DiscountDiscountDeletePostRequest) Execute() (*MerchantAuthSsoClearTotpPost200Response, *http.Response, error) {
	return r.ApiService.DiscountDeletePostExecute(r)
}

/*
DiscountDeletePost Delete Discount Code
...
// Execute executes the request
//  @return MerchantAuthSsoClearTotpPost200Response
func (a *DiscountService) DiscountDeletePostExecute(r DiscountDiscountDeletePostRequest) (*MerchantAuthSsoClearTotpPost200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
/*
DiscountDetailGet Get Merchant Discount Detail
...
/*
DiscountDetailPost Get Merchant Discount Detail
...
/*
DiscountEditPost Edit Discount Code
...
func (r DiscountDiscountListGetRequest) SearchKey(searchKey string) DiscountDiscountListGetRequest {
...
/*
DiscountListGet Get Discount Code List
...
/*
DiscountNewPost New Discount Code
...
type DiscountDiscountQuantityIncrementPostRequest struct {
	ctx context.Context
	ApiService *DiscountService
	unibeeApiMerchantDiscountQuantityIncrementReq *UnibeeApiMerchantDiscountQuantityIncrementReq
}

func (r DiscountDiscountQuantityIncrementPostRequest) UnibeeApiMerchantDiscountQuantityIncrementReq(unibeeApiMerchantDiscountQuantityIncrementReq UnibeeApiMerchantDiscountQuantityIncrementReq) DiscountDiscountQuantityIncrementPostRequest {
	r.unibeeApiMerchantDiscountQuantityIncrementReq = &unibeeApiMerchantDiscountQuantityIncrementReq
	return r
}

func (r DiscountDiscountQuantityIncrementPostRequest) Execute() (*MerchantDiscountDecreaseQuantityPost200Response, *http.Response, error) {
	return r.ApiService.DiscountQuantityIncrementPostExecute(r)
}

/*
DiscountQuantityIncrementPost Quantity Increment

Increase discount code quantity, if original quantity is 0, increase greater than 0 will enable quantity control

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return DiscountDiscountQuantityIncrementPostRequest
*/
func (a *DiscountService) DiscountQuantityIncrementPost(ctx context.Context) DiscountDiscountQuantityIncrementPostRequest {
	return DiscountDiscountQuantityIncrementPostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return MerchantDiscountDecreaseQuantityPost200Response
func (a *DiscountService) DiscountQuantityIncrementPostExecute(r DiscountDiscountQuantityIncrementPostRequest) (*MerchantDiscountDecreaseQuantityPost200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DiscountService.DiscountQuantityIncrementPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/merchant/discount/quantity_increment"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.unibeeApiMerchantDiscountQuantityIncrementReq == nil {
		return localVarReturnValue, nil, reportError("unibeeApiMerchantDiscountQuantityIncrementReq is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.unibeeApiMerchantDiscountQuantityIncrementReq
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
