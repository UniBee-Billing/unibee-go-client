...
func (r DiscountDiscountEditPostRequest) Execute() (*MerchantDiscountDetailGet200Response, *http.Response, error) {
...
// Execute executes the request
//  @return MerchantDiscountDetailGet200Response
func (a *DiscountService) DiscountEditPostExecute(r DiscountDiscountEditPostRequest) (*MerchantDiscountDetailGet200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r DiscountDiscountNewPostRequest) Execute() (*MerchantDiscountDetailGet200Response, *http.Response, error) {
...
// Execute executes the request
//  @return MerchantDiscountDetailGet200Response
func (a *DiscountService) DiscountNewPostExecute(r DiscountDiscountNewPostRequest) (*MerchantDiscountDetailGet200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
