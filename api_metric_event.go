...
func (r MetricEventMetricEventDeletePostRequest) Execute() (*MerchantAuthSsoLoginOTPPost200Response, *http.Response, error) {
...
func (a *MetricEventService) MetricEventDeletePostExecute(r MetricEventMetricEventDeletePostRequest) (*MerchantAuthSsoLoginOTPPost200Response, *http.Response, error) {
	var (
