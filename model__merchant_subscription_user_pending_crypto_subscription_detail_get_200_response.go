...
// checks if the MerchantSubscriptionUserPendingCryptoSubscriptionDetailGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantSubscriptionUserPendingCryptoSubscriptionDetailGet200Response{}

// MerchantSubscriptionUserPendingCryptoSubscriptionDetailGet200Response struct for MerchantSubscriptionUserPendingCryptoSubscriptionDetailGet200Response
type MerchantSubscriptionUserPendingCryptoSubscriptionDetailGet200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantSubscriptionUserPendingCryptoSubscriptionDetailGet200ResponseData `json:"data,omitempty"`
...
func NewMerchantSubscriptionUserPendingCryptoSubscriptionDetailGet200Response() *MerchantSubscriptionUserPendingCryptoSubscriptionDetailGet200Response {
	this := MerchantSubscriptionUserPendingCryptoSubscriptionDetailGet200Response{}
	return &this
}
...
func (o *MerchantSubscriptionUserPendingCryptoSubscriptionDetailGet200Response) GetData() MerchantSubscriptionUserPendingCryptoSubscriptionDetailGet200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantSubscriptionUserPendingCryptoSubscriptionDetailGet200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantSubscriptionUserPendingCryptoSubscriptionDetailGet200ResponseData and assigns it to the Data field.
...
func (o MerchantSubscriptionUserPendingCryptoSubscriptionDetailGet200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantSubscriptionUserPendingCryptoSubscriptionDetailGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantSubscriptionUserPendingCryptoSubscriptionDetailGet200Response struct {
	value *MerchantSubscriptionUserPendingCryptoSubscriptionDetailGet200Response
	isSet bool
}

func (v NullableMerchantSubscriptionUserPendingCryptoSubscriptionDetailGet200Response) Get() *MerchantSubscriptionUserPendingCryptoSubscriptionDetailGet200Response {
	return v.value
}

func (v *NullableMerchantSubscriptionUserPendingCryptoSubscriptionDetailGet200Response) Set(val *MerchantSubscriptionUserPendingCryptoSubscriptionDetailGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantSubscriptionUserPendingCryptoSubscriptionDetailGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantSubscriptionUserPendingCryptoSubscriptionDetailGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantSubscriptionUserPendingCryptoSubscriptionDetailGet200Response(val *MerchantSubscriptionUserPendingCryptoSubscriptionDetailGet200Response) *NullableMerchantSubscriptionUserPendingCryptoSubscriptionDetailGet200Response {
	return &NullableMerchantSubscriptionUserPendingCryptoSubscriptionDetailGet200Response{value: val, isSet: true}
}

func (v NullableMerchantSubscriptionUserPendingCryptoSubscriptionDetailGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantSubscriptionUserPendingCryptoSubscriptionDetailGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
