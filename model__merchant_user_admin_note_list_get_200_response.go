...
// checks if the MerchantUserAdminNoteListGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantUserAdminNoteListGet200Response{}

// MerchantUserAdminNoteListGet200Response struct for MerchantUserAdminNoteListGet200Response
type MerchantUserAdminNoteListGet200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantUserAdminNoteListGet200ResponseData `json:"data,omitempty"`
...
func NewMerchantUserAdminNoteListGet200Response() *MerchantUserAdminNoteListGet200Response {
	this := MerchantUserAdminNoteListGet200Response{}
	return &this
}
...
func (o *MerchantUserAdminNoteListGet200Response) GetData() MerchantUserAdminNoteListGet200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantUserAdminNoteListGet200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantUserAdminNoteListGet200ResponseData and assigns it to the Data field.
func (o *MerchantUserAdminNoteListGet200Response) SetData(v MerchantUserAdminNoteListGet200ResponseData) {
	o.Data = &v
}

// GetMerchantId returns the MerchantId field value if set, zero value otherwise.
func (o *MerchantUserAdminNoteListGet200Response) GetMerchantId() int64 {
...
// and a boolean to check if the value has been set.
func (o *MerchantUserAdminNoteListGet200Response) GetMerchantIdOk() (*int64, bool) {
	if o == nil || IsNil(o.MerchantId) {
		return nil, false
	}
...
func (o *MerchantUserAdminNoteListGet200Response) HasMerchantId() bool {
	if o != nil && !IsNil(o.MerchantId) {
		return true
	}
...
func (o *MerchantUserAdminNoteListGet200Response) SetMerchantId(v int64) {
	o.MerchantId = &v
}
...
func (o MerchantUserAdminNoteListGet200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantUserAdminNoteListGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantUserAdminNoteListGet200Response struct {
	value *MerchantUserAdminNoteListGet200Response
	isSet bool
}

func (v NullableMerchantUserAdminNoteListGet200Response) Get() *MerchantUserAdminNoteListGet200Response {
	return v.value
}

func (v *NullableMerchantUserAdminNoteListGet200Response) Set(val *MerchantUserAdminNoteListGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantUserAdminNoteListGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantUserAdminNoteListGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantUserAdminNoteListGet200Response(val *MerchantUserAdminNoteListGet200Response) *NullableMerchantUserAdminNoteListGet200Response {
	return &NullableMerchantUserAdminNoteListGet200Response{value: val, isSet: true}
}

func (v NullableMerchantUserAdminNoteListGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantUserAdminNoteListGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
