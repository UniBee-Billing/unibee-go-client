...
// checks if the MerchantDiscountEditPost200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantDiscountEditPost200Response{}

// MerchantDiscountEditPost200Response struct for MerchantDiscountEditPost200Response
type MerchantDiscountEditPost200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantDiscountEditPost200ResponseData `json:"data,omitempty"`
...
func NewMerchantDiscountEditPost200Response() *MerchantDiscountEditPost200Response {
	this := MerchantDiscountEditPost200Response{}
	return &this
}
...
func (o *MerchantDiscountEditPost200Response) GetData() MerchantDiscountEditPost200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantDiscountEditPost200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantDiscountEditPost200ResponseData and assigns it to the Data field.
...
func (o MerchantDiscountEditPost200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantDiscountEditPost200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantDiscountEditPost200Response struct {
	value *MerchantDiscountEditPost200Response
	isSet bool
}

func (v NullableMerchantDiscountEditPost200Response) Get() *MerchantDiscountEditPost200Response {
	return v.value
}

func (v *NullableMerchantDiscountEditPost200Response) Set(val *MerchantDiscountEditPost200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantDiscountEditPost200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantDiscountEditPost200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantDiscountEditPost200Response(val *MerchantDiscountEditPost200Response) *NullableMerchantDiscountEditPost200Response {
	return &NullableMerchantDiscountEditPost200Response{value: val, isSet: true}
}

func (v NullableMerchantDiscountEditPost200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantDiscountEditPost200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
