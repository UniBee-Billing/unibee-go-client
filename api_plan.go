...
func (r PlanPlanActivatePostRequest) Execute() (*MerchantAuthSsoClearTotpPost200Response, *http.Response, error) {
	return r.ApiService.PlanActivatePostExecute(r)
}

/*
PlanActivatePost Activate Plan
...
func (a *PlanService) PlanActivatePostExecute(r PlanPlanActivatePostRequest) (*MerchantAuthSsoClearTotpPost200Response, *http.Response, error) {
	var (
...
type PlanPlanActivePriceChangeConfirmPostRequest struct {
	ctx context.Context
	ApiService *PlanService
	unibeeApiMerchantPlanActivePriceChangeConfirmReq *UnibeeApiMerchantPlanActivePriceChangeConfirmReq
}

func (r PlanPlanActivePriceChangeConfirmPostRequest) UnibeeApiMerchantPlanActivePriceChangeConfirmReq(unibeeApiMerchantPlanActivePriceChangeConfirmReq UnibeeApiMerchantPlanActivePriceChangeConfirmReq) PlanPlanActivePriceChangeConfirmPostRequest {
	r.unibeeApiMerchantPlanActivePriceChangeConfirmReq = &unibeeApiMerchantPlanActivePriceChangeConfirmReq
	return r
}

func (r PlanPlanActivePriceChangeConfirmPostRequest) Execute() (*MerchantPlanActivePriceChangeConfirmPost200Response, *http.Response, error) {
	return r.ApiService.PlanActivePriceChangeConfirmPostExecute(r)
}

/*
PlanActivePriceChangeConfirmPost Confirm Active Plan Price Change

Confirm and apply price change for an active plan.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return PlanPlanActivePriceChangeConfirmPostRequest
*/
func (a *PlanService) PlanActivePriceChangeConfirmPost(ctx context.Context) PlanPlanActivePriceChangeConfirmPostRequest {
	return PlanPlanActivePriceChangeConfirmPostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return MerchantPlanActivePriceChangeConfirmPost200Response
func (a *PlanService) PlanActivePriceChangeConfirmPostExecute(r PlanPlanActivePriceChangeConfirmPostRequest) (*MerchantPlanActivePriceChangeConfirmPost200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *MerchantPlanActivePriceChangeConfirmPost200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PlanService.PlanActivePriceChangeConfirmPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/merchant/plan/active_price_change/confirm"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.unibeeApiMerchantPlanActivePriceChangeConfirmReq == nil {
		return localVarReturnValue, nil, reportError("unibeeApiMerchantPlanActivePriceChangeConfirmReq is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.unibeeApiMerchantPlanActivePriceChangeConfirmReq
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
type PlanPlanActivePriceChangePreviewPostRequest struct {
	ctx context.Context
	ApiService *PlanService
	unibeeApiMerchantPlanActivePriceChangePreviewReq *UnibeeApiMerchantPlanActivePriceChangePreviewReq
}

func (r PlanPlanActivePriceChangePreviewPostRequest) UnibeeApiMerchantPlanActivePriceChangePreviewReq(unibeeApiMerchantPlanActivePriceChangePreviewReq UnibeeApiMerchantPlanActivePriceChangePreviewReq) PlanPlanActivePriceChangePreviewPostRequest {
	r.unibeeApiMerchantPlanActivePriceChangePreviewReq = &unibeeApiMerchantPlanActivePriceChangePreviewReq
	return r
}

func (r PlanPlanActivePriceChangePreviewPostRequest) Execute() (*MerchantPlanActivePriceChangePreviewPost200Response, *http.Response, error) {
	return r.ApiService.PlanActivePriceChangePreviewPostExecute(r)
}

/*
PlanActivePriceChangePreviewPost Preview Active Plan Price Change

Preview how many subscriptions will be affected if we change price of an active plan.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return PlanPlanActivePriceChangePreviewPostRequest
*/
func (a *PlanService) PlanActivePriceChangePreviewPost(ctx context.Context) PlanPlanActivePriceChangePreviewPostRequest {
	return PlanPlanActivePriceChangePreviewPostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return MerchantPlanActivePriceChangePreviewPost200Response
func (a *PlanService) PlanActivePriceChangePreviewPostExecute(r PlanPlanActivePriceChangePreviewPostRequest) (*MerchantPlanActivePriceChangePreviewPost200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *MerchantPlanActivePriceChangePreviewPost200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PlanService.PlanActivePriceChangePreviewPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/merchant/plan/active_price_change/preview"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.unibeeApiMerchantPlanActivePriceChangePreviewReq == nil {
		return localVarReturnValue, nil, reportError("unibeeApiMerchantPlanActivePriceChangePreviewReq is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.unibeeApiMerchantPlanActivePriceChangePreviewReq
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
/*
PlanAddonsBindingPost Addon Binding
...
type PlanPlanArchivePostRequest struct {
	ctx context.Context
	ApiService *PlanService
	unibeeApiMerchantPlanArchiveReq *UnibeeApiMerchantPlanArchiveReq
}

func (r PlanPlanArchivePostRequest) UnibeeApiMerchantPlanArchiveReq(unibeeApiMerchantPlanArchiveReq UnibeeApiMerchantPlanArchiveReq) PlanPlanArchivePostRequest {
	r.unibeeApiMerchantPlanArchiveReq = &unibeeApiMerchantPlanArchiveReq
	return r
}

func (r PlanPlanArchivePostRequest) Execute() (*MerchantAuthSsoClearTotpPost200Response, *http.Response, error) {
	return r.ApiService.PlanArchivePostExecute(r)
}

/*
PlanArchivePost Archive Plan

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return PlanPlanArchivePostRequest
*/
func (a *PlanService) PlanArchivePost(ctx context.Context) PlanPlanArchivePostRequest {
	return PlanPlanArchivePostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return MerchantAuthSsoClearTotpPost200Response
func (a *PlanService) PlanArchivePostExecute(r PlanPlanArchivePostRequest) (*MerchantAuthSsoClearTotpPost200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PlanService.PlanArchivePost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/merchant/plan/archive"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.unibeeApiMerchantPlanArchiveReq == nil {
		return localVarReturnValue, nil, reportError("unibeeApiMerchantPlanArchiveReq is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.unibeeApiMerchantPlanArchiveReq
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
func (r PlanPlanDeletePostRequest) Execute() (*MerchantAuthSsoClearTotpPost200Response, *http.Response, error) {
	return r.ApiService.PlanDeletePostExecute(r)
}

/*
PlanDeletePost Delete Plan
...
// Execute executes the request
//  @return MerchantAuthSsoClearTotpPost200Response
func (a *PlanService) PlanDeletePostExecute(r PlanPlanDeletePostRequest) (*MerchantAuthSsoClearTotpPost200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r PlanPlanDetailGetRequest) ExternalPlanId(externalPlanId string) PlanPlanDetailGetRequest {
...
func (r PlanPlanListGetRequest) PlanIds(planIds []int64) PlanPlanListGetRequest {
	r.planIds = &planIds
	return r
}
...
func (r PlanPlanListGetRequest) IntervalUnits(intervalUnits []string) PlanPlanListGetRequest {
	r.intervalUnits = &intervalUnits
	return r
}

// Filter by interval count; ignored when billingIntervalMin is provided
func (r PlanPlanListGetRequest) IntervalCounts(intervalCounts []int32) PlanPlanListGetRequest {
	r.intervalCounts = &intervalCounts
	return r
}

// Minimum billing interval in ISO 8601 duration (date part only, Y/M/W/D), e.g. P1M, P6M, P1Y, P2W, P10D
func (r PlanPlanListGetRequest) BillingIntervalMin(billingIntervalMin string) PlanPlanListGetRequest {
	r.billingIntervalMin = &billingIntervalMin
	return r
}

// Search Key, plan name or description
func (r PlanPlanListGetRequest) SearchKey(searchKey string) PlanPlanListGetRequest {
...
func (a *PlanService) PlanListGetExecute(r PlanPlanListGetRequest) (*MerchantPlanListGet200Response, *http.Response, error) {
	...
	if r.intervalUnits != nil {
		t := *r.intervalUnits
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "intervalUnits", s.Index(i).Interface(), "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "intervalUnits", t, "multi")
		}
	}
	if r.intervalCounts != nil {
		t := *r.intervalCounts
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "intervalCounts", s.Index(i).Interface(), "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "intervalCounts", t, "multi")
		}
	}
	if r.billingIntervalMin != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "billingIntervalMin", r.billingIntervalMin, "")
	}
	if r.searchKey != nil {
...
type PlanPlanMetricLimitOverridePostRequest struct {
	ctx context.Context
	ApiService *PlanService
	unibeeApiMerchantPlanMetricLimitOverrideReq *UnibeeApiMerchantPlanMetricLimitOverrideReq
}

func (r PlanPlanMetricLimitOverridePostRequest) UnibeeApiMerchantPlanMetricLimitOverrideReq(unibeeApiMerchantPlanMetricLimitOverrideReq UnibeeApiMerchantPlanMetricLimitOverrideReq) PlanPlanMetricLimitOverridePostRequest {
	r.unibeeApiMerchantPlanMetricLimitOverrideReq = &unibeeApiMerchantPlanMetricLimitOverrideReq
	return r
}

func (r PlanPlanMetricLimitOverridePostRequest) Execute() (*MerchantPlanMetricLimitOverridePost200Response, *http.Response, error) {
	return r.ApiService.PlanMetricLimitOverridePostExecute(r)
}

/*
PlanMetricLimitOverridePost Override Metric Limits Of Plan

Insert or override metric limit items of a plan

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return PlanPlanMetricLimitOverridePostRequest
*/
func (a *PlanService) PlanMetricLimitOverridePost(ctx context.Context) PlanPlanMetricLimitOverridePostRequest {
	return PlanPlanMetricLimitOverridePostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *PlanService) PlanMetricLimitOverridePostExecute(r PlanPlanMetricLimitOverridePostRequest) (*MerchantPlanMetricLimitOverridePost200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *MerchantPlanMetricLimitOverridePost200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PlanService.PlanMetricLimitOverridePost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/merchant/plan/metric_limit_override"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.unibeeApiMerchantPlanMetricLimitOverrideReq == nil {
		return localVarReturnValue, nil, reportError("unibeeApiMerchantPlanMetricLimitOverrideReq is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.unibeeApiMerchantPlanMetricLimitOverrideReq
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
func (r PlanPlanPublishPostRequest) Execute() (*MerchantAuthSsoClearTotpPost200Response, *http.Response, error) {
	return r.ApiService.PlanPublishPostExecute(r)
}

/*
PlanPublishPost Publish Plan
...
// Execute executes the request
//  @return MerchantAuthSsoClearTotpPost200Response
func (a *PlanService) PlanPublishPostExecute(r PlanPlanPublishPostRequest) (*MerchantAuthSsoClearTotpPost200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r PlanPlanUnpublishedPostRequest) Execute() (*MerchantAuthSsoClearTotpPost200Response, *http.Response, error) {
	return r.ApiService.PlanUnpublishedPostExecute(r)
}

/*
PlanUnpublishedPost UnPublish Plan
...
// Execute executes the request
//  @return MerchantAuthSsoClearTotpPost200Response
func (a *PlanService) PlanUnpublishedPostExecute(r PlanPlanUnpublishedPostRequest) (*MerchantAuthSsoClearTotpPost200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
