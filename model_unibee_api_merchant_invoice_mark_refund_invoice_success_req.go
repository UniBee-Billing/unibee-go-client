...
// UnibeeApiMerchantInvoiceMarkRefundInvoiceSuccessReq Mark existing manual refund of an invoice as success, only supports Changelly (crypto) and Wire Transfer refunds.
