...
type MerchantWebhookEndpointListGet200ResponseData struct {
	...
	ZapierCredential *UnibeeApiBeanMerchantZapierCredential `json:"zapierCredential,omitempty"`
}
...
// GetZapierCredential returns the ZapierCredential field value if set, zero value otherwise.
func (o *MerchantWebhookEndpointListGet200ResponseData) GetZapierCredential() UnibeeApiBeanMerchantZapierCredential {
	if o == nil || IsNil(o.ZapierCredential) {
		var ret UnibeeApiBeanMerchantZapierCredential
		return ret
	}
	return *o.ZapierCredential
}

// GetZapierCredentialOk returns a tuple with the ZapierCredential field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MerchantWebhookEndpointListGet200ResponseData) GetZapierCredentialOk() (*UnibeeApiBeanMerchantZapierCredential, bool) {
	if o == nil || IsNil(o.ZapierCredential) {
		return nil, false
	}
	return o.ZapierCredential, true
}
...
// SetZapierCredential gets a reference to the given UnibeeApiBeanMerchantZapierCredential and assigns it to the ZapierCredential field.
func (o *MerchantWebhookEndpointListGet200ResponseData) SetZapierCredential(v UnibeeApiBeanMerchantZapierCredential) {
	o.ZapierCredential = &v
}
...
func (o MerchantWebhookEndpointListGet200ResponseData) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ZapierCredential) {
		toSerialize["zapierCredential"] = o.ZapierCredential
	}
