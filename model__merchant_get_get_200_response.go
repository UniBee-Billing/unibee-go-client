...
// checks if the MerchantGetGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantGetGet200Response{}

// MerchantGetGet200Response struct for MerchantGetGet200Response
type MerchantGetGet200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantGetGet200ResponseData `json:"data,omitempty"`
...
func NewMerchantGetGet200Response() *MerchantGetGet200Response {
	this := MerchantGetGet200Response{}
	return &this
}
...
func (o *MerchantGetGet200Response) GetData() MerchantGetGet200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantGetGet200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantGetGet200ResponseData and assigns it to the Data field.
...
func (o MerchantGetGet200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantGetGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantGetGet200Response struct {
	value *MerchantGetGet200Response
	isSet bool
}

func (v NullableMerchantGetGet200Response) Get() *MerchantGetGet200Response {
	return v.value
}

func (v *NullableMerchantGetGet200Response) Set(val *MerchantGetGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantGetGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantGetGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantGetGet200Response(val *MerchantGetGet200Response) *NullableMerchantGetGet200Response {
	return &NullableMerchantGetGet200Response{value: val, isSet: true}
}

func (v NullableMerchantGetGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantGetGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
