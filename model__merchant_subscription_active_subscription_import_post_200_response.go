...
// checks if the MerchantSubscriptionActiveSubscriptionImportPost200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantSubscriptionActiveSubscriptionImportPost200Response{}

// MerchantSubscriptionActiveSubscriptionImportPost200Response struct for MerchantSubscriptionActiveSubscriptionImportPost200Response
type MerchantSubscriptionActiveSubscriptionImportPost200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantSubscriptionActiveSubscriptionImportPost200ResponseData `json:"data,omitempty"`
...
func NewMerchantSubscriptionActiveSubscriptionImportPost200Response() *MerchantSubscriptionActiveSubscriptionImportPost200Response {
	this := MerchantSubscriptionActiveSubscriptionImportPost200Response{}
	return &this
}
...
func (o *MerchantSubscriptionActiveSubscriptionImportPost200Response) GetData() MerchantSubscriptionActiveSubscriptionImportPost200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantSubscriptionActiveSubscriptionImportPost200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantSubscriptionActiveSubscriptionImportPost200ResponseData and assigns it to the Data field.
...
func (o MerchantSubscriptionActiveSubscriptionImportPost200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantSubscriptionActiveSubscriptionImportPost200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantSubscriptionActiveSubscriptionImportPost200Response struct {
	value *MerchantSubscriptionActiveSubscriptionImportPost200Response
	isSet bool
}

func (v NullableMerchantSubscriptionActiveSubscriptionImportPost200Response) Get() *MerchantSubscriptionActiveSubscriptionImportPost200Response {
	return v.value
}

func (v *NullableMerchantSubscriptionActiveSubscriptionImportPost200Response) Set(val *MerchantSubscriptionActiveSubscriptionImportPost200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantSubscriptionActiveSubscriptionImportPost200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantSubscriptionActiveSubscriptionImportPost200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantSubscriptionActiveSubscriptionImportPost200Response(val *MerchantSubscriptionActiveSubscriptionImportPost200Response) *NullableMerchantSubscriptionActiveSubscriptionImportPost200Response {
	return &NullableMerchantSubscriptionActiveSubscriptionImportPost200Response{value: val, isSet: true}
}

func (v NullableMerchantSubscriptionActiveSubscriptionImportPost200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantSubscriptionActiveSubscriptionImportPost200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
