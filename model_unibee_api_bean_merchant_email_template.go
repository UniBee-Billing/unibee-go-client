...
type UnibeeApiBeanMerchantEmailTemplate struct {
	VariableGroups []UnibeeApiBeanTemplateVariableGroup `json:"VariableGroups,omitempty"`
	// create utc time
	CreateTime *int64 `json:"createTime,omitempty"`
	GatewayTemplateId *string `json:"gatewayTemplateId,omitempty"`
	Id *int64 `json:"id,omitempty"`
	LanguageData []UnibeeApiBeanEmailLocalizationTemplate `json:"languageData,omitempty"`
	LocalizationVersions []UnibeeApiBeanMerchantLocalizationVersion `json:"localizationVersions,omitempty"`
...
// GetVariableGroups returns the VariableGroups field value if set, zero value otherwise.
func (o *UnibeeApiBeanMerchantEmailTemplate) GetVariableGroups() []UnibeeApiBeanTemplateVariableGroup {
	if o == nil || IsNil(o.VariableGroups) {
		var ret []UnibeeApiBeanTemplateVariableGroup
		return ret
	}
	return o.VariableGroups
}

// GetVariableGroupsOk returns a tuple with the VariableGroups field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UnibeeApiBeanMerchantEmailTemplate) GetVariableGroupsOk() ([]UnibeeApiBeanTemplateVariableGroup, bool) {
	if o == nil || IsNil(o.VariableGroups) {
		return nil, false
	}
	return o.VariableGroups, true
}
...
// SetVariableGroups gets a reference to the given []UnibeeApiBeanTemplateVariableGroup and assigns it to the VariableGroups field.
...
// SetLanguageData gets a reference to the given []UnibeeApiBeanEmailLocalizationTemplate and assigns it to the LanguageData field.
func (o *UnibeeApiBeanMerchantEmailTemplate) SetLanguageData(v []UnibeeApiBeanEmailLocalizationTemplate) {
	o.LanguageData = v
}

// GetLocalizationVersions returns the LocalizationVersions field value if set, zero value otherwise.
func (o *UnibeeApiBeanMerchantEmailTemplate) GetLocalizationVersions() []UnibeeApiBeanMerchantLocalizationVersion {
	if o == nil || IsNil(o.LocalizationVersions) {
		var ret []UnibeeApiBeanMerchantLocalizationVersion
		return ret
	}
	return o.LocalizationVersions
}

// GetLocalizationVersionsOk returns a tuple with the LocalizationVersions field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UnibeeApiBeanMerchantEmailTemplate) GetLocalizationVersionsOk() ([]UnibeeApiBeanMerchantLocalizationVersion, bool) {
	if o == nil || IsNil(o.LocalizationVersions) {
		return nil, false
	}
	return o.LocalizationVersions, true
}
...
// SetLocalizationVersions gets a reference to the given []UnibeeApiBeanMerchantLocalizationVersion and assigns it to the LocalizationVersions field.
func (o *UnibeeApiBeanMerchantEmailTemplate) SetLocalizationVersions(v []UnibeeApiBeanMerchantLocalizationVersion) {
	o.LocalizationVersions = v
}
...
func (o UnibeeApiBeanMerchantEmailTemplate) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.VariableGroups) {
		toSerialize["VariableGroups"] = o.VariableGroups
	}
	...
	if !IsNil(o.LocalizationVersions) {
		toSerialize["localizationVersions"] = o.LocalizationVersions
	}
