...
// checks if the MerchantSubscriptionDetailGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantSubscriptionDetailGet200Response{}

// MerchantSubscriptionDetailGet200Response struct for MerchantSubscriptionDetailGet200Response
type MerchantSubscriptionDetailGet200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantSubscriptionDetailGet200ResponseData `json:"data,omitempty"`
...
func NewMerchantSubscriptionDetailGet200Response() *MerchantSubscriptionDetailGet200Response {
	this := MerchantSubscriptionDetailGet200Response{}
	return &this
}
...
func (o *MerchantSubscriptionDetailGet200Response) GetData() MerchantSubscriptionDetailGet200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantSubscriptionDetailGet200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantSubscriptionDetailGet200ResponseData and assigns it to the Data field.
...
func (o MerchantSubscriptionDetailGet200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantSubscriptionDetailGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantSubscriptionDetailGet200Response struct {
	value *MerchantSubscriptionDetailGet200Response
	isSet bool
}

func (v NullableMerchantSubscriptionDetailGet200Response) Get() *MerchantSubscriptionDetailGet200Response {
	return v.value
}

func (v *NullableMerchantSubscriptionDetailGet200Response) Set(val *MerchantSubscriptionDetailGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantSubscriptionDetailGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantSubscriptionDetailGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantSubscriptionDetailGet200Response(val *MerchantSubscriptionDetailGet200Response) *NullableMerchantSubscriptionDetailGet200Response {
	return &NullableMerchantSubscriptionDetailGet200Response{value: val, isSet: true}
}

func (v NullableMerchantSubscriptionDetailGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantSubscriptionDetailGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
