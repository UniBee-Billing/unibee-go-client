...
// UnibeeApiMerchantInvoiceListReq struct for UnibeeApiMerchantInvoiceListReq
type UnibeeApiMerchantInvoiceListReq struct {
	// AmountEnd
	AmountEnd *int64 `json:"amountEnd,omitempty"`
	// AmountStart
	AmountStart *int64 `json:"amountStart,omitempty"`
	// Count By Page
...
// SetAmountEnd gets a reference to the given int64 and assigns it to the AmountEnd field.
...
// SetAmountStart gets a reference to the given int64 and assigns it to the AmountStart field.
