...
// checks if the MerchantCreditCreditAccountListGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantCreditCreditAccountListGet200Response{}

// MerchantCreditCreditAccountListGet200Response struct for MerchantCreditCreditAccountListGet200Response
type MerchantCreditCreditAccountListGet200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantCreditCreditAccountListGet200ResponseData `json:"data,omitempty"`
...
func NewMerchantCreditCreditAccountListGet200Response() *MerchantCreditCreditAccountListGet200Response {
	this := MerchantCreditCreditAccountListGet200Response{}
	return &this
}
...
func (o *MerchantCreditCreditAccountListGet200Response) GetData() MerchantCreditCreditAccountListGet200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantCreditCreditAccountListGet200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantCreditCreditAccountListGet200ResponseData and assigns it to the Data field.
...
func (o MerchantCreditCreditAccountListGet200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantCreditCreditAccountListGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantCreditCreditAccountListGet200Response struct {
	value *MerchantCreditCreditAccountListGet200Response
	isSet bool
}

func (v NullableMerchantCreditCreditAccountListGet200Response) Get() *MerchantCreditCreditAccountListGet200Response {
	return v.value
}

func (v *NullableMerchantCreditCreditAccountListGet200Response) Set(val *MerchantCreditCreditAccountListGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantCreditCreditAccountListGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantCreditCreditAccountListGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantCreditCreditAccountListGet200Response(val *MerchantCreditCreditAccountListGet200Response) *NullableMerchantCreditCreditAccountListGet200Response {
	return &NullableMerchantCreditCreditAccountListGet200Response{value: val, isSet: true}
}

func (v NullableMerchantCreditCreditAccountListGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantCreditCreditAccountListGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
