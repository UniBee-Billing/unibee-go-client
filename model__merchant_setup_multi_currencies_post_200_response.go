...
// checks if the MerchantSetupMultiCurrenciesPost200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantSetupMultiCurrenciesPost200Response{}

// MerchantSetupMultiCurrenciesPost200Response struct for MerchantSetupMultiCurrenciesPost200Response
type MerchantSetupMultiCurrenciesPost200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantSetupMultiCurrenciesPost200ResponseData `json:"data,omitempty"`
...
func NewMerchantSetupMultiCurrenciesPost200Response() *MerchantSetupMultiCurrenciesPost200Response {
	this := MerchantSetupMultiCurrenciesPost200Response{}
	return &this
}
...
func (o *MerchantSetupMultiCurrenciesPost200Response) GetData() MerchantSetupMultiCurrenciesPost200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantSetupMultiCurrenciesPost200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantSetupMultiCurrenciesPost200ResponseData and assigns it to the Data field.
...
func (o *MerchantSetupMultiCurrenciesPost200Response) GetMerchantId() int64 {
...
// and a boolean to check if the value has been set.
func (o *MerchantSetupMultiCurrenciesPost200Response) GetMerchantIdOk() (*int64, bool) {
	if o == nil || IsNil(o.MerchantId) {
		return nil, false
	}
...
func (o *MerchantSetupMultiCurrenciesPost200Response) HasMerchantId() bool {
	if o != nil && !IsNil(o.MerchantId) {
		return true
	}
...
func (o *MerchantSetupMultiCurrenciesPost200Response) SetMerchantId(v int64) {
	o.MerchantId = &v
}
...
func (o MerchantSetupMultiCurrenciesPost200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantSetupMultiCurrenciesPost200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantSetupMultiCurrenciesPost200Response struct {
	value *MerchantSetupMultiCurrenciesPost200Response
	isSet bool
}

func (v NullableMerchantSetupMultiCurrenciesPost200Response) Get() *MerchantSetupMultiCurrenciesPost200Response {
	return v.value
}

func (v *NullableMerchantSetupMultiCurrenciesPost200Response) Set(val *MerchantSetupMultiCurrenciesPost200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantSetupMultiCurrenciesPost200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantSetupMultiCurrenciesPost200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantSetupMultiCurrenciesPost200Response(val *MerchantSetupMultiCurrenciesPost200Response) *NullableMerchantSetupMultiCurrenciesPost200Response {
	return &NullableMerchantSetupMultiCurrenciesPost200Response{value: val, isSet: true}
}

func (v NullableMerchantSetupMultiCurrenciesPost200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantSetupMultiCurrenciesPost200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
