...
// checks if the MerchantSubscriptionNewOnetimeAddonPaymentPost200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantSubscriptionNewOnetimeAddonPaymentPost200Response{}

// MerchantSubscriptionNewOnetimeAddonPaymentPost200Response struct for MerchantSubscriptionNewOnetimeAddonPaymentPost200Response
type MerchantSubscriptionNewOnetimeAddonPaymentPost200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantSubscriptionNewOnetimeAddonPaymentPost200ResponseData `json:"data,omitempty"`
...
func NewMerchantSubscriptionNewOnetimeAddonPaymentPost200Response() *MerchantSubscriptionNewOnetimeAddonPaymentPost200Response {
	this := MerchantSubscriptionNewOnetimeAddonPaymentPost200Response{}
	return &this
}
...
func (o *MerchantSubscriptionNewOnetimeAddonPaymentPost200Response) GetData() MerchantSubscriptionNewOnetimeAddonPaymentPost200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantSubscriptionNewOnetimeAddonPaymentPost200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantSubscriptionNewOnetimeAddonPaymentPost200ResponseData and assigns it to the Data field.
...
func (o MerchantSubscriptionNewOnetimeAddonPaymentPost200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantSubscriptionNewOnetimeAddonPaymentPost200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantSubscriptionNewOnetimeAddonPaymentPost200Response struct {
	value *MerchantSubscriptionNewOnetimeAddonPaymentPost200Response
	isSet bool
}

func (v NullableMerchantSubscriptionNewOnetimeAddonPaymentPost200Response) Get() *MerchantSubscriptionNewOnetimeAddonPaymentPost200Response {
	return v.value
}

func (v *NullableMerchantSubscriptionNewOnetimeAddonPaymentPost200Response) Set(val *MerchantSubscriptionNewOnetimeAddonPaymentPost200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantSubscriptionNewOnetimeAddonPaymentPost200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantSubscriptionNewOnetimeAddonPaymentPost200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantSubscriptionNewOnetimeAddonPaymentPost200Response(val *MerchantSubscriptionNewOnetimeAddonPaymentPost200Response) *NullableMerchantSubscriptionNewOnetimeAddonPaymentPost200Response {
	return &NullableMerchantSubscriptionNewOnetimeAddonPaymentPost200Response{value: val, isSet: true}
}

func (v NullableMerchantSubscriptionNewOnetimeAddonPaymentPost200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantSubscriptionNewOnetimeAddonPaymentPost200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
