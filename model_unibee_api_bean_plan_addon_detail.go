...
type UnibeeApiBeanPlanAddonDetail struct {
	AddonPlan *UnibeeApiBeanPlanSimplify `json:"addonPlan,omitempty"`
	// Quantity
...
// SetAddonPlan gets a reference to the given UnibeeApiBeanPlanSimplify and assigns it to the AddonPlan field.
