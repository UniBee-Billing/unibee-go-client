...
type MerchantSubscriptionRenewPost200ResponseData struct {
	...
	// ID of the renewal invoice generated by this request.
	InvoiceId *string `json:"invoiceId,omitempty"`
	// Hosted payment or invoice link. When paid=false, redirect the customer to this link to complete the renewal payment.
	Link *string `json:"link,omitempty"`
	// Whether the renewal invoice has been successfully paid at the time of response.
	Paid *bool `json:"paid,omitempty"`
	// ID of the payment created for the renewal invoice, if any.
