...
type UnibeeApiBeanPayment struct {
	...
	AuthorizeComment *string `json:"authorizeComment,omitempty"`
	...
	// Final system auto-charge result flag for this payment. True only when: automatic=1, gatewayPaymentMethod not empty, and no hosted payment link visit evidence (meta_data.plCount==0).
...
// GetAuthorizeComment returns the AuthorizeComment field value if set, zero value otherwise.
func (o *UnibeeApiBeanPayment) GetAuthorizeComment() string {
	if o == nil || IsNil(o.AuthorizeComment) {
		var ret string
		return ret
	}
	return *o.AuthorizeComment
}

// GetAuthorizeCommentOk returns a tuple with the AuthorizeComment field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UnibeeApiBeanPayment) GetAuthorizeCommentOk() (*string, bool) {
	if o == nil || IsNil(o.AuthorizeComment) {
		return nil, false
	}
	return o.AuthorizeComment, true
}
...
// SetAuthorizeComment gets a reference to the given string and assigns it to the AuthorizeComment field.
func (o *UnibeeApiBeanPayment) SetAuthorizeComment(v string) {
	o.AuthorizeComment = &v
}
...
func (o UnibeeApiBeanPayment) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.AuthorizeComment) {
		toSerialize["authorizeComment"] = o.AuthorizeComment
	}
