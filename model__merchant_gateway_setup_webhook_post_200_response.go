...
// checks if the MerchantGatewaySetupWebhookPost200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantGatewaySetupWebhookPost200Response{}

// MerchantGatewaySetupWebhookPost200Response struct for MerchantGatewaySetupWebhookPost200Response
type MerchantGatewaySetupWebhookPost200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantGatewaySetupWebhookPost200ResponseData `json:"data,omitempty"`
...
func NewMerchantGatewaySetupWebhookPost200Response() *MerchantGatewaySetupWebhookPost200Response {
	this := MerchantGatewaySetupWebhookPost200Response{}
	return &this
}
...
func (o *MerchantGatewaySetupWebhookPost200Response) GetData() MerchantGatewaySetupWebhookPost200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantGatewaySetupWebhookPost200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantGatewaySetupWebhookPost200ResponseData and assigns it to the Data field.
...
func (o *MerchantGatewaySetupWebhookPost200Response) GetMerchantId() int64 {
...
// and a boolean to check if the value has been set.
func (o *MerchantGatewaySetupWebhookPost200Response) GetMerchantIdOk() (*int64, bool) {
	if o == nil || IsNil(o.MerchantId) {
		return nil, false
	}
...
func (o *MerchantGatewaySetupWebhookPost200Response) HasMerchantId() bool {
	if o != nil && !IsNil(o.MerchantId) {
		return true
	}
...
func (o *MerchantGatewaySetupWebhookPost200Response) SetMerchantId(v int64) {
	o.MerchantId = &v
}
...
func (o MerchantGatewaySetupWebhookPost200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantGatewaySetupWebhookPost200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantGatewaySetupWebhookPost200Response struct {
	value *MerchantGatewaySetupWebhookPost200Response
	isSet bool
}

func (v NullableMerchantGatewaySetupWebhookPost200Response) Get() *MerchantGatewaySetupWebhookPost200Response {
	return v.value
}

func (v *NullableMerchantGatewaySetupWebhookPost200Response) Set(val *MerchantGatewaySetupWebhookPost200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantGatewaySetupWebhookPost200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantGatewaySetupWebhookPost200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantGatewaySetupWebhookPost200Response(val *MerchantGatewaySetupWebhookPost200Response) *NullableMerchantGatewaySetupWebhookPost200Response {
	return &NullableMerchantGatewaySetupWebhookPost200Response{value: val, isSet: true}
}

func (v NullableMerchantGatewaySetupWebhookPost200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantGatewaySetupWebhookPost200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
