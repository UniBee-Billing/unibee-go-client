...
// GetSupportCurrencies returns the SupportCurrencies field value if set, zero value otherwise.
func (o *UnibeeInternalInterfaceGatewayPaymentType) GetSupportCurrencies() []string {
	if o == nil || IsNil(o.SupportCurrencies) {
		var ret []string
		return ret
	}
	return o.SupportCurrencies
}

// GetSupportCurrenciesOk returns a tuple with the SupportCurrencies field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UnibeeInternalInterfaceGatewayPaymentType) GetSupportCurrenciesOk() ([]string, bool) {
	if o == nil || IsNil(o.SupportCurrencies) {
		return nil, false
	}
	return o.SupportCurrencies, true
}
...
// SetSupportCurrencies gets a reference to the given []string and assigns it to the SupportCurrencies field.
func (o *UnibeeInternalInterfaceGatewayPaymentType) SetSupportCurrencies(v []string) {
	o.SupportCurrencies = v
}
...
func (o UnibeeInternalInterfaceGatewayPaymentType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.SupportCurrencies) {
		toSerialize["supportCurrencies"] = o.SupportCurrencies
	}
