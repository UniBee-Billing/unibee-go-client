...
// checks if the MerchantSubscriptionUpdateSubmitPost200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantSubscriptionUpdateSubmitPost200Response{}

// MerchantSubscriptionUpdateSubmitPost200Response struct for MerchantSubscriptionUpdateSubmitPost200Response
type MerchantSubscriptionUpdateSubmitPost200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantSubscriptionUpdateSubmitPost200ResponseData `json:"data,omitempty"`
...
func NewMerchantSubscriptionUpdateSubmitPost200Response() *MerchantSubscriptionUpdateSubmitPost200Response {
	this := MerchantSubscriptionUpdateSubmitPost200Response{}
	return &this
}
...
func (o *MerchantSubscriptionUpdateSubmitPost200Response) GetData() MerchantSubscriptionUpdateSubmitPost200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantSubscriptionUpdateSubmitPost200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantSubscriptionUpdateSubmitPost200ResponseData and assigns it to the Data field.
...
func (o *MerchantSubscriptionUpdateSubmitPost200Response) GetMerchantId() int64 {
...
// and a boolean to check if the value has been set.
func (o *MerchantSubscriptionUpdateSubmitPost200Response) GetMerchantIdOk() (*int64, bool) {
	if o == nil || IsNil(o.MerchantId) {
		return nil, false
	}
...
func (o *MerchantSubscriptionUpdateSubmitPost200Response) HasMerchantId() bool {
	if o != nil && !IsNil(o.MerchantId) {
		return true
	}
...
func (o *MerchantSubscriptionUpdateSubmitPost200Response) SetMerchantId(v int64) {
	o.MerchantId = &v
}
...
func (o MerchantSubscriptionUpdateSubmitPost200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantSubscriptionUpdateSubmitPost200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantSubscriptionUpdateSubmitPost200Response struct {
	value *MerchantSubscriptionUpdateSubmitPost200Response
	isSet bool
}

func (v NullableMerchantSubscriptionUpdateSubmitPost200Response) Get() *MerchantSubscriptionUpdateSubmitPost200Response {
	return v.value
}

func (v *NullableMerchantSubscriptionUpdateSubmitPost200Response) Set(val *MerchantSubscriptionUpdateSubmitPost200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantSubscriptionUpdateSubmitPost200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantSubscriptionUpdateSubmitPost200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantSubscriptionUpdateSubmitPost200Response(val *MerchantSubscriptionUpdateSubmitPost200Response) *NullableMerchantSubscriptionUpdateSubmitPost200Response {
	return &NullableMerchantSubscriptionUpdateSubmitPost200Response{value: val, isSet: true}
}

func (v NullableMerchantSubscriptionUpdateSubmitPost200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantSubscriptionUpdateSubmitPost200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
