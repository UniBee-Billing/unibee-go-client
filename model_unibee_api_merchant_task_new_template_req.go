...
func (o *UnibeeApiMerchantTaskNewTemplateReq) GetPayload() map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *UnibeeApiMerchantTaskNewTemplateReq) GetPayloadOk() (*map[string]interface{}, bool) {
	if o == nil || IsNil(o.Payload) {
		return nil, false
	}
...
func (o *UnibeeApiMerchantTaskNewTemplateReq) SetPayload(v map[string]interface{}) {
	o.Payload = &v
}
