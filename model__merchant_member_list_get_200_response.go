...
// checks if the MerchantMemberListGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantMemberListGet200Response{}

// MerchantMemberListGet200Response struct for MerchantMemberListGet200Response
type MerchantMemberListGet200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantMemberListGet200ResponseData `json:"data,omitempty"`
...
func NewMerchantMemberListGet200Response() *MerchantMemberListGet200Response {
	this := MerchantMemberListGet200Response{}
	return &this
}
...
func (o *MerchantMemberListGet200Response) GetData() MerchantMemberListGet200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantMemberListGet200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantMemberListGet200ResponseData and assigns it to the Data field.
...
func (o MerchantMemberListGet200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantMemberListGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantMemberListGet200Response struct {
	value *MerchantMemberListGet200Response
	isSet bool
}

func (v NullableMerchantMemberListGet200Response) Get() *MerchantMemberListGet200Response {
	return v.value
}

func (v *NullableMerchantMemberListGet200Response) Set(val *MerchantMemberListGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantMemberListGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantMemberListGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantMemberListGet200Response(val *MerchantMemberListGet200Response) *NullableMerchantMemberListGet200Response {
	return &NullableMerchantMemberListGet200Response{value: val, isSet: true}
}

func (v NullableMerchantMemberListGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantMemberListGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
