...
// checks if the MerchantUserGetGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantUserGetGet200Response{}

// MerchantUserGetGet200Response struct for MerchantUserGetGet200Response
type MerchantUserGetGet200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantUserGetGet200ResponseData `json:"data,omitempty"`
...
func NewMerchantUserGetGet200Response() *MerchantUserGetGet200Response {
	this := MerchantUserGetGet200Response{}
	return &this
}
...
func (o *MerchantUserGetGet200Response) GetData() MerchantUserGetGet200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantUserGetGet200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantUserGetGet200ResponseData and assigns it to the Data field.
...
func (o MerchantUserGetGet200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantUserGetGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantUserGetGet200Response struct {
	value *MerchantUserGetGet200Response
	isSet bool
}

func (v NullableMerchantUserGetGet200Response) Get() *MerchantUserGetGet200Response {
	return v.value
}

func (v *NullableMerchantUserGetGet200Response) Set(val *MerchantUserGetGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantUserGetGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantUserGetGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantUserGetGet200Response(val *MerchantUserGetGet200Response) *NullableMerchantUserGetGet200Response {
	return &NullableMerchantUserGetGet200Response{value: val, isSet: true}
}

func (v NullableMerchantUserGetGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantUserGetGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
