...
// checks if the MerchantWebhookEventListGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantWebhookEventListGet200Response{}

// MerchantWebhookEventListGet200Response struct for MerchantWebhookEventListGet200Response
type MerchantWebhookEventListGet200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantWebhookEventListGet200ResponseData `json:"data,omitempty"`
...
func NewMerchantWebhookEventListGet200Response() *MerchantWebhookEventListGet200Response {
	this := MerchantWebhookEventListGet200Response{}
	return &this
}
...
func (o *MerchantWebhookEventListGet200Response) GetData() MerchantWebhookEventListGet200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantWebhookEventListGet200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantWebhookEventListGet200ResponseData and assigns it to the Data field.
...
func (o MerchantWebhookEventListGet200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantWebhookEventListGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantWebhookEventListGet200Response struct {
	value *MerchantWebhookEventListGet200Response
	isSet bool
}

func (v NullableMerchantWebhookEventListGet200Response) Get() *MerchantWebhookEventListGet200Response {
	return v.value
}

func (v *NullableMerchantWebhookEventListGet200Response) Set(val *MerchantWebhookEventListGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantWebhookEventListGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantWebhookEventListGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantWebhookEventListGet200Response(val *MerchantWebhookEventListGet200Response) *NullableMerchantWebhookEventListGet200Response {
	return &NullableMerchantWebhookEventListGet200Response{value: val, isSet: true}
}

func (v NullableMerchantWebhookEventListGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantWebhookEventListGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
