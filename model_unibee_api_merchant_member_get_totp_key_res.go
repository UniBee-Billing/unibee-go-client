...
// checks if the UnibeeApiMerchantMemberGetTotpKeyRes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UnibeeApiMerchantMemberGetTotpKeyRes{}

// UnibeeApiMerchantMemberGetTotpKeyRes struct for UnibeeApiMerchantMemberGetTotpKeyRes
type UnibeeApiMerchantMemberGetTotpKeyRes struct {
...
func NewUnibeeApiMerchantMemberGetTotpKeyRes() *UnibeeApiMerchantMemberGetTotpKeyRes {
	this := UnibeeApiMerchantMemberGetTotpKeyRes{}
	return &this
}
...
func (o UnibeeApiMerchantMemberGetTotpKeyRes) MarshalJSON() ([]byte, error) {
...
func (o UnibeeApiMerchantMemberGetTotpKeyRes) ToMap() (map[string]interface{}, error) {
...
type NullableUnibeeApiMerchantMemberGetTotpKeyRes struct {
	value *UnibeeApiMerchantMemberGetTotpKeyRes
	isSet bool
}

func (v NullableUnibeeApiMerchantMemberGetTotpKeyRes) Get() *UnibeeApiMerchantMemberGetTotpKeyRes {
	return v.value
}

func (v *NullableUnibeeApiMerchantMemberGetTotpKeyRes) Set(val *UnibeeApiMerchantMemberGetTotpKeyRes) {
	v.value = val
	v.isSet = true
}

func (v NullableUnibeeApiMerchantMemberGetTotpKeyRes) IsSet() bool {
	return v.isSet
}

func (v *NullableUnibeeApiMerchantMemberGetTotpKeyRes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUnibeeApiMerchantMemberGetTotpKeyRes(val *UnibeeApiMerchantMemberGetTotpKeyRes) *NullableUnibeeApiMerchantMemberGetTotpKeyRes {
	return &NullableUnibeeApiMerchantMemberGetTotpKeyRes{value: val, isSet: true}
}

func (v NullableUnibeeApiMerchantMemberGetTotpKeyRes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUnibeeApiMerchantMemberGetTotpKeyRes) UnmarshalJSON(src []byte) error {
	v.isSet = true
