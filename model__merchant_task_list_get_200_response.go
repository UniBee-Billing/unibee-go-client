...
// checks if the MerchantTaskListGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantTaskListGet200Response{}

// MerchantTaskListGet200Response struct for MerchantTaskListGet200Response
type MerchantTaskListGet200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantTaskListGet200ResponseData `json:"data,omitempty"`
...
func NewMerchantTaskListGet200Response() *MerchantTaskListGet200Response {
	this := MerchantTaskListGet200Response{}
	return &this
}
...
func (o *MerchantTaskListGet200Response) GetData() MerchantTaskListGet200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantTaskListGet200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantTaskListGet200ResponseData and assigns it to the Data field.
...
func (o MerchantTaskListGet200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantTaskListGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantTaskListGet200Response struct {
	value *MerchantTaskListGet200Response
	isSet bool
}

func (v NullableMerchantTaskListGet200Response) Get() *MerchantTaskListGet200Response {
	return v.value
}

func (v *NullableMerchantTaskListGet200Response) Set(val *MerchantTaskListGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantTaskListGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantTaskListGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantTaskListGet200Response(val *MerchantTaskListGet200Response) *NullableMerchantTaskListGet200Response {
	return &NullableMerchantTaskListGet200Response{value: val, isSet: true}
}

func (v NullableMerchantTaskListGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantTaskListGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
