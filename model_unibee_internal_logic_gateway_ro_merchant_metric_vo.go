...
// checks if the UnibeeInternalLogicGatewayRoMerchantMetricVo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UnibeeInternalLogicGatewayRoMerchantMetricVo{}

// UnibeeInternalLogicGatewayRoMerchantMetricVo struct for UnibeeInternalLogicGatewayRoMerchantMetricVo
type UnibeeInternalLogicGatewayRoMerchantMetricVo struct {
...
func NewUnibeeInternalLogicGatewayRoMerchantMetricVo() *UnibeeInternalLogicGatewayRoMerchantMetricVo {
	this := UnibeeInternalLogicGatewayRoMerchantMetricVo{}
	return &this
}
...
func (o UnibeeInternalLogicGatewayRoMerchantMetricVo) MarshalJSON() ([]byte, error) {
...
func (o UnibeeInternalLogicGatewayRoMerchantMetricVo) ToMap() (map[string]interface{}, error) {
...
type NullableUnibeeInternalLogicGatewayRoMerchantMetricVo struct {
	value *UnibeeInternalLogicGatewayRoMerchantMetricVo
	isSet bool
}

func (v NullableUnibeeInternalLogicGatewayRoMerchantMetricVo) Get() *UnibeeInternalLogicGatewayRoMerchantMetricVo {
	return v.value
}

func (v *NullableUnibeeInternalLogicGatewayRoMerchantMetricVo) Set(val *UnibeeInternalLogicGatewayRoMerchantMetricVo) {
	v.value = val
	v.isSet = true
}

func (v NullableUnibeeInternalLogicGatewayRoMerchantMetricVo) IsSet() bool {
	return v.isSet
}

func (v *NullableUnibeeInternalLogicGatewayRoMerchantMetricVo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUnibeeInternalLogicGatewayRoMerchantMetricVo(val *UnibeeInternalLogicGatewayRoMerchantMetricVo) *NullableUnibeeInternalLogicGatewayRoMerchantMetricVo {
	return &NullableUnibeeInternalLogicGatewayRoMerchantMetricVo{value: val, isSet: true}
}

func (v NullableUnibeeInternalLogicGatewayRoMerchantMetricVo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUnibeeInternalLogicGatewayRoMerchantMetricVo) UnmarshalJSON(src []byte) error {
	v.isSet = true
