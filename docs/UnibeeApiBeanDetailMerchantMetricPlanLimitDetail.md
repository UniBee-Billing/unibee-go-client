...
**Quantity** | Pointer to **int64** | quantity for this plan | [optional] 
...
`func (o *UnibeeApiBeanDetailMerchantMetricPlanLimitDetail) GetQuantity() int64`

GetQuantity returns the Quantity field if non-nil, zero value otherwise.

### GetQuantityOk

`func (o *UnibeeApiBeanDetailMerchantMetricPlanLimitDetail) GetQuantityOk() (*int64, bool)`
...
`func (o *UnibeeApiBeanDetailMerchantMetricPlanLimitDetail) SetQuantity(v int64)`

SetQuantity sets Quantity field to given value.

### HasQuantity

`func (o *UnibeeApiBeanDetailMerchantMetricPlanLimitDetail) HasQuantity() bool`
