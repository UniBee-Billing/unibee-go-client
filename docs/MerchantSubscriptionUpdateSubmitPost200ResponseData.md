...
**InvoiceId** | Pointer to **string** | ID of the invoice generated by this update (proration or next-period invoice, depending on effectImmediate). | [optional] 
**Link** | Pointer to **string** | Hosted payment or invoice link. When paid&#x3D;false and an invoice exists, redirect the customer to this link to complete payment. | [optional] 
**Note** | Pointer to **string** | Additional message describing the update result, used for internal or merchant-facing explanations. | [optional] 
**Paid** | Pointer to **bool** | Whether the update invoice has been successfully paid at the time of response. | [optional] 
**PaymentId** | Pointer to **string** | ID of the payment created for the update invoice, if any. | [optional] 
