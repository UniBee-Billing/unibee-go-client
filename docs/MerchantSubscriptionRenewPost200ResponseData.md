# MerchantSubscriptionRenewPost200ResponseData
...
**InvoiceId** | Pointer to **string** | ID of the renewal invoice generated by this request. | [optional] 
**Link** | Pointer to **string** | Hosted payment or invoice link. When paid&#x3D;false, redirect the customer to this link to complete the renewal payment. | [optional] 
**Paid** | Pointer to **bool** | Whether the renewal invoice has been successfully paid at the time of response. | [optional] 
**PaymentId** | Pointer to **string** | ID of the payment created for the renewal invoice, if any. | [optional] 
