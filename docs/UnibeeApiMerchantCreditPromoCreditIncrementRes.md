# UnibeeApiMerchantCreditPromoCreditIncrementRes
...
`func (o *UnibeeApiMerchantCreditPromoCreditIncrementRes) GetCreditTransaction() UnibeeApiBeanCreditTransaction`

GetCreditTransaction returns the CreditTransaction field if non-nil, zero value otherwise.

### GetCreditTransactionOk

`func (o *UnibeeApiMerchantCreditPromoCreditIncrementRes) GetCreditTransactionOk() (*UnibeeApiBeanCreditTransaction, bool)`
...
`func (o *UnibeeApiMerchantCreditPromoCreditIncrementRes) SetCreditTransaction(v UnibeeApiBeanCreditTransaction)`

SetCreditTransaction sets CreditTransaction field to given value.

### HasCreditTransaction

`func (o *UnibeeApiMerchantCreditPromoCreditIncrementRes) HasCreditTransaction() bool`
