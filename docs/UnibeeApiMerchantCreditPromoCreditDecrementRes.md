# UnibeeApiMerchantCreditPromoCreditDecrementRes
...
`func (o *UnibeeApiMerchantCreditPromoCreditDecrementRes) GetCreditTransaction() UnibeeApiBeanCreditTransaction`

GetCreditTransaction returns the CreditTransaction field if non-nil, zero value otherwise.

### GetCreditTransactionOk

`func (o *UnibeeApiMerchantCreditPromoCreditDecrementRes) GetCreditTransactionOk() (*UnibeeApiBeanCreditTransaction, bool)`
...
`func (o *UnibeeApiMerchantCreditPromoCreditDecrementRes) SetCreditTransaction(v UnibeeApiBeanCreditTransaction)`

SetCreditTransaction sets CreditTransaction field to given value.

### HasCreditTransaction

`func (o *UnibeeApiMerchantCreditPromoCreditDecrementRes) HasCreditTransaction() bool`
