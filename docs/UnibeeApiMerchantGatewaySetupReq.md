...
`func (o *UnibeeApiMerchantGatewaySetupReq) GetCompanyIssuer() UnibeeApiBeanDetailGatewayCompanyIssuer`

GetCompanyIssuer returns the CompanyIssuer field if non-nil, zero value otherwise.

### GetCompanyIssuerOk

`func (o *UnibeeApiMerchantGatewaySetupReq) GetCompanyIssuerOk() (*UnibeeApiBeanDetailGatewayCompanyIssuer, bool)`
...
`func (o *UnibeeApiMerchantGatewaySetupReq) SetCompanyIssuer(v UnibeeApiBeanDetailGatewayCompanyIssuer)`

SetCompanyIssuer sets CompanyIssuer field to given value.

### HasCompanyIssuer

`func (o *UnibeeApiMerchantGatewaySetupReq) HasCompanyIssuer() bool`
...
`func (o *UnibeeApiMerchantGatewaySetupReq) GetMetadata() map[string]map[string]interface{}`

GetMetadata returns the Metadata field if non-nil, zero value otherwise.

### GetMetadataOk

`func (o *UnibeeApiMerchantGatewaySetupReq) GetMetadataOk() (*map[string]map[string]interface{}, bool)`
...
`func (o *UnibeeApiMerchantGatewaySetupReq) SetMetadata(v map[string]map[string]interface{})`

SetMetadata sets Metadata field to given value.

### HasMetadata

`func (o *UnibeeApiMerchantGatewaySetupReq) HasMetadata() bool`
