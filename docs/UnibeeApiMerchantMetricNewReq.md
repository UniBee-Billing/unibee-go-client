...
**ProrationRefundEnabled** | Pointer to **bool** | Enable proration refund for this metric (reclaim metric limit on upgrade; default: false when not set) | [optional] 
...
`func (o *UnibeeApiMerchantMetricNewReq) GetMetaData() map[string]map[string]interface{}`

GetMetaData returns the MetaData field if non-nil, zero value otherwise.

### GetMetaDataOk

`func (o *UnibeeApiMerchantMetricNewReq) GetMetaDataOk() (*map[string]map[string]interface{}, bool)`
...
`func (o *UnibeeApiMerchantMetricNewReq) SetMetaData(v map[string]map[string]interface{})`

SetMetaData sets MetaData field to given value.

### HasMetaData

`func (o *UnibeeApiMerchantMetricNewReq) HasMetaData() bool`
...
`func (o *UnibeeApiMerchantMetricNewReq) GetProrationRefundEnabled() bool`
...
`func (o *UnibeeApiMerchantMetricNewReq) GetProrationRefundEnabledOk() (*bool, bool)`
...
`func (o *UnibeeApiMerchantMetricNewReq) SetProrationRefundEnabled(v bool)`

SetProrationRefundEnabled sets ProrationRefundEnabled field to given value.

### HasProrationRefundEnabled

`func (o *UnibeeApiMerchantMetricNewReq) HasProrationRefundEnabled() bool`
...
`func (o *UnibeeApiMerchantMetricNewReq) GetUnit() string`

GetUnit returns the Unit field if non-nil, zero value otherwise.

### GetUnitOk

`func (o *UnibeeApiMerchantMetricNewReq) GetUnitOk() (*string, bool)`
...
`func (o *UnibeeApiMerchantMetricNewReq) SetUnit(v string)`

SetUnit sets Unit field to given value.

### HasUnit

`func (o *UnibeeApiMerchantMetricNewReq) HasUnit() bool`
