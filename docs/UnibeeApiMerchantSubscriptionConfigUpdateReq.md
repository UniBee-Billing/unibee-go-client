...
`func (o *UnibeeApiMerchantSubscriptionConfigUpdateReq) GetGatewayVATRule() string`

GetGatewayVATRule returns the GatewayVATRule field if non-nil, zero value otherwise.

### GetGatewayVATRuleOk

`func (o *UnibeeApiMerchantSubscriptionConfigUpdateReq) GetGatewayVATRuleOk() (*string, bool)`
...
`func (o *UnibeeApiMerchantSubscriptionConfigUpdateReq) SetGatewayVATRule(v string)`
