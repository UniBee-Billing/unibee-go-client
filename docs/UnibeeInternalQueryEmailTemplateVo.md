...
`func (o *UnibeeInternalQueryEmailTemplateVo) SetCreateTime(v int64)`
...
`func (o *UnibeeInternalQueryEmailTemplateVo) GetTemplateNameOk() (*string, bool)`
...
`func (o *UnibeeInternalQueryEmailTemplateVo) SetUpdateTime(v int64)`
