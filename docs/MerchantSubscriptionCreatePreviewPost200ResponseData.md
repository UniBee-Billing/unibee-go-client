...
------------ | ------------- | ------------- | -------------
**AddonParams** | Pointer to [**[]UnibeeApiBeanPlanAddonParam**](UnibeeApiBeanPlanAddonParam.md) | Addon parameters used to compute the preview. | [optional] 
**Addons** | Pointer to [**[]UnibeeApiBeanPlanAddonDetail**](UnibeeApiBeanPlanAddonDetail.md) | Resolved addon plan details included in this preview. | [optional] 
**ApplyPromoCredit** | Pointer to **bool** | Whether promo credit is effectively applied in this preview. | [optional] 
**Currency** | Pointer to **string** | Currency used for this preview. | [optional] 
**Discount** | Pointer to [**UnibeeApiBeanMerchantDiscountCode**](UnibeeApiBeanMerchantDiscountCode.md) |  | [optional] 
**DiscountAmount** | Pointer to **int64** | Total discount amount applied in this preview, including promo credit if applicable. | [optional] 
**DiscountMessage** | Pointer to **string** | Human-readable message describing discount application result. | [optional] 
**Email** | Pointer to **string** | Resolved user email used in this preview. | [optional] 
...
**OriginAmount** | Pointer to **int64** | Original invoice amount before discounts and promo credit, in minor units. | [optional] 
...
**TotalAmount** | Pointer to **int64** | Final payable amount for the previewed invoice, including tax and after discounts, in minor units. | [optional] 
**TrialEnd** | Pointer to **int64** | trial_end, utc time | [optional] 
**UserId** | Pointer to **int64** | Resolved user ID used in this preview. | [optional] 
**VatCountryCode** | Pointer to **string** | Country code used for VAT calculation. | [optional] 
**VatCountryName** | Pointer to **string** | Country name used for VAT calculation, when available. | [optional] 
**VatNumber** | Pointer to **string** | VAT number used in this preview, if any. | [optional] 
**VatNumberValidate** | Pointer to [**UnibeeApiBeanValidResult**](UnibeeApiBeanValidResult.md) |  | [optional] 
**VatNumberValidateMessage** | Pointer to **string** | Human-readable message for VAT number validation result. | [optional] 
...
`func (o *MerchantSubscriptionCreatePreviewPost200ResponseData) GetApplyPromoCredit() bool`

GetApplyPromoCredit returns the ApplyPromoCredit field if non-nil, zero value otherwise.

### GetApplyPromoCreditOk

`func (o *MerchantSubscriptionCreatePreviewPost200ResponseData) GetApplyPromoCreditOk() (*bool, bool)`
...
`func (o *MerchantSubscriptionCreatePreviewPost200ResponseData) SetApplyPromoCredit(v bool)`

SetApplyPromoCredit sets ApplyPromoCredit field to given value.

### HasApplyPromoCredit

`func (o *MerchantSubscriptionCreatePreviewPost200ResponseData) HasApplyPromoCredit() bool`
...
`func (o *MerchantSubscriptionCreatePreviewPost200ResponseData) GetGateway() UnibeeApiBeanDetailGateway`

GetGateway returns the Gateway field if non-nil, zero value otherwise.

### GetGatewayOk

`func (o *MerchantSubscriptionCreatePreviewPost200ResponseData) GetGatewayOk() (*UnibeeApiBeanDetailGateway, bool)`
...
`func (o *MerchantSubscriptionCreatePreviewPost200ResponseData) SetGateway(v UnibeeApiBeanDetailGateway)`
...
`func (o *MerchantSubscriptionCreatePreviewPost200ResponseData) GetRecurringDiscountCode() string`
...
`func (o *MerchantSubscriptionCreatePreviewPost200ResponseData) GetRecurringDiscountCodeOk() (*string, bool)`
...
`func (o *MerchantSubscriptionCreatePreviewPost200ResponseData) SetRecurringDiscountCode(v string)`

SetRecurringDiscountCode sets RecurringDiscountCode field to given value.

### HasRecurringDiscountCode

`func (o *MerchantSubscriptionCreatePreviewPost200ResponseData) HasRecurringDiscountCode() bool`
