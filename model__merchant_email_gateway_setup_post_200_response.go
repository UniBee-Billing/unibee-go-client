...
// checks if the MerchantEmailGatewaySetupPost200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantEmailGatewaySetupPost200Response{}

// MerchantEmailGatewaySetupPost200Response struct for MerchantEmailGatewaySetupPost200Response
type MerchantEmailGatewaySetupPost200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantEmailGatewaySetupPost200ResponseData `json:"data,omitempty"`
...
func NewMerchantEmailGatewaySetupPost200Response() *MerchantEmailGatewaySetupPost200Response {
	this := MerchantEmailGatewaySetupPost200Response{}
	return &this
}
...
func (o *MerchantEmailGatewaySetupPost200Response) GetData() MerchantEmailGatewaySetupPost200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantEmailGatewaySetupPost200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantEmailGatewaySetupPost200ResponseData and assigns it to the Data field.
...
func (o MerchantEmailGatewaySetupPost200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantEmailGatewaySetupPost200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantEmailGatewaySetupPost200Response struct {
	value *MerchantEmailGatewaySetupPost200Response
	isSet bool
}

func (v NullableMerchantEmailGatewaySetupPost200Response) Get() *MerchantEmailGatewaySetupPost200Response {
	return v.value
}

func (v *NullableMerchantEmailGatewaySetupPost200Response) Set(val *MerchantEmailGatewaySetupPost200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantEmailGatewaySetupPost200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantEmailGatewaySetupPost200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantEmailGatewaySetupPost200Response(val *MerchantEmailGatewaySetupPost200Response) *NullableMerchantEmailGatewaySetupPost200Response {
	return &NullableMerchantEmailGatewaySetupPost200Response{value: val, isSet: true}
}

func (v NullableMerchantEmailGatewaySetupPost200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantEmailGatewaySetupPost200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
