...
/*
AuthSsoLoginPost Merchant Password Login
...
type MemberAuthenticationAuthSsoRegisterWithoutVerificationPostRequest struct {
	ctx context.Context
	ApiService *MemberAuthenticationService
	unibeeApiMerchantAuthRegisterWithoutVerificationReq *UnibeeApiMerchantAuthRegisterWithoutVerificationReq
}

func (r MemberAuthenticationAuthSsoRegisterWithoutVerificationPostRequest) UnibeeApiMerchantAuthRegisterWithoutVerificationReq(unibeeApiMerchantAuthRegisterWithoutVerificationReq UnibeeApiMerchantAuthRegisterWithoutVerificationReq) MemberAuthenticationAuthSsoRegisterWithoutVerificationPostRequest {
	r.unibeeApiMerchantAuthRegisterWithoutVerificationReq = &unibeeApiMerchantAuthRegisterWithoutVerificationReq
	return r
}

func (r MemberAuthenticationAuthSsoRegisterWithoutVerificationPostRequest) Execute() (*MerchantAuthSsoLoginPost200Response, *http.Response, error) {
	return r.ApiService.AuthSsoRegisterWithoutVerificationPostExecute(r)
}

/*
AuthSsoRegisterWithoutVerificationPost RegisterWithoutCode

Register with owner permission without code verification

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return MemberAuthenticationAuthSsoRegisterWithoutVerificationPostRequest
*/
func (a *MemberAuthenticationService) AuthSsoRegisterWithoutVerificationPost(ctx context.Context) MemberAuthenticationAuthSsoRegisterWithoutVerificationPostRequest {
	return MemberAuthenticationAuthSsoRegisterWithoutVerificationPostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return MerchantAuthSsoLoginPost200Response
func (a *MemberAuthenticationService) AuthSsoRegisterWithoutVerificationPostExecute(r MemberAuthenticationAuthSsoRegisterWithoutVerificationPostRequest) (*MerchantAuthSsoLoginPost200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MemberAuthenticationService.AuthSsoRegisterWithoutVerificationPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/merchant/auth/sso/register_without_verification"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.unibeeApiMerchantAuthRegisterWithoutVerificationReq == nil {
		return localVarReturnValue, nil, reportError("unibeeApiMerchantAuthRegisterWithoutVerificationReq is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.unibeeApiMerchantAuthRegisterWithoutVerificationReq
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
