...
func (r MemberAuthenticationAuthSsoPasswordSetupPostRequest) Execute() (*MerchantAuthSsoClearTotpPost200Response, *http.Response, error) {
...
// Execute executes the request
//  @return MerchantAuthSsoClearTotpPost200Response
func (a *MemberAuthenticationService) AuthSsoPasswordSetupPostExecute(r MemberAuthenticationAuthSsoPasswordSetupPostRequest) (*MerchantAuthSsoClearTotpPost200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
