...
// checks if the MerchantCheckoutDetailGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantCheckoutDetailGet200Response{}

// MerchantCheckoutDetailGet200Response struct for MerchantCheckoutDetailGet200Response
type MerchantCheckoutDetailGet200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantCheckoutDetailGet200ResponseData `json:"data,omitempty"`
...
func NewMerchantCheckoutDetailGet200Response() *MerchantCheckoutDetailGet200Response {
	this := MerchantCheckoutDetailGet200Response{}
	return &this
}
...
func (o *MerchantCheckoutDetailGet200Response) GetData() MerchantCheckoutDetailGet200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantCheckoutDetailGet200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantCheckoutDetailGet200ResponseData and assigns it to the Data field.
func (o *MerchantCheckoutDetailGet200Response) SetData(v MerchantCheckoutDetailGet200ResponseData) {
	o.Data = &v
}

// GetMerchantId returns the MerchantId field value if set, zero value otherwise.
func (o *MerchantCheckoutDetailGet200Response) GetMerchantId() int64 {
...
// and a boolean to check if the value has been set.
func (o *MerchantCheckoutDetailGet200Response) GetMerchantIdOk() (*int64, bool) {
	if o == nil || IsNil(o.MerchantId) {
		return nil, false
	}
...
func (o *MerchantCheckoutDetailGet200Response) HasMerchantId() bool {
	if o != nil && !IsNil(o.MerchantId) {
		return true
	}
...
func (o *MerchantCheckoutDetailGet200Response) SetMerchantId(v int64) {
	o.MerchantId = &v
}
...
func (o MerchantCheckoutDetailGet200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantCheckoutDetailGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantCheckoutDetailGet200Response struct {
	value *MerchantCheckoutDetailGet200Response
	isSet bool
}

func (v NullableMerchantCheckoutDetailGet200Response) Get() *MerchantCheckoutDetailGet200Response {
	return v.value
}

func (v *NullableMerchantCheckoutDetailGet200Response) Set(val *MerchantCheckoutDetailGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantCheckoutDetailGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantCheckoutDetailGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantCheckoutDetailGet200Response(val *MerchantCheckoutDetailGet200Response) *NullableMerchantCheckoutDetailGet200Response {
	return &NullableMerchantCheckoutDetailGet200Response{value: val, isSet: true}
}

func (v NullableMerchantCheckoutDetailGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantCheckoutDetailGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
