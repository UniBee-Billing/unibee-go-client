...
// checks if the MerchantPaymentRefundNewPost200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantPaymentRefundNewPost200Response{}

// MerchantPaymentRefundNewPost200Response struct for MerchantPaymentRefundNewPost200Response
type MerchantPaymentRefundNewPost200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantPaymentRefundNewPost200ResponseData `json:"data,omitempty"`
...
func NewMerchantPaymentRefundNewPost200Response() *MerchantPaymentRefundNewPost200Response {
	this := MerchantPaymentRefundNewPost200Response{}
	return &this
}
...
func (o *MerchantPaymentRefundNewPost200Response) GetData() MerchantPaymentRefundNewPost200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantPaymentRefundNewPost200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantPaymentRefundNewPost200ResponseData and assigns it to the Data field.
func (o *MerchantPaymentRefundNewPost200Response) SetData(v MerchantPaymentRefundNewPost200ResponseData) {
	o.Data = &v
}

// GetMerchantId returns the MerchantId field value if set, zero value otherwise.
func (o *MerchantPaymentRefundNewPost200Response) GetMerchantId() int64 {
...
// and a boolean to check if the value has been set.
func (o *MerchantPaymentRefundNewPost200Response) GetMerchantIdOk() (*int64, bool) {
	if o == nil || IsNil(o.MerchantId) {
		return nil, false
	}
...
func (o *MerchantPaymentRefundNewPost200Response) HasMerchantId() bool {
	if o != nil && !IsNil(o.MerchantId) {
		return true
	}
...
func (o *MerchantPaymentRefundNewPost200Response) SetMerchantId(v int64) {
	o.MerchantId = &v
}
...
func (o MerchantPaymentRefundNewPost200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantPaymentRefundNewPost200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantPaymentRefundNewPost200Response struct {
	value *MerchantPaymentRefundNewPost200Response
	isSet bool
}

func (v NullableMerchantPaymentRefundNewPost200Response) Get() *MerchantPaymentRefundNewPost200Response {
	return v.value
}

func (v *NullableMerchantPaymentRefundNewPost200Response) Set(val *MerchantPaymentRefundNewPost200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantPaymentRefundNewPost200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantPaymentRefundNewPost200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantPaymentRefundNewPost200Response(val *MerchantPaymentRefundNewPost200Response) *NullableMerchantPaymentRefundNewPost200Response {
	return &NullableMerchantPaymentRefundNewPost200Response{value: val, isSet: true}
}

func (v NullableMerchantPaymentRefundNewPost200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantPaymentRefundNewPost200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
