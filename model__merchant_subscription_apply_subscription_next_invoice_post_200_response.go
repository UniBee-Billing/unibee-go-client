...
// checks if the MerchantSubscriptionApplySubscriptionNextInvoicePost200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantSubscriptionApplySubscriptionNextInvoicePost200Response{}

// MerchantSubscriptionApplySubscriptionNextInvoicePost200Response struct for MerchantSubscriptionApplySubscriptionNextInvoicePost200Response
type MerchantSubscriptionApplySubscriptionNextInvoicePost200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantSubscriptionApplySubscriptionNextInvoicePost200ResponseData `json:"data,omitempty"`
...
func NewMerchantSubscriptionApplySubscriptionNextInvoicePost200Response() *MerchantSubscriptionApplySubscriptionNextInvoicePost200Response {
	this := MerchantSubscriptionApplySubscriptionNextInvoicePost200Response{}
	return &this
}
...
func (o *MerchantSubscriptionApplySubscriptionNextInvoicePost200Response) GetData() MerchantSubscriptionApplySubscriptionNextInvoicePost200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantSubscriptionApplySubscriptionNextInvoicePost200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantSubscriptionApplySubscriptionNextInvoicePost200ResponseData and assigns it to the Data field.
...
func (o MerchantSubscriptionApplySubscriptionNextInvoicePost200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantSubscriptionApplySubscriptionNextInvoicePost200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantSubscriptionApplySubscriptionNextInvoicePost200Response struct {
	value *MerchantSubscriptionApplySubscriptionNextInvoicePost200Response
	isSet bool
}

func (v NullableMerchantSubscriptionApplySubscriptionNextInvoicePost200Response) Get() *MerchantSubscriptionApplySubscriptionNextInvoicePost200Response {
	return v.value
}

func (v *NullableMerchantSubscriptionApplySubscriptionNextInvoicePost200Response) Set(val *MerchantSubscriptionApplySubscriptionNextInvoicePost200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantSubscriptionApplySubscriptionNextInvoicePost200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantSubscriptionApplySubscriptionNextInvoicePost200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantSubscriptionApplySubscriptionNextInvoicePost200Response(val *MerchantSubscriptionApplySubscriptionNextInvoicePost200Response) *NullableMerchantSubscriptionApplySubscriptionNextInvoicePost200Response {
	return &NullableMerchantSubscriptionApplySubscriptionNextInvoicePost200Response{value: val, isSet: true}
}

func (v NullableMerchantSubscriptionApplySubscriptionNextInvoicePost200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantSubscriptionApplySubscriptionNextInvoicePost200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
