...
// checks if the MerchantCreditDetailGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantCreditDetailGet200Response{}

// MerchantCreditDetailGet200Response struct for MerchantCreditDetailGet200Response
type MerchantCreditDetailGet200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantCreditDetailGet200ResponseData `json:"data,omitempty"`
...
func NewMerchantCreditDetailGet200Response() *MerchantCreditDetailGet200Response {
	this := MerchantCreditDetailGet200Response{}
	return &this
}
...
func (o *MerchantCreditDetailGet200Response) GetData() MerchantCreditDetailGet200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantCreditDetailGet200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantCreditDetailGet200ResponseData and assigns it to the Data field.
func (o *MerchantCreditDetailGet200Response) SetData(v MerchantCreditDetailGet200ResponseData) {
	o.Data = &v
}

// GetMerchantId returns the MerchantId field value if set, zero value otherwise.
func (o *MerchantCreditDetailGet200Response) GetMerchantId() int64 {
...
// and a boolean to check if the value has been set.
func (o *MerchantCreditDetailGet200Response) GetMerchantIdOk() (*int64, bool) {
	if o == nil || IsNil(o.MerchantId) {
		return nil, false
	}
...
func (o *MerchantCreditDetailGet200Response) HasMerchantId() bool {
	if o != nil && !IsNil(o.MerchantId) {
		return true
	}
...
func (o *MerchantCreditDetailGet200Response) SetMerchantId(v int64) {
	o.MerchantId = &v
}
...
func (o MerchantCreditDetailGet200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantCreditDetailGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantCreditDetailGet200Response struct {
	value *MerchantCreditDetailGet200Response
	isSet bool
}

func (v NullableMerchantCreditDetailGet200Response) Get() *MerchantCreditDetailGet200Response {
	return v.value
}

func (v *NullableMerchantCreditDetailGet200Response) Set(val *MerchantCreditDetailGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantCreditDetailGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantCreditDetailGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantCreditDetailGet200Response(val *MerchantCreditDetailGet200Response) *NullableMerchantCreditDetailGet200Response {
	return &NullableMerchantCreditDetailGet200Response{value: val, isSet: true}
}

func (v NullableMerchantCreditDetailGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantCreditDetailGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
