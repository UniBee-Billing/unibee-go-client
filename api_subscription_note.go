...
func (r SubscriptionNoteSubscriptionNewAdminNotePostRequest) Execute() (*MerchantAuthSsoClearTotpPost200Response, *http.Response, error) {
...
func (a *SubscriptionNoteService) SubscriptionNewAdminNotePostExecute(r SubscriptionNoteSubscriptionNewAdminNotePostRequest) (*MerchantAuthSsoClearTotpPost200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
