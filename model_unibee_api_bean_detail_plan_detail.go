...
type UnibeeApiBeanDetailPlanDetail struct {
	...
	MetricMeteredCharge []UnibeeApiBeanDetailMetricPlanChargeDetail `json:"metricMeteredCharge,omitempty"`
	// MetricPlanLimits
	MetricPlanLimits []UnibeeApiBeanMerchantMetricPlanLimit `json:"metricPlanLimits,omitempty"`
	// Plan's MetricRecurringCharge
	MetricRecurringCharge []UnibeeApiBeanDetailMetricPlanChargeDetail `json:"metricRecurringCharge,omitempty"`
	// OneTimeAddonIds
...
func (o *UnibeeApiBeanDetailPlanDetail) GetMetricMeteredCharge() []UnibeeApiBeanDetailMetricPlanChargeDetail {
	if o == nil || IsNil(o.MetricMeteredCharge) {
		var ret []UnibeeApiBeanDetailMetricPlanChargeDetail
		return ret
	}
...
// SetMetricMeteredCharge gets a reference to the given []UnibeeApiBeanDetailMetricPlanChargeDetail and assigns it to the MetricMeteredCharge field.
...
// SetMetricRecurringCharge gets a reference to the given []UnibeeApiBeanDetailMetricPlanChargeDetail and assigns it to the MetricRecurringCharge field.
