...
// checks if the MerchantCheckoutGetLinkGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantCheckoutGetLinkGet200Response{}

// MerchantCheckoutGetLinkGet200Response struct for MerchantCheckoutGetLinkGet200Response
type MerchantCheckoutGetLinkGet200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantCheckoutGetLinkGet200ResponseData `json:"data,omitempty"`
...
func NewMerchantCheckoutGetLinkGet200Response() *MerchantCheckoutGetLinkGet200Response {
	this := MerchantCheckoutGetLinkGet200Response{}
	return &this
}
...
func (o *MerchantCheckoutGetLinkGet200Response) GetData() MerchantCheckoutGetLinkGet200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantCheckoutGetLinkGet200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantCheckoutGetLinkGet200ResponseData and assigns it to the Data field.
...
func (o MerchantCheckoutGetLinkGet200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantCheckoutGetLinkGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantCheckoutGetLinkGet200Response struct {
	value *MerchantCheckoutGetLinkGet200Response
	isSet bool
}

func (v NullableMerchantCheckoutGetLinkGet200Response) Get() *MerchantCheckoutGetLinkGet200Response {
	return v.value
}

func (v *NullableMerchantCheckoutGetLinkGet200Response) Set(val *MerchantCheckoutGetLinkGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantCheckoutGetLinkGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantCheckoutGetLinkGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantCheckoutGetLinkGet200Response(val *MerchantCheckoutGetLinkGet200Response) *NullableMerchantCheckoutGetLinkGet200Response {
	return &NullableMerchantCheckoutGetLinkGet200Response{value: val, isSet: true}
}

func (v NullableMerchantCheckoutGetLinkGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantCheckoutGetLinkGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
