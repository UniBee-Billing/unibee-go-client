...
// checks if the MerchantPaymentMethodGetGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantPaymentMethodGetGet200Response{}

// MerchantPaymentMethodGetGet200Response struct for MerchantPaymentMethodGetGet200Response
type MerchantPaymentMethodGetGet200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantPaymentMethodGetGet200ResponseData `json:"data,omitempty"`
...
func NewMerchantPaymentMethodGetGet200Response() *MerchantPaymentMethodGetGet200Response {
	this := MerchantPaymentMethodGetGet200Response{}
	return &this
}
...
func (o *MerchantPaymentMethodGetGet200Response) GetData() MerchantPaymentMethodGetGet200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantPaymentMethodGetGet200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantPaymentMethodGetGet200ResponseData and assigns it to the Data field.
...
func (o MerchantPaymentMethodGetGet200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantPaymentMethodGetGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantPaymentMethodGetGet200Response struct {
	value *MerchantPaymentMethodGetGet200Response
	isSet bool
}

func (v NullableMerchantPaymentMethodGetGet200Response) Get() *MerchantPaymentMethodGetGet200Response {
	return v.value
}

func (v *NullableMerchantPaymentMethodGetGet200Response) Set(val *MerchantPaymentMethodGetGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantPaymentMethodGetGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantPaymentMethodGetGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantPaymentMethodGetGet200Response(val *MerchantPaymentMethodGetGet200Response) *NullableMerchantPaymentMethodGetGet200Response {
	return &NullableMerchantPaymentMethodGetGet200Response{value: val, isSet: true}
}

func (v NullableMerchantPaymentMethodGetGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantPaymentMethodGetGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
