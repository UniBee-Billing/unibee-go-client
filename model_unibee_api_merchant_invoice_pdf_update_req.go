...
type UnibeeApiMerchantInvoicePdfUpdateReq struct {
	...
	LocalizedExchangeRate *string `json:"localizedExchangeRate,omitempty"`
...
// SetLocalizedExchangeRate gets a reference to the given string and assigns it to the LocalizedExchangeRate field.
