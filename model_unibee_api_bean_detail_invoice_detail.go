...
type UnibeeApiBeanDetailInvoiceDetail struct {
	...
	PlanSnapshot *UnibeeApiBeanDetailInvoicePlanSnapshot `json:"planSnapshot,omitempty"`
...
func (o *UnibeeApiBeanDetailInvoiceDetail) GetPlanSnapshot() UnibeeApiBeanDetailInvoicePlanSnapshot {
	if o == nil || IsNil(o.PlanSnapshot) {
		var ret UnibeeApiBeanDetailInvoicePlanSnapshot
		return ret
	}
...
// SetPlanSnapshot gets a reference to the given UnibeeApiBeanDetailInvoicePlanSnapshot and assigns it to the PlanSnapshot field.
