...
type UnibeeApiBeanDetailInvoiceDetail struct {
	...
	// Invoice auto-charge source flag. True means this invoice was created by system auto-renew/auto-billing flow (createFrom=AutoRenew). It does NOT guarantee the invoice was finally paid by system auto-charge.
	...
	UserMetricChargeForInvoice *UnibeeApiBeanUserMetricChargeInvoiceItemEntity `json:"userMetricChargeForInvoice,omitempty"`
...
// GetUserMetricChargeForInvoice returns the UserMetricChargeForInvoice field value if set, zero value otherwise.
func (o *UnibeeApiBeanDetailInvoiceDetail) GetUserMetricChargeForInvoice() UnibeeApiBeanUserMetricChargeInvoiceItemEntity {
	if o == nil || IsNil(o.UserMetricChargeForInvoice) {
		var ret UnibeeApiBeanUserMetricChargeInvoiceItemEntity
		return ret
	}
	return *o.UserMetricChargeForInvoice
}

// GetUserMetricChargeForInvoiceOk returns a tuple with the UserMetricChargeForInvoice field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UnibeeApiBeanDetailInvoiceDetail) GetUserMetricChargeForInvoiceOk() (*UnibeeApiBeanUserMetricChargeInvoiceItemEntity, bool) {
	...
	return o.UserMetricChargeForInvoice, true
}
...
// SetUserMetricChargeForInvoice gets a reference to the given UnibeeApiBeanUserMetricChargeInvoiceItemEntity and assigns it to the UserMetricChargeForInvoice field.
func (o *UnibeeApiBeanDetailInvoiceDetail) SetUserMetricChargeForInvoice(v UnibeeApiBeanUserMetricChargeInvoiceItemEntity) {
	o.UserMetricChargeForInvoice = &v
}
...
func (o UnibeeApiBeanDetailInvoiceDetail) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.UserMetricChargeForInvoice) {
		toSerialize["userMetricChargeForInvoice"] = o.UserMetricChargeForInvoice
	}
