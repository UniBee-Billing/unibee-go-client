...
type UnibeeApiBeanDetailInvoiceDetail struct {
	...
	UserSnapshot *UnibeeApiBeanUserAccountSimplify `json:"userSnapshot,omitempty"`
...
// SetUserSnapshot gets a reference to the given UnibeeApiBeanUserAccountSimplify and assigns it to the UserSnapshot field.
