...
// checks if the MerchantCreditEditConfigPost200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantCreditEditConfigPost200Response{}

// MerchantCreditEditConfigPost200Response struct for MerchantCreditEditConfigPost200Response
type MerchantCreditEditConfigPost200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantCreditEditConfigPost200ResponseData `json:"data,omitempty"`
...
func NewMerchantCreditEditConfigPost200Response() *MerchantCreditEditConfigPost200Response {
	this := MerchantCreditEditConfigPost200Response{}
	return &this
}
...
func (o *MerchantCreditEditConfigPost200Response) GetData() MerchantCreditEditConfigPost200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantCreditEditConfigPost200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantCreditEditConfigPost200ResponseData and assigns it to the Data field.
...
func (o MerchantCreditEditConfigPost200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantCreditEditConfigPost200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantCreditEditConfigPost200Response struct {
	value *MerchantCreditEditConfigPost200Response
	isSet bool
}

func (v NullableMerchantCreditEditConfigPost200Response) Get() *MerchantCreditEditConfigPost200Response {
	return v.value
}

func (v *NullableMerchantCreditEditConfigPost200Response) Set(val *MerchantCreditEditConfigPost200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantCreditEditConfigPost200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantCreditEditConfigPost200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantCreditEditConfigPost200Response(val *MerchantCreditEditConfigPost200Response) *NullableMerchantCreditEditConfigPost200Response {
	return &NullableMerchantCreditEditConfigPost200Response{value: val, isSet: true}
}

func (v NullableMerchantCreditEditConfigPost200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantCreditEditConfigPost200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
