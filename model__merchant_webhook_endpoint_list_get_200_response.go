...
// checks if the MerchantWebhookEndpointListGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantWebhookEndpointListGet200Response{}

// MerchantWebhookEndpointListGet200Response struct for MerchantWebhookEndpointListGet200Response
type MerchantWebhookEndpointListGet200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantWebhookEndpointListGet200ResponseData `json:"data,omitempty"`
...
func NewMerchantWebhookEndpointListGet200Response() *MerchantWebhookEndpointListGet200Response {
	this := MerchantWebhookEndpointListGet200Response{}
	return &this
}
...
func (o *MerchantWebhookEndpointListGet200Response) GetData() MerchantWebhookEndpointListGet200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantWebhookEndpointListGet200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantWebhookEndpointListGet200ResponseData and assigns it to the Data field.
...
func (o MerchantWebhookEndpointListGet200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantWebhookEndpointListGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantWebhookEndpointListGet200Response struct {
	value *MerchantWebhookEndpointListGet200Response
	isSet bool
}

func (v NullableMerchantWebhookEndpointListGet200Response) Get() *MerchantWebhookEndpointListGet200Response {
	return v.value
}

func (v *NullableMerchantWebhookEndpointListGet200Response) Set(val *MerchantWebhookEndpointListGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantWebhookEndpointListGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantWebhookEndpointListGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantWebhookEndpointListGet200Response(val *MerchantWebhookEndpointListGet200Response) *NullableMerchantWebhookEndpointListGet200Response {
	return &NullableMerchantWebhookEndpointListGet200Response{value: val, isSet: true}
}

func (v NullableMerchantWebhookEndpointListGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantWebhookEndpointListGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
