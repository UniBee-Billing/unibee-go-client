...
// checks if the MerchantPlanDetailGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantPlanDetailGet200Response{}

// MerchantPlanDetailGet200Response struct for MerchantPlanDetailGet200Response
type MerchantPlanDetailGet200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantPlanDetailGet200ResponseData `json:"data,omitempty"`
...
func NewMerchantPlanDetailGet200Response() *MerchantPlanDetailGet200Response {
	this := MerchantPlanDetailGet200Response{}
	return &this
}
...
func (o *MerchantPlanDetailGet200Response) GetData() MerchantPlanDetailGet200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantPlanDetailGet200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantPlanDetailGet200ResponseData and assigns it to the Data field.
func (o *MerchantPlanDetailGet200Response) SetData(v MerchantPlanDetailGet200ResponseData) {
	o.Data = &v
}

// GetMerchantId returns the MerchantId field value if set, zero value otherwise.
func (o *MerchantPlanDetailGet200Response) GetMerchantId() int64 {
...
// and a boolean to check if the value has been set.
func (o *MerchantPlanDetailGet200Response) GetMerchantIdOk() (*int64, bool) {
	if o == nil || IsNil(o.MerchantId) {
		return nil, false
	}
...
func (o *MerchantPlanDetailGet200Response) HasMerchantId() bool {
	if o != nil && !IsNil(o.MerchantId) {
		return true
	}
...
func (o *MerchantPlanDetailGet200Response) SetMerchantId(v int64) {
	o.MerchantId = &v
}
...
func (o MerchantPlanDetailGet200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantPlanDetailGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantPlanDetailGet200Response struct {
	value *MerchantPlanDetailGet200Response
	isSet bool
}

func (v NullableMerchantPlanDetailGet200Response) Get() *MerchantPlanDetailGet200Response {
	return v.value
}

func (v *NullableMerchantPlanDetailGet200Response) Set(val *MerchantPlanDetailGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantPlanDetailGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantPlanDetailGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantPlanDetailGet200Response(val *MerchantPlanDetailGet200Response) *NullableMerchantPlanDetailGet200Response {
	return &NullableMerchantPlanDetailGet200Response{value: val, isSet: true}
}

func (v NullableMerchantPlanDetailGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantPlanDetailGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
