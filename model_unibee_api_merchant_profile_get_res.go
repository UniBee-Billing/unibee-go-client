...
type UnibeeApiMerchantProfileGetRes struct {
	...
	DefaultEmailGateway *string `json:"defaultEmailGateway,omitempty"`
	// Email Gateway Map
	EmailGateways *map[string]UnibeeApiBeanEmailGatewayConnectionAPIKeys `json:"emailGateways,omitempty"`
...
// GetCnameDomain returns the CnameDomain field value if set, zero value otherwise.
func (o *UnibeeApiMerchantProfileGetRes) GetCnameDomain() string {
	if o == nil || IsNil(o.CnameDomain) {
		var ret string
		return ret
	}
	return *o.CnameDomain
}

// GetCnameDomainOk returns a tuple with the CnameDomain field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UnibeeApiMerchantProfileGetRes) GetCnameDomainOk() (*string, bool) {
	if o == nil || IsNil(o.CnameDomain) {
		return nil, false
	}
	return o.CnameDomain, true
}
...
// SetCnameDomain gets a reference to the given string and assigns it to the CnameDomain field.
...
// GetDefaultEmailGateway returns the DefaultEmailGateway field value if set, zero value otherwise.
func (o *UnibeeApiMerchantProfileGetRes) GetDefaultEmailGateway() string {
	if o == nil || IsNil(o.DefaultEmailGateway) {
		var ret string
		return ret
	}
	return *o.DefaultEmailGateway
}

// GetDefaultEmailGatewayOk returns a tuple with the DefaultEmailGateway field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UnibeeApiMerchantProfileGetRes) GetDefaultEmailGatewayOk() (*string, bool) {
	if o == nil || IsNil(o.DefaultEmailGateway) {
		return nil, false
	}
	return o.DefaultEmailGateway, true
}
...
// SetDefaultEmailGateway gets a reference to the given string and assigns it to the DefaultEmailGateway field.
func (o *UnibeeApiMerchantProfileGetRes) SetDefaultEmailGateway(v string) {
	o.DefaultEmailGateway = &v
}

// GetEmailGateways returns the EmailGateways field value if set, zero value otherwise.
func (o *UnibeeApiMerchantProfileGetRes) GetEmailGateways() map[string]UnibeeApiBeanEmailGatewayConnectionAPIKeys {
	if o == nil || IsNil(o.EmailGateways) {
		var ret map[string]UnibeeApiBeanEmailGatewayConnectionAPIKeys
		return ret
	}
	return *o.EmailGateways
}

// GetEmailGatewaysOk returns a tuple with the EmailGateways field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UnibeeApiMerchantProfileGetRes) GetEmailGatewaysOk() (*map[string]UnibeeApiBeanEmailGatewayConnectionAPIKeys, bool) {
	if o == nil || IsNil(o.EmailGateways) {
		return nil, false
	}
	return o.EmailGateways, true
}
...
// SetEmailGateways gets a reference to the given map[string]UnibeeApiBeanEmailGatewayConnectionAPIKeys and assigns it to the EmailGateways field.
...
func (o UnibeeApiMerchantProfileGetRes) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.CnameDomain) {
		toSerialize["cnameDomain"] = o.CnameDomain
	}
	if !IsNil(o.DefaultCurrency) {
		toSerialize["defaultCurrency"] = o.DefaultCurrency
	}
	if !IsNil(o.DefaultEmailGateway) {
		toSerialize["defaultEmailGateway"] = o.DefaultEmailGateway
	}
	if !IsNil(o.EmailGateways) {
		toSerialize["emailGateways"] = o.EmailGateways
	}
