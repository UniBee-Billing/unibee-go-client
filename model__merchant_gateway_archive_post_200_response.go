...
// checks if the MerchantGatewayArchivePost200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantGatewayArchivePost200Response{}

// MerchantGatewayArchivePost200Response struct for MerchantGatewayArchivePost200Response
type MerchantGatewayArchivePost200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantGatewayArchivePost200ResponseData `json:"data,omitempty"`
...
func NewMerchantGatewayArchivePost200Response() *MerchantGatewayArchivePost200Response {
	this := MerchantGatewayArchivePost200Response{}
	return &this
}
...
func (o *MerchantGatewayArchivePost200Response) GetData() MerchantGatewayArchivePost200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantGatewayArchivePost200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantGatewayArchivePost200ResponseData and assigns it to the Data field.
...
func (o MerchantGatewayArchivePost200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantGatewayArchivePost200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantGatewayArchivePost200Response struct {
	value *MerchantGatewayArchivePost200Response
	isSet bool
}

func (v NullableMerchantGatewayArchivePost200Response) Get() *MerchantGatewayArchivePost200Response {
	return v.value
}

func (v *NullableMerchantGatewayArchivePost200Response) Set(val *MerchantGatewayArchivePost200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantGatewayArchivePost200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantGatewayArchivePost200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantGatewayArchivePost200Response(val *MerchantGatewayArchivePost200Response) *NullableMerchantGatewayArchivePost200Response {
	return &NullableMerchantGatewayArchivePost200Response{value: val, isSet: true}
}

func (v NullableMerchantGatewayArchivePost200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantGatewayArchivePost200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
