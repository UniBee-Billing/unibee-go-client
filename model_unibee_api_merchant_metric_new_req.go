...
type UnibeeApiMerchantMetricNewReq struct {
	...
	CarryoverProrationEnabled *bool `json:"carryoverProrationEnabled,omitempty"`
	// Code
	...
	ProrationRefundEnabled *bool `json:"prorationRefundEnabled,omitempty"`
...
// GetCarryoverProrationEnabled returns the CarryoverProrationEnabled field value if set, zero value otherwise.
func (o *UnibeeApiMerchantMetricNewReq) GetCarryoverProrationEnabled() bool {
	if o == nil || IsNil(o.CarryoverProrationEnabled) {
		var ret bool
		return ret
	}
	return *o.CarryoverProrationEnabled
}

// GetCarryoverProrationEnabledOk returns a tuple with the CarryoverProrationEnabled field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UnibeeApiMerchantMetricNewReq) GetCarryoverProrationEnabledOk() (*bool, bool) {
	if o == nil || IsNil(o.CarryoverProrationEnabled) {
		return nil, false
	}
	return o.CarryoverProrationEnabled, true
}
...
// SetCarryoverProrationEnabled gets a reference to the given bool and assigns it to the CarryoverProrationEnabled field.
func (o *UnibeeApiMerchantMetricNewReq) SetCarryoverProrationEnabled(v bool) {
	o.CarryoverProrationEnabled = &v
}
...
func (o *UnibeeApiMerchantMetricNewReq) GetMetaData() map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *UnibeeApiMerchantMetricNewReq) GetMetaDataOk() (*map[string]interface{}, bool) {
	if o == nil || IsNil(o.MetaData) {
		return nil, false
	}
...
func (o *UnibeeApiMerchantMetricNewReq) SetMetaData(v map[string]interface{}) {
	o.MetaData = &v
}
...
// GetProrationRefundEnabled returns the ProrationRefundEnabled field value if set, zero value otherwise.
func (o *UnibeeApiMerchantMetricNewReq) GetProrationRefundEnabled() bool {
	if o == nil || IsNil(o.ProrationRefundEnabled) {
		var ret bool
		return ret
	}
	return *o.ProrationRefundEnabled
}

// GetProrationRefundEnabledOk returns a tuple with the ProrationRefundEnabled field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UnibeeApiMerchantMetricNewReq) GetProrationRefundEnabledOk() (*bool, bool) {
	if o == nil || IsNil(o.ProrationRefundEnabled) {
		return nil, false
	}
	return o.ProrationRefundEnabled, true
}
...
// SetProrationRefundEnabled gets a reference to the given bool and assigns it to the ProrationRefundEnabled field.
func (o *UnibeeApiMerchantMetricNewReq) SetProrationRefundEnabled(v bool) {
	o.ProrationRefundEnabled = &v
}
...
func (o UnibeeApiMerchantMetricNewReq) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.CarryoverProrationEnabled) {
		toSerialize["carryoverProrationEnabled"] = o.CarryoverProrationEnabled
	}
	...
	if !IsNil(o.ProrationRefundEnabled) {
		toSerialize["prorationRefundEnabled"] = o.ProrationRefundEnabled
	}
	if !IsNil(o.Type) {
