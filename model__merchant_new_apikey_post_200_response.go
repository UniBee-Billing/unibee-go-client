...
// checks if the MerchantNewApikeyPost200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantNewApikeyPost200Response{}

// MerchantNewApikeyPost200Response struct for MerchantNewApikeyPost200Response
type MerchantNewApikeyPost200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantNewApikeyPost200ResponseData `json:"data,omitempty"`
...
func NewMerchantNewApikeyPost200Response() *MerchantNewApikeyPost200Response {
	this := MerchantNewApikeyPost200Response{}
	return &this
}
...
func (o *MerchantNewApikeyPost200Response) GetData() MerchantNewApikeyPost200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantNewApikeyPost200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantNewApikeyPost200ResponseData and assigns it to the Data field.
func (o *MerchantNewApikeyPost200Response) SetData(v MerchantNewApikeyPost200ResponseData) {
	o.Data = &v
}

// GetMerchantId returns the MerchantId field value if set, zero value otherwise.
func (o *MerchantNewApikeyPost200Response) GetMerchantId() int64 {
...
// and a boolean to check if the value has been set.
func (o *MerchantNewApikeyPost200Response) GetMerchantIdOk() (*int64, bool) {
	if o == nil || IsNil(o.MerchantId) {
		return nil, false
	}
...
func (o *MerchantNewApikeyPost200Response) HasMerchantId() bool {
	if o != nil && !IsNil(o.MerchantId) {
		return true
	}
...
func (o *MerchantNewApikeyPost200Response) SetMerchantId(v int64) {
	o.MerchantId = &v
}
...
func (o MerchantNewApikeyPost200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantNewApikeyPost200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantNewApikeyPost200Response struct {
	value *MerchantNewApikeyPost200Response
	isSet bool
}

func (v NullableMerchantNewApikeyPost200Response) Get() *MerchantNewApikeyPost200Response {
	return v.value
}

func (v *NullableMerchantNewApikeyPost200Response) Set(val *MerchantNewApikeyPost200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantNewApikeyPost200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantNewApikeyPost200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantNewApikeyPost200Response(val *MerchantNewApikeyPost200Response) *NullableMerchantNewApikeyPost200Response {
	return &NullableMerchantNewApikeyPost200Response{value: val, isSet: true}
}

func (v NullableMerchantNewApikeyPost200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantNewApikeyPost200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
