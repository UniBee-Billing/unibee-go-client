...
// checks if the MerchantInvoiceListGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantInvoiceListGet200Response{}

// MerchantInvoiceListGet200Response struct for MerchantInvoiceListGet200Response
type MerchantInvoiceListGet200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantInvoiceListGet200ResponseData `json:"data,omitempty"`
...
func NewMerchantInvoiceListGet200Response() *MerchantInvoiceListGet200Response {
	this := MerchantInvoiceListGet200Response{}
	return &this
}
...
func (o *MerchantInvoiceListGet200Response) GetData() MerchantInvoiceListGet200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantInvoiceListGet200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantInvoiceListGet200ResponseData and assigns it to the Data field.
...
func (o MerchantInvoiceListGet200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantInvoiceListGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantInvoiceListGet200Response struct {
	value *MerchantInvoiceListGet200Response
	isSet bool
}

func (v NullableMerchantInvoiceListGet200Response) Get() *MerchantInvoiceListGet200Response {
	return v.value
}

func (v *NullableMerchantInvoiceListGet200Response) Set(val *MerchantInvoiceListGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantInvoiceListGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantInvoiceListGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantInvoiceListGet200Response(val *MerchantInvoiceListGet200Response) *NullableMerchantInvoiceListGet200Response {
	return &NullableMerchantInvoiceListGet200Response{value: val, isSet: true}
}

func (v NullableMerchantInvoiceListGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantInvoiceListGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
