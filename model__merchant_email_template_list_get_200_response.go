...
// checks if the MerchantEmailTemplateListGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantEmailTemplateListGet200Response{}

// MerchantEmailTemplateListGet200Response struct for MerchantEmailTemplateListGet200Response
type MerchantEmailTemplateListGet200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantEmailTemplateListGet200ResponseData `json:"data,omitempty"`
...
func NewMerchantEmailTemplateListGet200Response() *MerchantEmailTemplateListGet200Response {
	this := MerchantEmailTemplateListGet200Response{}
	return &this
}
...
func (o *MerchantEmailTemplateListGet200Response) GetData() MerchantEmailTemplateListGet200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantEmailTemplateListGet200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantEmailTemplateListGet200ResponseData and assigns it to the Data field.
...
func (o MerchantEmailTemplateListGet200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantEmailTemplateListGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantEmailTemplateListGet200Response struct {
	value *MerchantEmailTemplateListGet200Response
	isSet bool
}

func (v NullableMerchantEmailTemplateListGet200Response) Get() *MerchantEmailTemplateListGet200Response {
	return v.value
}

func (v *NullableMerchantEmailTemplateListGet200Response) Set(val *MerchantEmailTemplateListGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantEmailTemplateListGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantEmailTemplateListGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantEmailTemplateListGet200Response(val *MerchantEmailTemplateListGet200Response) *NullableMerchantEmailTemplateListGet200Response {
	return &NullableMerchantEmailTemplateListGet200Response{value: val, isSet: true}
}

func (v NullableMerchantEmailTemplateListGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantEmailTemplateListGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
