...
type UnibeeApiMerchantPlanEditReq struct {
	...
	AutoUpgradePlanId *int32 `json:"autoUpgradePlanId,omitempty"`
	...
	CheckoutTemplateId *int32 `json:"checkoutTemplateId,omitempty"`
	// omit = no change; set to 0 to clear; >0 sets strikethrough price for regular amount (UI only)
	CompareAtAmount *int32 `json:"compareAtAmount,omitempty"`
...
// SetAutoUpgradePlanId gets a reference to the given int32 and assigns it to the AutoUpgradePlanId field.
...
// SetCheckoutTemplateId gets a reference to the given int32 and assigns it to the CheckoutTemplateId field.
...
// SetCompareAtAmount gets a reference to the given int32 and assigns it to the CompareAtAmount field.
