...
func (o *UnibeeApiMerchantPaymentMethodNewReq) GetMetadata() map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *UnibeeApiMerchantPaymentMethodNewReq) GetMetadataOk() (*map[string]interface{}, bool) {
	if o == nil || IsNil(o.Metadata) {
		return nil, false
	}
...
func (o *UnibeeApiMerchantPaymentMethodNewReq) SetMetadata(v map[string]interface{}) {
	o.Metadata = &v
}
