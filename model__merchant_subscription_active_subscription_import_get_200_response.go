...
// checks if the MerchantSubscriptionActiveSubscriptionImportGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantSubscriptionActiveSubscriptionImportGet200Response{}

// MerchantSubscriptionActiveSubscriptionImportGet200Response struct for MerchantSubscriptionActiveSubscriptionImportGet200Response
type MerchantSubscriptionActiveSubscriptionImportGet200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantSubscriptionActiveSubscriptionImportGet200ResponseData `json:"data,omitempty"`
...
func NewMerchantSubscriptionActiveSubscriptionImportGet200Response() *MerchantSubscriptionActiveSubscriptionImportGet200Response {
	this := MerchantSubscriptionActiveSubscriptionImportGet200Response{}
	return &this
}
...
func (o *MerchantSubscriptionActiveSubscriptionImportGet200Response) GetData() MerchantSubscriptionActiveSubscriptionImportGet200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantSubscriptionActiveSubscriptionImportGet200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantSubscriptionActiveSubscriptionImportGet200ResponseData and assigns it to the Data field.
...
func (o MerchantSubscriptionActiveSubscriptionImportGet200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantSubscriptionActiveSubscriptionImportGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantSubscriptionActiveSubscriptionImportGet200Response struct {
	value *MerchantSubscriptionActiveSubscriptionImportGet200Response
	isSet bool
}

func (v NullableMerchantSubscriptionActiveSubscriptionImportGet200Response) Get() *MerchantSubscriptionActiveSubscriptionImportGet200Response {
	return v.value
}

func (v *NullableMerchantSubscriptionActiveSubscriptionImportGet200Response) Set(val *MerchantSubscriptionActiveSubscriptionImportGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantSubscriptionActiveSubscriptionImportGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantSubscriptionActiveSubscriptionImportGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantSubscriptionActiveSubscriptionImportGet200Response(val *MerchantSubscriptionActiveSubscriptionImportGet200Response) *NullableMerchantSubscriptionActiveSubscriptionImportGet200Response {
	return &NullableMerchantSubscriptionActiveSubscriptionImportGet200Response{value: val, isSet: true}
}

func (v NullableMerchantSubscriptionActiveSubscriptionImportGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantSubscriptionActiveSubscriptionImportGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
