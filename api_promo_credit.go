...
type PromoCreditCreditPromoCreditRefundFromInvoicePostRequest struct {
	ctx context.Context
	ApiService *PromoCreditService
	unibeeApiMerchantCreditPromoCreditRefundFromInvoiceReq *UnibeeApiMerchantCreditPromoCreditRefundFromInvoiceReq
}

func (r PromoCreditCreditPromoCreditRefundFromInvoicePostRequest) UnibeeApiMerchantCreditPromoCreditRefundFromInvoiceReq(unibeeApiMerchantCreditPromoCreditRefundFromInvoiceReq UnibeeApiMerchantCreditPromoCreditRefundFromInvoiceReq) PromoCreditCreditPromoCreditRefundFromInvoicePostRequest {
	r.unibeeApiMerchantCreditPromoCreditRefundFromInvoiceReq = &unibeeApiMerchantCreditPromoCreditRefundFromInvoiceReq
	return r
}

func (r PromoCreditCreditPromoCreditRefundFromInvoicePostRequest) Execute() (*MerchantAuthSsoClearTotpPost200Response, *http.Response, error) {
	return r.ApiService.CreditPromoCreditRefundFromInvoicePostExecute(r)
}

/*
CreditPromoCreditRefundFromInvoicePost Promo Credit Refund

Refund user promo credit amount from refund invoice

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return PromoCreditCreditPromoCreditRefundFromInvoicePostRequest
*/
func (a *PromoCreditService) CreditPromoCreditRefundFromInvoicePost(ctx context.Context) PromoCreditCreditPromoCreditRefundFromInvoicePostRequest {
	return PromoCreditCreditPromoCreditRefundFromInvoicePostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *PromoCreditService) CreditPromoCreditRefundFromInvoicePostExecute(r PromoCreditCreditPromoCreditRefundFromInvoicePostRequest) (*MerchantAuthSsoClearTotpPost200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PromoCreditService.CreditPromoCreditRefundFromInvoicePost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/merchant/credit/promo_credit_refund_from_invoice"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.unibeeApiMerchantCreditPromoCreditRefundFromInvoiceReq == nil {
		return localVarReturnValue, nil, reportError("unibeeApiMerchantCreditPromoCreditRefundFromInvoiceReq is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.unibeeApiMerchantCreditPromoCreditRefundFromInvoiceReq
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
