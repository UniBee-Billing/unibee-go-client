...
type WebhookVatUsVatUploadHistoryListGetRequest struct {
	ctx context.Context
...
// Invoice Id
func (r WebhookVatUsVatUploadHistoryListGetRequest) InvoiceId(invoiceId string) WebhookVatUsVatUploadHistoryListGetRequest {
	r.invoiceId = &invoiceId
	return r
}

// GatewayName, em. TaxJar
func (r WebhookVatUsVatUploadHistoryListGetRequest) GatewayName(gatewayName string) WebhookVatUsVatUploadHistoryListGetRequest {
	r.gatewayName = &gatewayName
	return r
}

// UploadType, PaymentUpload or RefundUpload, default both
func (r WebhookVatUsVatUploadHistoryListGetRequest) UploadType(uploadType []string) WebhookVatUsVatUploadHistoryListGetRequest {
	r.uploadType = &uploadType
	return r
}

// Page, Start With 0
func (r WebhookVatUsVatUploadHistoryListGetRequest) Page(page int32) WebhookVatUsVatUploadHistoryListGetRequest {
	r.page = &page
	return r
}

// Count Of Page
func (r WebhookVatUsVatUploadHistoryListGetRequest) Count(count int32) WebhookVatUsVatUploadHistoryListGetRequest {
	r.count = &count
	return r
}

func (r WebhookVatUsVatUploadHistoryListGetRequest) Execute() (*MerchantVatUsVatUploadHistoryListGet200Response, *http.Response, error) {
	return r.ApiService.VatUsVatUploadHistoryListGetExecute(r)
}

/*
VatUsVatUploadHistoryListGet Get US VAT Upload History List

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return WebhookVatUsVatUploadHistoryListGetRequest
*/
func (a *WebhookService) VatUsVatUploadHistoryListGet(ctx context.Context) WebhookVatUsVatUploadHistoryListGetRequest {
	return WebhookVatUsVatUploadHistoryListGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *WebhookService) VatUsVatUploadHistoryListGetExecute(r WebhookVatUsVatUploadHistoryListGetRequest) (*MerchantVatUsVatUploadHistoryListGet200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *MerchantVatUsVatUploadHistoryListGet200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WebhookService.VatUsVatUploadHistoryListGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/merchant/vat/us_vat_upload_history_list"
	...
	if r.uploadType != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "uploadType", s.Index(i).Interface(), "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "uploadType", t, "multi")
		}
	}
	if r.page != nil {
...
type WebhookWebhookRemoveWebhookZapierConnectPostRequest struct {
	ctx context.Context
	ApiService *WebhookService
	body *map[string]interface{}
}

func (r WebhookWebhookRemoveWebhookZapierConnectPostRequest) Body(body map[string]interface{}) WebhookWebhookRemoveWebhookZapierConnectPostRequest {
	r.body = &body
	return r
}

func (r WebhookWebhookRemoveWebhookZapierConnectPostRequest) Execute() (*MerchantAuthSsoClearTotpPost200Response, *http.Response, error) {
	return r.ApiService.WebhookRemoveWebhookZapierConnectPostExecute(r)
}

/*
WebhookRemoveWebhookZapierConnectPost Remove Webhook Zapier Connnect

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return WebhookWebhookRemoveWebhookZapierConnectPostRequest
*/
func (a *WebhookService) WebhookRemoveWebhookZapierConnectPost(ctx context.Context) WebhookWebhookRemoveWebhookZapierConnectPostRequest {
	return WebhookWebhookRemoveWebhookZapierConnectPostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return MerchantAuthSsoClearTotpPost200Response
func (a *WebhookService) WebhookRemoveWebhookZapierConnectPostExecute(r WebhookWebhookRemoveWebhookZapierConnectPostRequest) (*MerchantAuthSsoClearTotpPost200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WebhookService.WebhookRemoveWebhookZapierConnectPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/merchant/webhook/remove_webhook_zapier_connect"
...
type WebhookWebhookWebhookZapierConnectUrlPostRequest struct {
	ctx context.Context
	ApiService *WebhookService
	unibeeApiMerchantWebhookGetWebhookZapierConnectURLReq *UnibeeApiMerchantWebhookGetWebhookZapierConnectURLReq
}

func (r WebhookWebhookWebhookZapierConnectUrlPostRequest) UnibeeApiMerchantWebhookGetWebhookZapierConnectURLReq(unibeeApiMerchantWebhookGetWebhookZapierConnectURLReq UnibeeApiMerchantWebhookGetWebhookZapierConnectURLReq) WebhookWebhookWebhookZapierConnectUrlPostRequest {
	r.unibeeApiMerchantWebhookGetWebhookZapierConnectURLReq = &unibeeApiMerchantWebhookGetWebhookZapierConnectURLReq
	return r
}

func (r WebhookWebhookWebhookZapierConnectUrlPostRequest) Execute() (*MerchantWebhookWebhookZapierConnectUrlPost200Response, *http.Response, error) {
	return r.ApiService.WebhookWebhookZapierConnectUrlPostExecute(r)
}

/*
WebhookWebhookZapierConnectUrlPost Get Webhook Zapier Connect Url

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return WebhookWebhookWebhookZapierConnectUrlPostRequest
*/
func (a *WebhookService) WebhookWebhookZapierConnectUrlPost(ctx context.Context) WebhookWebhookWebhookZapierConnectUrlPostRequest {
	return WebhookWebhookWebhookZapierConnectUrlPostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *WebhookService) WebhookWebhookZapierConnectUrlPostExecute(r WebhookWebhookWebhookZapierConnectUrlPostRequest) (*MerchantWebhookWebhookZapierConnectUrlPost200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *MerchantWebhookWebhookZapierConnectUrlPost200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WebhookService.WebhookWebhookZapierConnectUrlPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/merchant/webhook/webhook_zapier_connect_url"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.unibeeApiMerchantWebhookGetWebhookZapierConnectURLReq == nil {
		return localVarReturnValue, nil, reportError("unibeeApiMerchantWebhookGetWebhookZapierConnectURLReq is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.unibeeApiMerchantWebhookGetWebhookZapierConnectURLReq
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
