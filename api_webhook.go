...
type WebhookWebhookRemoveWebhookZapierOauthPostRequest struct {
	ctx context.Context
	ApiService *WebhookService
	body *map[string]interface{}
}

func (r WebhookWebhookRemoveWebhookZapierOauthPostRequest) Body(body map[string]interface{}) WebhookWebhookRemoveWebhookZapierOauthPostRequest {
	r.body = &body
	return r
}

func (r WebhookWebhookRemoveWebhookZapierOauthPostRequest) Execute() (*MerchantAuthSsoClearTotpPost200Response, *http.Response, error) {
	return r.ApiService.WebhookRemoveWebhookZapierOauthPostExecute(r)
}

/*
WebhookRemoveWebhookZapierOauthPost Remove Webhook Zapier Oauth

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return WebhookWebhookRemoveWebhookZapierOauthPostRequest
*/
func (a *WebhookService) WebhookRemoveWebhookZapierOauthPost(ctx context.Context) WebhookWebhookRemoveWebhookZapierOauthPostRequest {
	return WebhookWebhookRemoveWebhookZapierOauthPostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return MerchantAuthSsoClearTotpPost200Response
func (a *WebhookService) WebhookRemoveWebhookZapierOauthPostExecute(r WebhookWebhookRemoveWebhookZapierOauthPostRequest) (*MerchantAuthSsoClearTotpPost200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WebhookService.WebhookRemoveWebhookZapierOauthPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/merchant/webhook/remove_webhook_zapier_oauth"
...
type WebhookWebhookWebhookZapierOauthUrlPostRequest struct {
	ctx context.Context
	ApiService *WebhookService
	unibeeApiMerchantWebhookGetWebhookZapierOauthUrlReq *UnibeeApiMerchantWebhookGetWebhookZapierOauthUrlReq
}

func (r WebhookWebhookWebhookZapierOauthUrlPostRequest) UnibeeApiMerchantWebhookGetWebhookZapierOauthUrlReq(unibeeApiMerchantWebhookGetWebhookZapierOauthUrlReq UnibeeApiMerchantWebhookGetWebhookZapierOauthUrlReq) WebhookWebhookWebhookZapierOauthUrlPostRequest {
	r.unibeeApiMerchantWebhookGetWebhookZapierOauthUrlReq = &unibeeApiMerchantWebhookGetWebhookZapierOauthUrlReq
	return r
}

func (r WebhookWebhookWebhookZapierOauthUrlPostRequest) Execute() (*MerchantWebhookWebhookZapierOauthUrlPost200Response, *http.Response, error) {
	return r.ApiService.WebhookWebhookZapierOauthUrlPostExecute(r)
}

/*
WebhookWebhookZapierOauthUrlPost Get Webhook Zapier Oauth Url

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return WebhookWebhookWebhookZapierOauthUrlPostRequest
*/
func (a *WebhookService) WebhookWebhookZapierOauthUrlPost(ctx context.Context) WebhookWebhookWebhookZapierOauthUrlPostRequest {
	return WebhookWebhookWebhookZapierOauthUrlPostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return MerchantWebhookWebhookZapierOauthUrlPost200Response
func (a *WebhookService) WebhookWebhookZapierOauthUrlPostExecute(r WebhookWebhookWebhookZapierOauthUrlPostRequest) (*MerchantWebhookWebhookZapierOauthUrlPost200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *MerchantWebhookWebhookZapierOauthUrlPost200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WebhookService.WebhookWebhookZapierOauthUrlPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/merchant/webhook/webhook_zapier_oauth_url"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.unibeeApiMerchantWebhookGetWebhookZapierOauthUrlReq == nil {
		return localVarReturnValue, nil, reportError("unibeeApiMerchantWebhookGetWebhookZapierOauthUrlReq is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.unibeeApiMerchantWebhookGetWebhookZapierOauthUrlReq
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
