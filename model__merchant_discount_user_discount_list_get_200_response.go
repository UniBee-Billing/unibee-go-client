...
// checks if the MerchantDiscountUserDiscountListGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantDiscountUserDiscountListGet200Response{}

// MerchantDiscountUserDiscountListGet200Response struct for MerchantDiscountUserDiscountListGet200Response
type MerchantDiscountUserDiscountListGet200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantDiscountUserDiscountListGet200ResponseData `json:"data,omitempty"`
...
func NewMerchantDiscountUserDiscountListGet200Response() *MerchantDiscountUserDiscountListGet200Response {
	this := MerchantDiscountUserDiscountListGet200Response{}
	return &this
}
...
func (o *MerchantDiscountUserDiscountListGet200Response) GetData() MerchantDiscountUserDiscountListGet200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantDiscountUserDiscountListGet200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantDiscountUserDiscountListGet200ResponseData and assigns it to the Data field.
...
func (o MerchantDiscountUserDiscountListGet200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantDiscountUserDiscountListGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantDiscountUserDiscountListGet200Response struct {
	value *MerchantDiscountUserDiscountListGet200Response
	isSet bool
}

func (v NullableMerchantDiscountUserDiscountListGet200Response) Get() *MerchantDiscountUserDiscountListGet200Response {
	return v.value
}

func (v *NullableMerchantDiscountUserDiscountListGet200Response) Set(val *MerchantDiscountUserDiscountListGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantDiscountUserDiscountListGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantDiscountUserDiscountListGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantDiscountUserDiscountListGet200Response(val *MerchantDiscountUserDiscountListGet200Response) *NullableMerchantDiscountUserDiscountListGet200Response {
	return &NullableMerchantDiscountUserDiscountListGet200Response{value: val, isSet: true}
}

func (v NullableMerchantDiscountUserDiscountListGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantDiscountUserDiscountListGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
