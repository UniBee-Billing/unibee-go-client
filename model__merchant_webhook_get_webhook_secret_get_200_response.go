...
// checks if the MerchantWebhookGetWebhookSecretGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantWebhookGetWebhookSecretGet200Response{}

// MerchantWebhookGetWebhookSecretGet200Response struct for MerchantWebhookGetWebhookSecretGet200Response
type MerchantWebhookGetWebhookSecretGet200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantWebhookGetWebhookSecretGet200ResponseData `json:"data,omitempty"`
...
func NewMerchantWebhookGetWebhookSecretGet200Response() *MerchantWebhookGetWebhookSecretGet200Response {
	this := MerchantWebhookGetWebhookSecretGet200Response{}
	return &this
}
...
func (o *MerchantWebhookGetWebhookSecretGet200Response) GetData() MerchantWebhookGetWebhookSecretGet200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantWebhookGetWebhookSecretGet200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantWebhookGetWebhookSecretGet200ResponseData and assigns it to the Data field.
...
func (o MerchantWebhookGetWebhookSecretGet200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantWebhookGetWebhookSecretGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantWebhookGetWebhookSecretGet200Response struct {
	value *MerchantWebhookGetWebhookSecretGet200Response
	isSet bool
}

func (v NullableMerchantWebhookGetWebhookSecretGet200Response) Get() *MerchantWebhookGetWebhookSecretGet200Response {
	return v.value
}

func (v *NullableMerchantWebhookGetWebhookSecretGet200Response) Set(val *MerchantWebhookGetWebhookSecretGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantWebhookGetWebhookSecretGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantWebhookGetWebhookSecretGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantWebhookGetWebhookSecretGet200Response(val *MerchantWebhookGetWebhookSecretGet200Response) *NullableMerchantWebhookGetWebhookSecretGet200Response {
	return &NullableMerchantWebhookGetWebhookSecretGet200Response{value: val, isSet: true}
}

func (v NullableMerchantWebhookGetWebhookSecretGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantWebhookGetWebhookSecretGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
