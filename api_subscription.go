...
func (r SubscriptionSubscriptionAddNewTrialStartPostRequest) Execute() (*MerchantAuthSsoClearTotpPost200Response, *http.Response, error) {
...
func (a *SubscriptionService) SubscriptionAddNewTrialStartPostExecute(r SubscriptionSubscriptionAddNewTrialStartPostRequest) (*MerchantAuthSsoClearTotpPost200Response, *http.Response, error) {
	var (
...
type SubscriptionSubscriptionApplySubscriptionNextInvoicePostRequest struct {
	ctx context.Context
	ApiService *SubscriptionService
	unibeeApiMerchantSubscriptionApplySubscriptionNextInvoiceReq *UnibeeApiMerchantSubscriptionApplySubscriptionNextInvoiceReq
}

func (r SubscriptionSubscriptionApplySubscriptionNextInvoicePostRequest) UnibeeApiMerchantSubscriptionApplySubscriptionNextInvoiceReq(unibeeApiMerchantSubscriptionApplySubscriptionNextInvoiceReq UnibeeApiMerchantSubscriptionApplySubscriptionNextInvoiceReq) SubscriptionSubscriptionApplySubscriptionNextInvoicePostRequest {
	r.unibeeApiMerchantSubscriptionApplySubscriptionNextInvoiceReq = &unibeeApiMerchantSubscriptionApplySubscriptionNextInvoiceReq
	return r
}

func (r SubscriptionSubscriptionApplySubscriptionNextInvoicePostRequest) Execute() (*MerchantSubscriptionApplySubscriptionNextInvoicePost200Response, *http.Response, error) {
	return r.ApiService.SubscriptionApplySubscriptionNextInvoicePostExecute(r)
}

/*
SubscriptionApplySubscriptionNextInvoicePost Apply Discount Or Premo Credit To Next Invoice

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return SubscriptionSubscriptionApplySubscriptionNextInvoicePostRequest
*/
func (a *SubscriptionService) SubscriptionApplySubscriptionNextInvoicePost(ctx context.Context) SubscriptionSubscriptionApplySubscriptionNextInvoicePostRequest {
	return SubscriptionSubscriptionApplySubscriptionNextInvoicePostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *SubscriptionService) SubscriptionApplySubscriptionNextInvoicePostExecute(r SubscriptionSubscriptionApplySubscriptionNextInvoicePostRequest) (*MerchantSubscriptionApplySubscriptionNextInvoicePost200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *MerchantSubscriptionApplySubscriptionNextInvoicePost200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SubscriptionService.SubscriptionApplySubscriptionNextInvoicePost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/merchant/subscription/apply_subscription_next_invoice"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.unibeeApiMerchantSubscriptionApplySubscriptionNextInvoiceReq == nil {
		return localVarReturnValue, nil, reportError("unibeeApiMerchantSubscriptionApplySubscriptionNextInvoiceReq is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.unibeeApiMerchantSubscriptionApplySubscriptionNextInvoiceReq
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
func (r SubscriptionSubscriptionCancelAtPeriodEndPostRequest) Execute() (*MerchantAuthSsoClearTotpPost200Response, *http.Response, error) {
...
// Execute executes the request
//  @return MerchantAuthSsoClearTotpPost200Response
func (a *SubscriptionService) SubscriptionCancelAtPeriodEndPostExecute(r SubscriptionSubscriptionCancelAtPeriodEndPostRequest) (*MerchantAuthSsoClearTotpPost200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SubscriptionSubscriptionCancelLastCancelAtPeriodEndPostRequest) Execute() (*MerchantAuthSsoClearTotpPost200Response, *http.Response, error) {
...
// Execute executes the request
//  @return MerchantAuthSsoClearTotpPost200Response
func (a *SubscriptionService) SubscriptionCancelLastCancelAtPeriodEndPostExecute(r SubscriptionSubscriptionCancelLastCancelAtPeriodEndPostRequest) (*MerchantAuthSsoClearTotpPost200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SubscriptionSubscriptionCancelPostRequest) Execute() (*MerchantAuthSsoClearTotpPost200Response, *http.Response, error) {
...
// Execute executes the request
//  @return MerchantAuthSsoClearTotpPost200Response
func (a *SubscriptionService) SubscriptionCancelPostExecute(r SubscriptionSubscriptionCancelPostRequest) (*MerchantAuthSsoClearTotpPost200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
type SubscriptionSubscriptionChangeCurrencyPostRequest struct {
	ctx context.Context
	ApiService *SubscriptionService
	unibeeApiMerchantSubscriptionChangeCurrencyReq *UnibeeApiMerchantSubscriptionChangeCurrencyReq
}

func (r SubscriptionSubscriptionChangeCurrencyPostRequest) UnibeeApiMerchantSubscriptionChangeCurrencyReq(unibeeApiMerchantSubscriptionChangeCurrencyReq UnibeeApiMerchantSubscriptionChangeCurrencyReq) SubscriptionSubscriptionChangeCurrencyPostRequest {
	r.unibeeApiMerchantSubscriptionChangeCurrencyReq = &unibeeApiMerchantSubscriptionChangeCurrencyReq
	return r
}

func (r SubscriptionSubscriptionChangeCurrencyPostRequest) Execute() (*MerchantAuthSsoClearTotpPost200Response, *http.Response, error) {
	return r.ApiService.SubscriptionChangeCurrencyPostExecute(r)
}

/*
SubscriptionChangeCurrencyPost Change Subscription Currency

Change subscription currency, only available for merchants with multi-currency enabled

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return SubscriptionSubscriptionChangeCurrencyPostRequest
*/
func (a *SubscriptionService) SubscriptionChangeCurrencyPost(ctx context.Context) SubscriptionSubscriptionChangeCurrencyPostRequest {
	return SubscriptionSubscriptionChangeCurrencyPostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return MerchantAuthSsoClearTotpPost200Response
func (a *SubscriptionService) SubscriptionChangeCurrencyPostExecute(r SubscriptionSubscriptionChangeCurrencyPostRequest) (*MerchantAuthSsoClearTotpPost200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SubscriptionService.SubscriptionChangeCurrencyPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/merchant/subscription/change_currency"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.unibeeApiMerchantSubscriptionChangeCurrencyReq == nil {
		return localVarReturnValue, nil, reportError("unibeeApiMerchantSubscriptionChangeCurrencyReq is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.unibeeApiMerchantSubscriptionChangeCurrencyReq
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
type SubscriptionSubscriptionChangeDueDayPostRequest struct {
	ctx context.Context
	ApiService *SubscriptionService
	unibeeApiMerchantSubscriptionChangeDueDayReq *UnibeeApiMerchantSubscriptionChangeDueDayReq
}

func (r SubscriptionSubscriptionChangeDueDayPostRequest) UnibeeApiMerchantSubscriptionChangeDueDayReq(unibeeApiMerchantSubscriptionChangeDueDayReq UnibeeApiMerchantSubscriptionChangeDueDayReq) SubscriptionSubscriptionChangeDueDayPostRequest {
	r.unibeeApiMerchantSubscriptionChangeDueDayReq = &unibeeApiMerchantSubscriptionChangeDueDayReq
	return r
}

func (r SubscriptionSubscriptionChangeDueDayPostRequest) Execute() (*MerchantAuthSsoClearTotpPost200Response, *http.Response, error) {
	return r.ApiService.SubscriptionChangeDueDayPostExecute(r)
}

/*
SubscriptionChangeDueDayPost Change Subscription Due Day

Change subscription due day

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return SubscriptionSubscriptionChangeDueDayPostRequest
*/
func (a *SubscriptionService) SubscriptionChangeDueDayPost(ctx context.Context) SubscriptionSubscriptionChangeDueDayPostRequest {
	return SubscriptionSubscriptionChangeDueDayPostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return MerchantAuthSsoClearTotpPost200Response
func (a *SubscriptionService) SubscriptionChangeDueDayPostExecute(r SubscriptionSubscriptionChangeDueDayPostRequest) (*MerchantAuthSsoClearTotpPost200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SubscriptionService.SubscriptionChangeDueDayPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/merchant/subscription/change_due_day"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.unibeeApiMerchantSubscriptionChangeDueDayReq == nil {
		return localVarReturnValue, nil, reportError("unibeeApiMerchantSubscriptionChangeDueDayReq is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.unibeeApiMerchantSubscriptionChangeDueDayReq
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
func (r SubscriptionSubscriptionChangeGatewayPostRequest) Execute() (*MerchantAuthSsoClearTotpPost200Response, *http.Response, error) {
...
// Execute executes the request
//  @return MerchantAuthSsoClearTotpPost200Response
func (a *SubscriptionService) SubscriptionChangeGatewayPostExecute(r SubscriptionSubscriptionChangeGatewayPostRequest) (*MerchantAuthSsoClearTotpPost200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
// ExternalUserId
func (r SubscriptionSubscriptionListGetRequest) ExternalUserId(externalUserId string) SubscriptionSubscriptionListGetRequest {
	r.externalUserId = &externalUserId
	return r
}

// Search SubscriptionId|Email
func (r SubscriptionSubscriptionListGetRequest) SearchKey(searchKey string) SubscriptionSubscriptionListGetRequest {
	r.searchKey = &searchKey
	return r
}

// The filter email of subscription user
func (r SubscriptionSubscriptionListGetRequest) Email(email string) SubscriptionSubscriptionListGetRequest {
	r.email = &email
	return r
}
...
// UserId
func (r SubscriptionSubscriptionPreviewSubscriptionNextInvoiceGetRequest) UserId(userId int64) SubscriptionSubscriptionPreviewSubscriptionNextInvoiceGetRequest {
	r.userId = &userId
	return r
}

// ExternalUserId, unique, either ExternalUserId&amp;Email or UserId needed if subscriptionId not specified
func (r SubscriptionSubscriptionPreviewSubscriptionNextInvoiceGetRequest) ExternalUserId(externalUserId string) SubscriptionSubscriptionPreviewSubscriptionNextInvoiceGetRequest {
	r.externalUserId = &externalUserId
	return r
}

// default product will use if productId not specified and subscriptionId is blank
func (r SubscriptionSubscriptionPreviewSubscriptionNextInvoiceGetRequest) ProductId(productId int64) SubscriptionSubscriptionPreviewSubscriptionNextInvoiceGetRequest {
...
func (r SubscriptionSubscriptionPreviewSubscriptionNextInvoiceGetRequest) Execute() (*MerchantSubscriptionApplySubscriptionNextInvoicePost200Response, *http.Response, error) {
...
// Execute executes the request
//  @return MerchantSubscriptionApplySubscriptionNextInvoicePost200Response
func (a *SubscriptionService) SubscriptionPreviewSubscriptionNextInvoiceGetExecute(r SubscriptionSubscriptionPreviewSubscriptionNextInvoiceGetRequest) (*MerchantSubscriptionApplySubscriptionNextInvoicePost200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SubscriptionSubscriptionUserPendingCryptoSubscriptionDetailGetRequest) Execute() (*MerchantSubscriptionActiveSubscriptionImportPost200Response, *http.Response, error) {
...
func (a *SubscriptionService) SubscriptionUserPendingCryptoSubscriptionDetailGetExecute(r SubscriptionSubscriptionUserPendingCryptoSubscriptionDetailGetRequest) (*MerchantSubscriptionActiveSubscriptionImportPost200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SubscriptionSubscriptionUserPendingCryptoSubscriptionDetailPostRequest) Execute() (*MerchantSubscriptionActiveSubscriptionImportPost200Response, *http.Response, error) {
...
// Execute executes the request
//  @return MerchantSubscriptionActiveSubscriptionImportPost200Response
func (a *SubscriptionService) SubscriptionUserPendingCryptoSubscriptionDetailPostExecute(r SubscriptionSubscriptionUserPendingCryptoSubscriptionDetailPostRequest) (*MerchantSubscriptionActiveSubscriptionImportPost200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
