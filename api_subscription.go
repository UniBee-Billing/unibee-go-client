...
type SubscriptionSubscriptionPendingUpdateDetailGetRequest struct {
	ctx context.Context
	ApiService *SubscriptionService
...
func (r SubscriptionSubscriptionPendingUpdateDetailGetRequest) SubscriptionPendingUpdateId(subscriptionPendingUpdateId string) SubscriptionSubscriptionPendingUpdateDetailGetRequest {
	r.subscriptionPendingUpdateId = &subscriptionPendingUpdateId
	return r
}

func (r SubscriptionSubscriptionPendingUpdateDetailGetRequest) Execute() (*MerchantSubscriptionPendingUpdateDetailGet200Response, *http.Response, error) {
	return r.ApiService.SubscriptionPendingUpdateDetailGetExecute(r)
}

/*
SubscriptionPendingUpdateDetailGet SubscriptionPendingUpdateDetail

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return SubscriptionSubscriptionPendingUpdateDetailGetRequest
*/
func (a *SubscriptionService) SubscriptionPendingUpdateDetailGet(ctx context.Context) SubscriptionSubscriptionPendingUpdateDetailGetRequest {
	return SubscriptionSubscriptionPendingUpdateDetailGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *SubscriptionService) SubscriptionPendingUpdateDetailGetExecute(r SubscriptionSubscriptionPendingUpdateDetailGetRequest) (*MerchantSubscriptionPendingUpdateDetailGet200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SubscriptionService.SubscriptionPendingUpdateDetailGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
