...
*AdminMember* | [**MemberClearOauthPost**](docs/AdminMember.md#memberclearoauthpost) | **Post** /merchant/member/clear_oauth | Clear Member OAuth Account
...
*AdminMember* | [**MemberUpdateOauthPost**](docs/AdminMember.md#memberupdateoauthpost) | **Post** /merchant/member/update_oauth | Update Member OAuth Account
...
*BatchDiscount* | [**DiscountBatchChildrenDetailGet**](docs/BatchDiscount.md#discountbatchchildrendetailget) | **Get** /merchant/discount/batch/children/detail | Get Batch Child Code Detail
*BatchDiscount* | [**DiscountBatchChildrenDetailPost**](docs/BatchDiscount.md#discountbatchchildrendetailpost) | **Post** /merchant/discount/batch/children/detail | Get Batch Child Code Detail
*BatchDiscount* | [**DiscountBatchChildrenGeneratePost**](docs/BatchDiscount.md#discountbatchchildrengeneratepost) | **Post** /merchant/discount/batch/children/generate | Generate Batch Child Codes
*BatchDiscount* | [**DiscountBatchChildrenListGet**](docs/BatchDiscount.md#discountbatchchildrenlistget) | **Get** /merchant/discount/batch/children/list | Get Batch Child Codes List
*BatchDiscount* | [**DiscountBatchTemplateDetailGet**](docs/BatchDiscount.md#discountbatchtemplatedetailget) | **Get** /merchant/discount/batch/template/detail | Get Batch Template Detail
*BatchDiscount* | [**DiscountBatchTemplateDetailPost**](docs/BatchDiscount.md#discountbatchtemplatedetailpost) | **Post** /merchant/discount/batch/template/detail | Get Batch Template Detail
*BatchDiscount* | [**DiscountBatchTemplateEditPost**](docs/BatchDiscount.md#discountbatchtemplateeditpost) | **Post** /merchant/discount/batch/template/edit | Edit Batch Discount Template
*BatchDiscount* | [**DiscountBatchTemplateListGet**](docs/BatchDiscount.md#discountbatchtemplatelistget) | **Get** /merchant/discount/batch/template/list | Get Batch Template List
*BatchDiscount* | [**DiscountBatchTemplateNewPost**](docs/BatchDiscount.md#discountbatchtemplatenewpost) | **Post** /merchant/discount/batch/template/new | Create Batch Discount Template
*BatchDiscount* | [**DiscountBatchTemplateQuantityIncrementPost**](docs/BatchDiscount.md#discountbatchtemplatequantityincrementpost) | **Post** /merchant/discount/batch/template/quantity_increment | Increment Template Quantity
...
*Email* | [**EmailGatewaySetDefaultPost**](docs/Email.md#emailgatewaysetdefaultpost) | **Post** /merchant/email/gateway_set_default | Email Gateway Set Default
*Email* | [**EmailGatewaySetupPost**](docs/Email.md#emailgatewaysetuppost) | **Post** /merchant/email/gateway_setup | Email Gateway Setup(Sendgrid)
*Email* | [**EmailGatewaySetupV2Post**](docs/Email.md#emailgatewaysetupv2post) | **Post** /merchant/email/gateway_setup_v2 | Email Gateway Setup V2(Sendgrid|smtp)
*Email* | [**EmailHistoryListGet**](docs/Email.md#emailhistorylistget) | **Get** /merchant/email/history_list | Get Email History List
*Email* | [**EmailSendEmailToUserPost**](docs/Email.md#emailsendemailtouserpost) | **Post** /merchant/email/send_email_to_user | Send Email To User
*Email* | [**EmailSendEmailViaApiCredentialPost**](docs/Email.md#emailsendemailviaapicredentialpost) | **Post** /merchant/email/send_email_via_api_credential | Send Email Via API Credential
...
*EmailTemplate* | [**EmailTemplateTestLocalizationVersionPost**](docs/EmailTemplate.md#emailtemplatetestlocalizationversionpost) | **Post** /merchant/email/template_test_localization_version | Test Email Template Localization Version
...
*Gateway* | [**GatewayRestorePost**](docs/Gateway.md#gatewayrestorepost) | **Post** /merchant/gateway/restore | Payment Gateway Restore
*Gateway* | [**GatewaySetDefaultPost**](docs/Gateway.md#gatewaysetdefaultpost) | **Post** /merchant/gateway/set_default | Payment Gateway Set Default
...
*Invoice* | [**InvoiceCreateMarkRefundPost**](docs/Invoice.md#invoicecreatemarkrefundpost) | **Post** /merchant/invoice/create_mark_refund | Create And Mark Manual Refund (Crypto/WireTransfer/External)
*Invoice* | [**InvoiceCreditNoteListPost**](docs/Invoice.md#invoicecreditnotelistpost) | **Post** /merchant/invoice/credit_note/list | Bulk CreditNote(Refund Invoice) Invoice List
...
*Invoice* | [**InvoiceEditPaidInvoiceBillingDetailsPost**](docs/Invoice.md#invoiceeditpaidinvoicebillingdetailspost) | **Post** /merchant/invoice/edit_paid_invoice_billing_details | Edit Paid Invoice Billing Details (Exception)
*Invoice* | [**InvoiceEditPost**](docs/Invoice.md#invoiceeditpost) | **Post** /merchant/invoice/edit | Invoice Edit
*Invoice* | [**InvoiceExternalGatewayInvoiceMarkPaidPost**](docs/Invoice.md#invoiceexternalgatewayinvoicemarkpaidpost) | **Post** /merchant/invoice/external_gateway_invoice/mark_paid | [Deprecated] Mark External Gateway Invoice As Paid
*Invoice* | [**InvoiceExternalGatewayInvoiceMarkRefundedPost**](docs/Invoice.md#invoiceexternalgatewayinvoicemarkrefundedpost) | **Post** /merchant/invoice/external_gateway_invoice/mark_refunded | [Deprecated] Mark External Gateway Invoice As Refunded
*Invoice* | [**InvoiceExternalGatewayInvoiceUpdatePaymentLinkPost**](docs/Invoice.md#invoiceexternalgatewayinvoiceupdatepaymentlinkpost) | **Post** /merchant/invoice/external_gateway_invoice/update_payment_link | [Deprecated] Update External Gateway Invoice Payment Link
...
*Invoice* | [**InvoiceMarkRefundSuccessPost**](docs/Invoice.md#invoicemarkrefundsuccesspost) | **Post** /merchant/invoice/mark_refund_success | Mark Manual Invoice Refund As Success
*Invoice* | [**InvoiceMarkWireTransferSuccessPost**](docs/Invoice.md#invoicemarkwiretransfersuccesspost) | **Post** /merchant/invoice/mark_wire_transfer_success | Mark Wire Transfer Invoice As Paid (Manual)
...
*Invoice* | [**InvoiceSplitPaymentsGet**](docs/Invoice.md#invoicesplitpaymentsget) | **Get** /merchant/invoice/split_payments | Get Split Payments
*Invoice* | [**InvoiceSplitPaymentsPost**](docs/Invoice.md#invoicesplitpaymentspost) | **Post** /merchant/invoice/split_payments | Get Split Payments
*Invoice* | [**InvoiceSyncPaidInvoiceBillingDetailsPost**](docs/Invoice.md#invoicesyncpaidinvoicebillingdetailspost) | **Post** /merchant/invoice/sync_paid_invoice_billing_details | Sync Paid Invoice Billing Details From Latest User Profile (Exception)
*Invoice* | [**InvoiceSyncUserSnapshotPost**](docs/Invoice.md#invoicesyncusersnapshotpost) | **Post** /merchant/invoice/sync_user_snapshot | Sync Invoice User Snapshot With Latest User Info
*InvoiceImport* | [**InvoiceHistoryInvoiceImportDeletePost**](docs/InvoiceImport.md#invoicehistoryinvoiceimportdeletepost) | **Post** /merchant/invoice/history_invoice_import/delete | Delete imported history invoice
*InvoiceImport* | [**InvoiceHistoryInvoiceImportPost**](docs/InvoiceImport.md#invoicehistoryinvoiceimportpost) | **Post** /merchant/invoice/history_invoice_import | History Invoice Import (supports override)
...
*MemberAuthentication* | [**AuthSsoLoginPost**](docs/MemberAuthentication.md#authssologinpost) | **Post** /merchant/auth/sso/login | Merchant Password Login
*MemberAuthentication* | [**AuthSsoOauthGithubGet**](docs/MemberAuthentication.md#authssooauthgithubget) | **Get** /merchant/auth/sso/oauth/github | Get Oauth Github
*MemberAuthentication* | [**AuthSsoOauthGoogleGet**](docs/MemberAuthentication.md#authssooauthgoogleget) | **Get** /merchant/auth/sso/oauth/google | Get Oauth Google
*MemberAuthentication* | [**AuthSsoOauthLoginPost**](docs/MemberAuthentication.md#authssooauthloginpost) | **Post** /merchant/auth/sso/oauth/login | OAuth Login
*MemberAuthentication* | [**AuthSsoOauthMembersGet**](docs/MemberAuthentication.md#authssooauthmembersget) | **Get** /merchant/auth/sso/oauth/members | Get Oauth Members
*MemberAuthentication* | [**AuthSsoOauthRegisterPost**](docs/MemberAuthentication.md#authssooauthregisterpost) | **Post** /merchant/auth/sso/oauth/register | Register OAuth
*MemberAuthentication* | [**AuthSsoOauthSetupPost**](docs/MemberAuthentication.md#authssooauthsetuppost) | **Post** /merchant/auth/sso/oauth/setup | OAuth Setup
...
*MemberAuthentication* | [**AuthSsoRegisterEmailCheckPost**](docs/MemberAuthentication.md#authssoregisteremailcheckpost) | **Post** /merchant/auth/sso/register_email_check | Register Email Check
...
*MemberAuthentication* | [**AuthSsoRegisterWithoutVerificationPost**](docs/MemberAuthentication.md#authssoregisterwithoutverificationpost) | **Post** /merchant/auth/sso/register_without_verification | RegisterWithoutCode
*Merchant* | [**AmountMultiCurrenciesExchangePost**](docs/Merchant.md#amountmulticurrenciesexchangepost) | **Post** /merchant/amount_multi_currencies_exchange | Amount Multi Currencies Exchange
...
*Merchant* | [**GetExchangeRatePost**](docs/Merchant.md#getexchangeratepost) | **Post** /merchant/get_exchange_rate | Get Exchange Rate
...
*Merchant* | [**OverviewStatisticsGet**](docs/Merchant.md#overviewstatisticsget) | **Get** /merchant/overview_statistics | Get Merchant Overview Statistics
*Merchant* | [**SetupMultiCurrenciesPost**](docs/Merchant.md#setupmulticurrenciespost) | **Post** /merchant/setup_multi_currencies | Multi Currencies Setup
*Merchant* | [**UpdateCnameDomainPost**](docs/Merchant.md#updatecnamedomainpost) | **Post** /merchant/update_cname_domain | Update Merchant CNAME Domain
*Merchant* | [**UpdatePortalHostDomainPost**](docs/Merchant.md#updateportalhostdomainpost) | **Post** /merchant/update_portal_host_domain | Update Profile Portal Host Domain
...
*MetricEvent* | [**MetricEventCurrentValuePost**](docs/MetricEvent.md#metriceventcurrentvaluepost) | **Post** /merchant/metric/event/current_value | Get Merchant Metric Event Current Value
...
*MetricLimitQuota* | [**MetricCarryoverReprocessPost**](docs/MetricLimitQuota.md#metriccarryoverreprocesspost) | **Post** /merchant/metric/carryover/reprocess | Reprocess Metric Carry Over (Admin Tool)
*MetricLimitQuota* | [**MetricLimitAdjustPost**](docs/MetricLimitQuota.md#metriclimitadjustpost) | **Post** /merchant/metric/limit_adjust | Manual Adjust Metric Limit
...
*Payment* | [**PaymentExternalGatewayPaymentMarkFailedPost**](docs/Payment.md#paymentexternalgatewaypaymentmarkfailedpost) | **Post** /merchant/payment/external_gateway_payment/mark_failed | Mark External Gateway Payment As Failed
*Payment* | [**PaymentExternalGatewayPaymentMarkPaidPost**](docs/Payment.md#paymentexternalgatewaypaymentmarkpaidpost) | **Post** /merchant/payment/external_gateway_payment/mark_paid | Mark External Gateway Payment As Paid
*Payment* | [**PaymentExternalGatewayPaymentUpdateLinkPost**](docs/Payment.md#paymentexternalgatewaypaymentupdatelinkpost) | **Post** /merchant/payment/external_gateway_payment/update_link | Update External Gateway Payment Link
*Payment* | [**PaymentExternalGatewayRefundMarkFailedPost**](docs/Payment.md#paymentexternalgatewayrefundmarkfailedpost) | **Post** /merchant/payment/external_gateway_refund/mark_failed | Mark External Gateway Refund As Failed
*Payment* | [**PaymentExternalGatewayRefundMarkSuccessPost**](docs/Payment.md#paymentexternalgatewayrefundmarksuccesspost) | **Post** /merchant/payment/external_gateway_refund/mark_success | Mark External Gateway Refund As Success
...
*Plan* | [**PlanActivePriceChangeConfirmPost**](docs/Plan.md#planactivepricechangeconfirmpost) | **Post** /merchant/plan/active_price_change/confirm | Confirm Active Plan Price Change
*Plan* | [**PlanActivePriceChangePreviewPost**](docs/Plan.md#planactivepricechangepreviewpost) | **Post** /merchant/plan/active_price_change/preview | Preview Active Plan Price Change
...
*Plan* | [**PlanMetricLimitOverridePost**](docs/Plan.md#planmetriclimitoverridepost) | **Post** /merchant/plan/metric_limit_override | Override Metric Limits Of Plan
...
*PromoCredit* | [**CreditPromoCreditRefundFromInvoicePost**](docs/PromoCredit.md#creditpromocreditrefundfrominvoicepost) | **Post** /merchant/credit/promo_credit_refund_from_invoice | Promo Credit Refund
...
*Session* | [**SessionCustomerPortalUrlGet**](docs/Session.md#sessioncustomerportalurlget) | **Get** /merchant/session/customer_portal_url | Get Customer Portal Url
*Session* | [**SessionCustomerPortalUrlPost**](docs/Session.md#sessioncustomerportalurlpost) | **Post** /merchant/session/customer_portal_url | Get Customer Portal Url
*Session* | [**SessionNewSessionPost**](docs/Session.md#sessionnewsessionpost) | **Post** /merchant/session/new_session | New Checkout Session
...
*Subscription* | [**SubscriptionChangeCurrencyPost**](docs/Subscription.md#subscriptionchangecurrencypost) | **Post** /merchant/subscription/change_currency | Change Subscription Currency
*Subscription* | [**SubscriptionChangeDueDayPost**](docs/Subscription.md#subscriptionchangeduedaypost) | **Post** /merchant/subscription/change_due_day | Change Subscription Due Day
...
*SubscriptionImport* | [**SubscriptionActiveSubscriptionImportPost**](docs/SubscriptionImport.md#subscriptionactivesubscriptionimportpost) | **Post** /merchant/subscription/active_subscription_import | Active Subscription Import(allows repetition imports)
*SubscriptionImport* | [**SubscriptionHistorySubscriptionImportPost**](docs/SubscriptionImport.md#subscriptionhistorysubscriptionimportpost) | **Post** /merchant/subscription/history_subscription_import | History Subscription Import(Allows repetition imports)
...
*SubscriptionPayment* | [**SubscriptionNewOnetimeAddonPreviewPost**](docs/SubscriptionPayment.md#subscriptionnewonetimeaddonpreviewpost) | **Post** /merchant/subscription/new_onetime_addon_preview | New Subscription Onetime Addon Preview
...
*SubscriptionUpdate* | [**SubscriptionMetadataUpdatePost**](docs/SubscriptionUpdate.md#subscriptionmetadataupdatepost) | **Post** /merchant/subscription/metadata_update | Update Subscription Metadata
...
*SubscriptionUpdate* | [**SubscriptionRenewPreviewPost**](docs/SubscriptionUpdate.md#subscriptionrenewpreviewpost) | **Post** /merchant/subscription/renew_preview | Renew Subscription Preview
...
*User* | [**UserDeletePost**](docs/User.md#userdeletepost) | **Post** /merchant/user/delete | Delete User
...
*User* | [**UserUpdateExternalUserIdPost**](docs/User.md#userupdateexternaluseridpost) | **Post** /merchant/user/update_external_user_id | Update User ExternalUserId
...
*UserMetric* | [**MetricUserHistoryInvoicesMetricQueryableGet**](docs/UserMetric.md#metricuserhistoryinvoicesmetricqueryableget) | **Get** /merchant/metric/user/history/invoices_metric_queryable | List invoices that can be used for metric_by_invoice (paid, subscription cycle only)
*UserMetric* | [**MetricUserHistoryMetricByInvoiceGet**](docs/UserMetric.md#metricuserhistorymetricbyinvoiceget) | **Get** /merchant/metric/user/history/metric_by_invoice | Query User History Limit Metric By Invoice (History Query Mode, limit_metered and limit_recurring only)
*UserMetric* | [**MetricUserHistoryMetricBySubscriptionGet**](docs/UserMetric.md#metricuserhistorymetricbysubscriptionget) | **Get** /merchant/metric/user/history/metric_by_subscription | Query User History Limit Metric By Subscription (History Query Mode, limit_metered and limit_recurring only, non-active subscription only)
...
*VatGateway* | [**VatSetupGlobalUsVatConfigPost**](docs/VatGateway.md#vatsetupglobalusvatconfigpost) | **Post** /merchant/vat/setup_global_us_vat_config | US Vat Config Setup
*VatGateway* | [**VatSetupUsVatGatewayPost**](docs/VatGateway.md#vatsetupusvatgatewaypost) | **Post** /merchant/vat/setup_us_vat_gateway | US Vat Gateway Setup
*VatGateway* | [**VatUsVatCategoryListGet**](docs/VatGateway.md#vatusvatcategorylistget) | **Get** /merchant/vat/us_vat_category_list | Get US Vat Category List
*VatGateway* | [**VatUsVatValidateAddressPost**](docs/VatGateway.md#vatusvatvalidateaddresspost) | **Post** /merchant/vat/us_vat_validate_address | Validate US Vat Address
*VatGateway* | [**VatVatNumberValidateHistoryActivatePost**](docs/VatGateway.md#vatvatnumbervalidatehistoryactivatepost) | **Post** /merchant/vat/vat_number_validate_history_activate | Vat Number Validation History Activate
*VatGateway* | [**VatVatNumberValidateHistoryDeactivatePost**](docs/VatGateway.md#vatvatnumbervalidatehistorydeactivatepost) | **Post** /merchant/vat/vat_number_validate_history_deactivate | Vat Number Validation History Deactivate
*VatGateway* | [**VatVatNumberValidateHistoryPost**](docs/VatGateway.md#vatvatnumbervalidatehistorypost) | **Post** /merchant/vat/vat_number_validate_history | Vat Number Validation History
...
*Webhook* | [**VatUsVatUploadHistoryListGet**](docs/Webhook.md#vatusvatuploadhistorylistget) | **Get** /merchant/vat/us_vat_upload_history_list | Get US VAT Upload History List
...
*Webhook* | [**WebhookRemoveWebhookZapierConnectPost**](docs/Webhook.md#webhookremovewebhookzapierconnectpost) | **Post** /merchant/webhook/remove_webhook_zapier_connect | Remove Webhook Zapier Connnect
...
*Webhook* | [**WebhookWebhookZapierConnectUrlPost**](docs/Webhook.md#webhookwebhookzapierconnecturlpost) | **Post** /merchant/webhook/webhook_zapier_connect_url | Get Webhook Zapier Connect Url


## Documentation For Models

 - [MerchantAmountMultiCurrenciesExchangePost200Response](docs/MerchantAmountMultiCurrenciesExchangePost200Response.md)
 - [MerchantAmountMultiCurrenciesExchangePost200ResponseData](docs/MerchantAmountMultiCurrenciesExchangePost200ResponseData.md)
 ...
 - [MerchantAuthSsoOauthGithubGet200Response](docs/MerchantAuthSsoOauthGithubGet200Response.md)
 - [MerchantAuthSsoOauthGithubGet200ResponseData](docs/MerchantAuthSsoOauthGithubGet200ResponseData.md)
 - [MerchantAuthSsoOauthGoogleGet200Response](docs/MerchantAuthSsoOauthGoogleGet200Response.md)
 - [MerchantAuthSsoOauthGoogleGet200ResponseData](docs/MerchantAuthSsoOauthGoogleGet200ResponseData.md)
 - [MerchantAuthSsoOauthMembersGet200Response](docs/MerchantAuthSsoOauthMembersGet200Response.md)
 - [MerchantAuthSsoOauthMembersGet200ResponseData](docs/MerchantAuthSsoOauthMembersGet200ResponseData.md)
 - [MerchantAuthSsoRegisterEmailCheckPost200Response](docs/MerchantAuthSsoRegisterEmailCheckPost200Response.md)
 - [MerchantAuthSsoRegisterEmailCheckPost200ResponseData](docs/MerchantAuthSsoRegisterEmailCheckPost200ResponseData.md)
 ...
 - [MerchantDiscountBatchChildrenDetailGet200Response](docs/MerchantDiscountBatchChildrenDetailGet200Response.md)
 - [MerchantDiscountBatchChildrenDetailGet200ResponseData](docs/MerchantDiscountBatchChildrenDetailGet200ResponseData.md)
 - [MerchantDiscountBatchChildrenGeneratePost200Response](docs/MerchantDiscountBatchChildrenGeneratePost200Response.md)
 - [MerchantDiscountBatchChildrenGeneratePost200ResponseData](docs/MerchantDiscountBatchChildrenGeneratePost200ResponseData.md)
 - [MerchantDiscountBatchChildrenListGet200Response](docs/MerchantDiscountBatchChildrenListGet200Response.md)
 - [MerchantDiscountBatchChildrenListGet200ResponseData](docs/MerchantDiscountBatchChildrenListGet200ResponseData.md)
 - [MerchantDiscountBatchTemplateDetailGet200Response](docs/MerchantDiscountBatchTemplateDetailGet200Response.md)
 - [MerchantDiscountBatchTemplateDetailGet200ResponseData](docs/MerchantDiscountBatchTemplateDetailGet200ResponseData.md)
 - [MerchantDiscountBatchTemplateListGet200Response](docs/MerchantDiscountBatchTemplateListGet200Response.md)
 - [MerchantDiscountBatchTemplateListGet200ResponseData](docs/MerchantDiscountBatchTemplateListGet200ResponseData.md)
 ...
 - [MerchantEmailHistoryListGet200Response](docs/MerchantEmailHistoryListGet200Response.md)
 - [MerchantEmailHistoryListGet200ResponseData](docs/MerchantEmailHistoryListGet200ResponseData.md)
 ...
 - [MerchantGetExchangeRatePost200Response](docs/MerchantGetExchangeRatePost200Response.md)
 - [MerchantGetExchangeRatePost200ResponseData](docs/MerchantGetExchangeRatePost200ResponseData.md)
 ...
 - [MerchantInvoiceCreateMarkRefundPost200Response](docs/MerchantInvoiceCreateMarkRefundPost200Response.md)
 - [MerchantInvoiceCreateMarkRefundPost200ResponseData](docs/MerchantInvoiceCreateMarkRefundPost200ResponseData.md)
 - [MerchantInvoiceCreditNoteListPost200Response](docs/MerchantInvoiceCreditNoteListPost200Response.md)
 - [MerchantInvoiceCreditNoteListPost200ResponseData](docs/MerchantInvoiceCreditNoteListPost200ResponseData.md)
 ...
 - [MerchantInvoiceExternalGatewayInvoiceMarkPaidPost200Response](docs/MerchantInvoiceExternalGatewayInvoiceMarkPaidPost200Response.md)
 - [MerchantInvoiceExternalGatewayInvoiceMarkPaidPost200ResponseData](docs/MerchantInvoiceExternalGatewayInvoiceMarkPaidPost200ResponseData.md)
 - [MerchantInvoiceExternalGatewayInvoiceMarkRefundedPost200Response](docs/MerchantInvoiceExternalGatewayInvoiceMarkRefundedPost200Response.md)
 - [MerchantInvoiceExternalGatewayInvoiceMarkRefundedPost200ResponseData](docs/MerchantInvoiceExternalGatewayInvoiceMarkRefundedPost200ResponseData.md)
 - [MerchantInvoiceExternalGatewayInvoiceUpdatePaymentLinkPost200Response](docs/MerchantInvoiceExternalGatewayInvoiceUpdatePaymentLinkPost200Response.md)
 - [MerchantInvoiceExternalGatewayInvoiceUpdatePaymentLinkPost200ResponseData](docs/MerchantInvoiceExternalGatewayInvoiceUpdatePaymentLinkPost200ResponseData.md)
 ...
 - [MerchantInvoiceSplitPaymentsGet200Response](docs/MerchantInvoiceSplitPaymentsGet200Response.md)
 - [MerchantInvoiceSplitPaymentsGet200ResponseData](docs/MerchantInvoiceSplitPaymentsGet200ResponseData.md)
 ...
 - [MerchantMemberProfileGet200Response](docs/MerchantMemberProfileGet200Response.md)
 - [MerchantMemberProfileGet200ResponseData](docs/MerchantMemberProfileGet200ResponseData.md)
 - [MerchantMetricCarryoverReprocessPost200Response](docs/MerchantMetricCarryoverReprocessPost200Response.md)
 - [MerchantMetricCarryoverReprocessPost200ResponseData](docs/MerchantMetricCarryoverReprocessPost200ResponseData.md)
 ...
 - [MerchantMetricEventCurrentValuePost200Response](docs/MerchantMetricEventCurrentValuePost200Response.md)
 - [MerchantMetricEventCurrentValuePost200ResponseData](docs/MerchantMetricEventCurrentValuePost200ResponseData.md)
 ...
 - [MerchantMetricLimitAdjustPost200Response](docs/MerchantMetricLimitAdjustPost200Response.md)
 - [MerchantMetricLimitAdjustPost200ResponseData](docs/MerchantMetricLimitAdjustPost200ResponseData.md)
 ...
 - [MerchantMetricUserHistoryMetricByInvoiceGet200Response](docs/MerchantMetricUserHistoryMetricByInvoiceGet200Response.md)
 - [MerchantMetricUserHistoryMetricByInvoiceGet200ResponseData](docs/MerchantMetricUserHistoryMetricByInvoiceGet200ResponseData.md)
 - [MerchantMetricUserHistoryMetricBySubscriptionGet200Response](docs/MerchantMetricUserHistoryMetricBySubscriptionGet200Response.md)
 - [MerchantMetricUserHistoryMetricBySubscriptionGet200ResponseData](docs/MerchantMetricUserHistoryMetricBySubscriptionGet200ResponseData.md)
 ...
 - [MerchantOverviewStatisticsGet200Response](docs/MerchantOverviewStatisticsGet200Response.md)
 - [MerchantOverviewStatisticsGet200ResponseData](docs/MerchantOverviewStatisticsGet200ResponseData.md)
 ...
 - [MerchantPaymentExternalGatewayPaymentMarkFailedPost200Response](docs/MerchantPaymentExternalGatewayPaymentMarkFailedPost200Response.md)
 - [MerchantPaymentExternalGatewayPaymentMarkFailedPost200ResponseData](docs/MerchantPaymentExternalGatewayPaymentMarkFailedPost200ResponseData.md)
 - [MerchantPaymentExternalGatewayPaymentMarkPaidPost200Response](docs/MerchantPaymentExternalGatewayPaymentMarkPaidPost200Response.md)
 - [MerchantPaymentExternalGatewayPaymentMarkPaidPost200ResponseData](docs/MerchantPaymentExternalGatewayPaymentMarkPaidPost200ResponseData.md)
 - [MerchantPaymentExternalGatewayPaymentUpdateLinkPost200Response](docs/MerchantPaymentExternalGatewayPaymentUpdateLinkPost200Response.md)
 - [MerchantPaymentExternalGatewayPaymentUpdateLinkPost200ResponseData](docs/MerchantPaymentExternalGatewayPaymentUpdateLinkPost200ResponseData.md)
 - [MerchantPaymentExternalGatewayRefundMarkFailedPost200Response](docs/MerchantPaymentExternalGatewayRefundMarkFailedPost200Response.md)
 - [MerchantPaymentExternalGatewayRefundMarkFailedPost200ResponseData](docs/MerchantPaymentExternalGatewayRefundMarkFailedPost200ResponseData.md)
 - [MerchantPaymentExternalGatewayRefundMarkSuccessPost200Response](docs/MerchantPaymentExternalGatewayRefundMarkSuccessPost200Response.md)
 - [MerchantPaymentExternalGatewayRefundMarkSuccessPost200ResponseData](docs/MerchantPaymentExternalGatewayRefundMarkSuccessPost200ResponseData.md)
 ...
 - [MerchantPlanActivePriceChangeConfirmPost200Response](docs/MerchantPlanActivePriceChangeConfirmPost200Response.md)
 - [MerchantPlanActivePriceChangeConfirmPost200ResponseData](docs/MerchantPlanActivePriceChangeConfirmPost200ResponseData.md)
 - [MerchantPlanActivePriceChangePreviewPost200Response](docs/MerchantPlanActivePriceChangePreviewPost200Response.md)
 - [MerchantPlanActivePriceChangePreviewPost200ResponseData](docs/MerchantPlanActivePriceChangePreviewPost200ResponseData.md)
 ...
 - [MerchantPlanMetricLimitOverridePost200Response](docs/MerchantPlanMetricLimitOverridePost200Response.md)
 - [MerchantPlanMetricLimitOverridePost200ResponseData](docs/MerchantPlanMetricLimitOverridePost200ResponseData.md)
 ...
 - [MerchantSetupMultiCurrenciesPost200Response](docs/MerchantSetupMultiCurrenciesPost200Response.md)
 - [MerchantSetupMultiCurrenciesPost200ResponseData](docs/MerchantSetupMultiCurrenciesPost200ResponseData.md)
 - [MerchantSubscriptionActiveSubscriptionImportPost200Response](docs/MerchantSubscriptionActiveSubscriptionImportPost200Response.md)
 - [MerchantSubscriptionActiveSubscriptionImportPost200ResponseData](docs/MerchantSubscriptionActiveSubscriptionImportPost200ResponseData.md)
 ...
 - [MerchantSubscriptionOnetimeAddonPurchaseListGet200ResponseData](docs/MerchantSubscriptionOnetimeAddonPurchaseListGet200ResponseData.md)
 - [MerchantSubscriptionPaymentNewPost200Response](docs/MerchantSubscriptionPaymentNewPost200Response.md)
 - [MerchantSubscriptionPaymentNewPost200ResponseData](docs/MerchantSubscriptionPaymentNewPost200ResponseData.md)
 ...
 - [MerchantSubscriptionRenewPreviewPost200Response](docs/MerchantSubscriptionRenewPreviewPost200Response.md)
 - [MerchantSubscriptionRenewPreviewPost200ResponseData](docs/MerchantSubscriptionRenewPreviewPost200ResponseData.md)
 ...
 - [MerchantVatUsVatCategoryListGet200Response](docs/MerchantVatUsVatCategoryListGet200Response.md)
 - [MerchantVatUsVatCategoryListGet200ResponseData](docs/MerchantVatUsVatCategoryListGet200ResponseData.md)
 - [MerchantVatUsVatUploadHistoryListGet200Response](docs/MerchantVatUsVatUploadHistoryListGet200Response.md)
 - [MerchantVatUsVatUploadHistoryListGet200ResponseData](docs/MerchantVatUsVatUploadHistoryListGet200ResponseData.md)
 - [MerchantVatUsVatValidateAddressPost200Response](docs/MerchantVatUsVatValidateAddressPost200Response.md)
 - [MerchantVatUsVatValidateAddressPost200ResponseData](docs/MerchantVatUsVatValidateAddressPost200ResponseData.md)
 - [MerchantVatVatNumberValidateHistoryPost200Response](docs/MerchantVatVatNumberValidateHistoryPost200Response.md)
 - [MerchantVatVatNumberValidateHistoryPost200ResponseData](docs/MerchantVatVatNumberValidateHistoryPost200ResponseData.md)
 ...
 - [MerchantWebhookGetWebhookSecretGet200Response](docs/MerchantWebhookGetWebhookSecretGet200Response.md)
 ...
 - [MerchantWebhookWebhookZapierConnectUrlPost200Response](docs/MerchantWebhookWebhookZapierConnectUrlPost200Response.md)
 - [MerchantWebhookWebhookZapierConnectUrlPost200ResponseData](docs/MerchantWebhookWebhookZapierConnectUrlPost200ResponseData.md)
 ...
 - [UnibeeApiBeanDetailCreditNoteDetail](docs/UnibeeApiBeanDetailCreditNoteDetail.md)
 ...
 - [UnibeeApiBeanDetailGatewayCompanyIssuer](docs/UnibeeApiBeanDetailGatewayCompanyIssuer.md)
 ...
 - [UnibeeApiBeanDetailMerchantEmailHistoryDetail](docs/UnibeeApiBeanDetailMerchantEmailHistoryDetail.md)
 - [UnibeeApiBeanDetailMerchantEmailHistoryStatistics](docs/UnibeeApiBeanDetailMerchantEmailHistoryStatistics.md)
 ...
 - [UnibeeApiBeanDetailMetricLimitQuotaDetail](docs/UnibeeApiBeanDetailMetricLimitQuotaDetail.md)
 ...
 - [UnibeeApiBeanDetailUserHistoryMetric](docs/UnibeeApiBeanDetailUserHistoryMetric.md)
 - [UnibeeApiBeanDetailUserHistoryMetricLimitStat](docs/UnibeeApiBeanDetailUserHistoryMetricLimitStat.md)
 ...
 - [UnibeeApiBeanDetailUserOnetimeAddonDetail](docs/UnibeeApiBeanDetailUserOnetimeAddonDetail.md)
 - [UnibeeApiBeanEmailGatewayConnectionAPIKeys](docs/UnibeeApiBeanEmailGatewayConnectionAPIKeys.md)
 - [UnibeeApiBeanEmailGatewayConnectionAPIKeysUpdate](docs/UnibeeApiBeanEmailGatewayConnectionAPIKeysUpdate.md)
 ...
 - [UnibeeApiBeanInvoiceMetricCharge](docs/UnibeeApiBeanInvoiceMetricCharge.md)
 - [UnibeeApiBeanInvoiceMetricLimit](docs/UnibeeApiBeanInvoiceMetricLimit.md)
 - [UnibeeApiBeanInvoicePlanSnapshot](docs/UnibeeApiBeanInvoicePlanSnapshot.md)
 - [UnibeeApiBeanMerchant](docs/UnibeeApiBeanMerchant.md)
 - [UnibeeApiBeanMerchantBatchDiscountCode](docs/UnibeeApiBeanMerchantBatchDiscountCode.md)
 - [UnibeeApiBeanMerchantBatchDiscountCodeTemplate](docs/UnibeeApiBeanMerchantBatchDiscountCodeTemplate.md)
 ...
 - [UnibeeApiBeanMerchantCurrencyConfig](docs/UnibeeApiBeanMerchantCurrencyConfig.md)
 ...
 - [UnibeeApiBeanMerchantMultiCurrencyConfig](docs/UnibeeApiBeanMerchantMultiCurrencyConfig.md)
 ...
 - [UnibeeApiBeanMerchantUsVatGatewayCalculateHistory](docs/UnibeeApiBeanMerchantUsVatGatewayCalculateHistory.md)
 - [UnibeeApiBeanMerchantUserBatchTask](docs/UnibeeApiBeanMerchantUserBatchTask.md)
 - [UnibeeApiBeanMerchantVatNumberVerifyHistory](docs/UnibeeApiBeanMerchantVatNumberVerifyHistory.md)
 ...
 - [UnibeeApiBeanMerchantZapierCredential](docs/UnibeeApiBeanMerchantZapierCredential.md)
 - [UnibeeApiBeanMetricPlanChargeGraduatedStep](docs/UnibeeApiBeanMetricPlanChargeGraduatedStep.md)
 - [UnibeeApiBeanMetricPlanChargeLine](docs/UnibeeApiBeanMetricPlanChargeLine.md)
 - [UnibeeApiBeanNewUser](docs/UnibeeApiBeanNewUser.md)
 - [UnibeeApiBeanOauth](docs/UnibeeApiBeanOauth.md)
 ...
 - [UnibeeApiBeanPlanMetricLimitOverrideParam](docs/UnibeeApiBeanPlanMetricLimitOverrideParam.md)
 ...
 - [UnibeeApiBeanPlanMultiCurrency](docs/UnibeeApiBeanPlanMultiCurrency.md)
 - [UnibeeApiBeanPlanMultiCurrencyRate](docs/UnibeeApiBeanPlanMultiCurrencyRate.md)
 - [UnibeeApiBeanPlanMultiCurrencySnapshot](docs/UnibeeApiBeanPlanMultiCurrencySnapshot.md)
 - [UnibeeApiBeanPlanMultiTrial](docs/UnibeeApiBeanPlanMultiTrial.md)
 ...
 - [UnibeeApiBeanSplitPaymentInfo](docs/UnibeeApiBeanSplitPaymentInfo.md)
 ...
 - [UnibeeApiBeanSubscriptionMultiTrial](docs/UnibeeApiBeanSubscriptionMultiTrial.md)
 - [UnibeeApiBeanSubscriptionMultiTrialItem](docs/UnibeeApiBeanSubscriptionMultiTrialItem.md)
 - [UnibeeApiBeanSubscriptionOnetimeAddon](docs/UnibeeApiBeanSubscriptionOnetimeAddon.md)
 - [UnibeeApiBeanTemplateVariable](docs/UnibeeApiBeanTemplateVariable.md)
 - [UnibeeApiBeanTemplateVariableGroup](docs/UnibeeApiBeanTemplateVariableGroup.md)
 - [UnibeeApiBeanUSAddress](docs/UnibeeApiBeanUSAddress.md)
 - [UnibeeApiBeanUSVATConfig](docs/UnibeeApiBeanUSVATConfig.md)
 - [UnibeeApiBeanUSVATGatewayConnectionAPIKeys](docs/UnibeeApiBeanUSVATGatewayConnectionAPIKeys.md)
 - [UnibeeApiBeanUSVATGatewayProductTaxCode](docs/UnibeeApiBeanUSVATGatewayProductTaxCode.md)
 - [UnibeeApiBeanUSVATGlobalConfig](docs/UnibeeApiBeanUSVATGlobalConfig.md)
 ...
 - [UnibeeApiCheckoutPaymentDetailReq](docs/UnibeeApiCheckoutPaymentDetailReq.md)
 - [UnibeeApiCheckoutPaymentDetailRes](docs/UnibeeApiCheckoutPaymentDetailRes.md)
 - [UnibeeApiCheckoutPlanDetailReq](docs/UnibeeApiCheckoutPlanDetailReq.md)
 - [UnibeeApiCheckoutPlanDetailRes](docs/UnibeeApiCheckoutPlanDetailRes.md)
 ...
 - [UnibeeApiCheckoutVatUSVATValidateAddressReq](docs/UnibeeApiCheckoutVatUSVATValidateAddressReq.md)
 - [UnibeeApiCheckoutVatUSVATValidateAddressRes](docs/UnibeeApiCheckoutVatUSVATValidateAddressRes.md)
 - [UnibeeApiMerchantAuthClearTotpReq](docs/UnibeeApiMerchantAuthClearTotpReq.md)
 - [UnibeeApiMerchantAuthGitHubUserInfo](docs/UnibeeApiMerchantAuthGitHubUserInfo.md)
 - [UnibeeApiMerchantAuthGoogleUserInfo](docs/UnibeeApiMerchantAuthGoogleUserInfo.md)
 - [UnibeeApiMerchantAuthLoginOAuthReq](docs/UnibeeApiMerchantAuthLoginOAuthReq.md)
 - [UnibeeApiMerchantAuthLoginOAuthRes](docs/UnibeeApiMerchantAuthLoginOAuthRes.md)
 ...
 - [UnibeeApiMerchantAuthOauthGithubReq](docs/UnibeeApiMerchantAuthOauthGithubReq.md)
 - [UnibeeApiMerchantAuthOauthGithubRes](docs/UnibeeApiMerchantAuthOauthGithubRes.md)
 - [UnibeeApiMerchantAuthOauthGoogleReq](docs/UnibeeApiMerchantAuthOauthGoogleReq.md)
 - [UnibeeApiMerchantAuthOauthGoogleRes](docs/UnibeeApiMerchantAuthOauthGoogleRes.md)
 - [UnibeeApiMerchantAuthOauthMembersRes](docs/UnibeeApiMerchantAuthOauthMembersRes.md)
 ...
 - [UnibeeApiMerchantAuthPasswordSetupOtpRes](docs/UnibeeApiMerchantAuthPasswordSetupOtpRes.md)
 - [UnibeeApiMerchantAuthRegisterEmailCheckReq](docs/UnibeeApiMerchantAuthRegisterEmailCheckReq.md)
 - [UnibeeApiMerchantAuthRegisterEmailCheckRes](docs/UnibeeApiMerchantAuthRegisterEmailCheckRes.md)
 - [UnibeeApiMerchantAuthRegisterOAuthReq](docs/UnibeeApiMerchantAuthRegisterOAuthReq.md)
 - [UnibeeApiMerchantAuthRegisterOAuthRes](docs/UnibeeApiMerchantAuthRegisterOAuthRes.md)
 ...
 - [UnibeeApiMerchantAuthRegisterWithoutVerificationReq](docs/UnibeeApiMerchantAuthRegisterWithoutVerificationReq.md)
 - [UnibeeApiMerchantAuthRegisterWithoutVerificationRes](docs/UnibeeApiMerchantAuthRegisterWithoutVerificationRes.md)
 ...
 - [UnibeeApiMerchantAuthSetupOAuthReq](docs/UnibeeApiMerchantAuthSetupOAuthReq.md)
 - [UnibeeApiMerchantAuthSetupOAuthRes](docs/UnibeeApiMerchantAuthSetupOAuthRes.md)
 ...
 - [UnibeeApiMerchantCreditPromoCreditRefundFromInvoiceReq](docs/UnibeeApiMerchantCreditPromoCreditRefundFromInvoiceReq.md)
 - [UnibeeApiMerchantDiscountActivateReq](docs/UnibeeApiMerchantDiscountActivateReq.md)
 - [UnibeeApiMerchantDiscountBatchChildrenDetailReq](docs/UnibeeApiMerchantDiscountBatchChildrenDetailReq.md)
 - [UnibeeApiMerchantDiscountBatchChildrenDetailRes](docs/UnibeeApiMerchantDiscountBatchChildrenDetailRes.md)
 - [UnibeeApiMerchantDiscountBatchChildrenGenerateReq](docs/UnibeeApiMerchantDiscountBatchChildrenGenerateReq.md)
 - [UnibeeApiMerchantDiscountBatchChildrenGenerateRes](docs/UnibeeApiMerchantDiscountBatchChildrenGenerateRes.md)
 - [UnibeeApiMerchantDiscountBatchChildrenListReq](docs/UnibeeApiMerchantDiscountBatchChildrenListReq.md)
 - [UnibeeApiMerchantDiscountBatchChildrenListRes](docs/UnibeeApiMerchantDiscountBatchChildrenListRes.md)
 - [UnibeeApiMerchantDiscountBatchTemplateDetailReq](docs/UnibeeApiMerchantDiscountBatchTemplateDetailReq.md)
 - [UnibeeApiMerchantDiscountBatchTemplateDetailRes](docs/UnibeeApiMerchantDiscountBatchTemplateDetailRes.md)
 - [UnibeeApiMerchantDiscountBatchTemplateEditReq](docs/UnibeeApiMerchantDiscountBatchTemplateEditReq.md)
 - [UnibeeApiMerchantDiscountBatchTemplateEditRes](docs/UnibeeApiMerchantDiscountBatchTemplateEditRes.md)
 - [UnibeeApiMerchantDiscountBatchTemplateListReq](docs/UnibeeApiMerchantDiscountBatchTemplateListReq.md)
 - [UnibeeApiMerchantDiscountBatchTemplateListRes](docs/UnibeeApiMerchantDiscountBatchTemplateListRes.md)
 - [UnibeeApiMerchantDiscountBatchTemplateNewReq](docs/UnibeeApiMerchantDiscountBatchTemplateNewReq.md)
 - [UnibeeApiMerchantDiscountBatchTemplateNewRes](docs/UnibeeApiMerchantDiscountBatchTemplateNewRes.md)
 - [UnibeeApiMerchantDiscountBatchTemplateQuantityIncrementReq](docs/UnibeeApiMerchantDiscountBatchTemplateQuantityIncrementReq.md)
 - [UnibeeApiMerchantDiscountBatchTemplateQuantityIncrementRes](docs/UnibeeApiMerchantDiscountBatchTemplateQuantityIncrementRes.md)
 ...
 - [UnibeeApiMerchantEmailGatewaySetDefaultReq](docs/UnibeeApiMerchantEmailGatewaySetDefaultReq.md)
 ...
 - [UnibeeApiMerchantEmailGatewaySetupV2Req](docs/UnibeeApiMerchantEmailGatewaySetupV2Req.md)
 - [UnibeeApiMerchantEmailHistoryListReq](docs/UnibeeApiMerchantEmailHistoryListReq.md)
 - [UnibeeApiMerchantEmailHistoryListRes](docs/UnibeeApiMerchantEmailHistoryListRes.md)
 - [UnibeeApiMerchantEmailSendEmailToUserReq](docs/UnibeeApiMerchantEmailSendEmailToUserReq.md)
 - [UnibeeApiMerchantEmailSendEmailViaAPICredentialReq](docs/UnibeeApiMerchantEmailSendEmailViaAPICredentialReq.md)
 ...
 - [UnibeeApiMerchantEmailTestLocalizationVersionReq](docs/UnibeeApiMerchantEmailTestLocalizationVersionReq.md)
 ...
 - [UnibeeApiMerchantGatewayRestoreReq](docs/UnibeeApiMerchantGatewayRestoreReq.md)
 - [UnibeeApiMerchantGatewayRestoreRes](docs/UnibeeApiMerchantGatewayRestoreRes.md)
 - [UnibeeApiMerchantGatewaySetDefaultReq](docs/UnibeeApiMerchantGatewaySetDefaultReq.md)
 - [UnibeeApiMerchantGatewaySetDefaultRes](docs/UnibeeApiMerchantGatewaySetDefaultRes.md)
 ...
 - [UnibeeApiMerchantInvoiceCreateMarkRefundReq](docs/UnibeeApiMerchantInvoiceCreateMarkRefundReq.md)
 - [UnibeeApiMerchantInvoiceCreateMarkRefundRes](docs/UnibeeApiMerchantInvoiceCreateMarkRefundRes.md)
 - [UnibeeApiMerchantInvoiceCreditNoteListReq](docs/UnibeeApiMerchantInvoiceCreditNoteListReq.md)
 - [UnibeeApiMerchantInvoiceCreditNoteListRes](docs/UnibeeApiMerchantInvoiceCreditNoteListRes.md)
 ...
 - [UnibeeApiMerchantInvoiceEditPaidInvoiceBillingDetailsReq](docs/UnibeeApiMerchantInvoiceEditPaidInvoiceBillingDetailsReq.md)
 - [UnibeeApiMerchantInvoiceEditPaidInvoiceBillingDetailsRes](docs/UnibeeApiMerchantInvoiceEditPaidInvoiceBillingDetailsRes.md)
 ...
 - [UnibeeApiMerchantInvoiceGetSplitPaymentsReq](docs/UnibeeApiMerchantInvoiceGetSplitPaymentsReq.md)
 - [UnibeeApiMerchantInvoiceGetSplitPaymentsRes](docs/UnibeeApiMerchantInvoiceGetSplitPaymentsRes.md)
 - [UnibeeApiMerchantInvoiceHistoryInvoiceImportDeleteReq](docs/UnibeeApiMerchantInvoiceHistoryInvoiceImportDeleteReq.md)
 - [UnibeeApiMerchantInvoiceHistoryInvoiceImportLineItem](docs/UnibeeApiMerchantInvoiceHistoryInvoiceImportLineItem.md)
 - [UnibeeApiMerchantInvoiceHistoryInvoiceImportReq](docs/UnibeeApiMerchantInvoiceHistoryInvoiceImportReq.md)
 - [UnibeeApiMerchantInvoiceHistoryInvoiceImportRes](docs/UnibeeApiMerchantInvoiceHistoryInvoiceImportRes.md)
 ...
 - [UnibeeApiMerchantInvoiceMarkExternalGatewayInvoiceAsPaidReq](docs/UnibeeApiMerchantInvoiceMarkExternalGatewayInvoiceAsPaidReq.md)
 - [UnibeeApiMerchantInvoiceMarkExternalGatewayInvoiceAsPaidRes](docs/UnibeeApiMerchantInvoiceMarkExternalGatewayInvoiceAsPaidRes.md)
 - [UnibeeApiMerchantInvoiceMarkExternalGatewayInvoiceAsRefundedReq](docs/UnibeeApiMerchantInvoiceMarkExternalGatewayInvoiceAsRefundedReq.md)
 - [UnibeeApiMerchantInvoiceMarkExternalGatewayInvoiceAsRefundedRes](docs/UnibeeApiMerchantInvoiceMarkExternalGatewayInvoiceAsRefundedRes.md)
 ...
 - [UnibeeApiMerchantInvoiceSyncPaidInvoiceBillingDetailsReq](docs/UnibeeApiMerchantInvoiceSyncPaidInvoiceBillingDetailsReq.md)
 - [UnibeeApiMerchantInvoiceSyncPaidInvoiceBillingDetailsRes](docs/UnibeeApiMerchantInvoiceSyncPaidInvoiceBillingDetailsRes.md)
 - [UnibeeApiMerchantInvoiceSyncUserSnapshotReq](docs/UnibeeApiMerchantInvoiceSyncUserSnapshotReq.md)
 - [UnibeeApiMerchantInvoiceSyncUserSnapshotRes](docs/UnibeeApiMerchantInvoiceSyncUserSnapshotRes.md)
 - [UnibeeApiMerchantInvoiceUpdateExternalGatewayInvoicePaymentLinkReq](docs/UnibeeApiMerchantInvoiceUpdateExternalGatewayInvoicePaymentLinkReq.md)
 - [UnibeeApiMerchantInvoiceUpdateExternalGatewayInvoicePaymentLinkRes](docs/UnibeeApiMerchantInvoiceUpdateExternalGatewayInvoicePaymentLinkRes.md)
 - [UnibeeApiMerchantMemberClearOAuthReq](docs/UnibeeApiMerchantMemberClearOAuthReq.md)
 ...
 - [UnibeeApiMerchantMetricEventCurrentValueReq](docs/UnibeeApiMerchantMetricEventCurrentValueReq.md)
 - [UnibeeApiMerchantMetricEventCurrentValueRes](docs/UnibeeApiMerchantMetricEventCurrentValueRes.md)
 ...
 - [UnibeeApiMerchantMetricListMetricQueryableInvoicesReq](docs/UnibeeApiMerchantMetricListMetricQueryableInvoicesReq.md)
 - [UnibeeApiMerchantMetricListMetricQueryableInvoicesRes](docs/UnibeeApiMerchantMetricListMetricQueryableInvoicesRes.md)
 ...
 - [UnibeeApiMerchantMetricMetricCarryoverReprocessReq](docs/UnibeeApiMerchantMetricMetricCarryoverReprocessReq.md)
 - [UnibeeApiMerchantMetricMetricCarryoverReprocessRes](docs/UnibeeApiMerchantMetricMetricCarryoverReprocessRes.md)
 - [UnibeeApiMerchantMetricMetricLimitAdjustReq](docs/UnibeeApiMerchantMetricMetricLimitAdjustReq.md)
 - [UnibeeApiMerchantMetricMetricLimitAdjustRes](docs/UnibeeApiMerchantMetricMetricLimitAdjustRes.md)
 ...
 - [UnibeeApiMerchantMetricUserHistoryLimitMetricByInvoiceReq](docs/UnibeeApiMerchantMetricUserHistoryLimitMetricByInvoiceReq.md)
 - [UnibeeApiMerchantMetricUserHistoryLimitMetricByInvoiceRes](docs/UnibeeApiMerchantMetricUserHistoryLimitMetricByInvoiceRes.md)
 - [UnibeeApiMerchantMetricUserHistoryLimitMetricBySubscriptionReq](docs/UnibeeApiMerchantMetricUserHistoryLimitMetricBySubscriptionReq.md)
 - [UnibeeApiMerchantMetricUserHistoryLimitMetricBySubscriptionRes](docs/UnibeeApiMerchantMetricUserHistoryLimitMetricBySubscriptionRes.md)
 ...
 - [UnibeeApiMerchantPaymentExternalGatewayPaymentMarkFailedReq](docs/UnibeeApiMerchantPaymentExternalGatewayPaymentMarkFailedReq.md)
 - [UnibeeApiMerchantPaymentExternalGatewayPaymentMarkFailedRes](docs/UnibeeApiMerchantPaymentExternalGatewayPaymentMarkFailedRes.md)
 - [UnibeeApiMerchantPaymentExternalGatewayPaymentMarkPaidReq](docs/UnibeeApiMerchantPaymentExternalGatewayPaymentMarkPaidReq.md)
 - [UnibeeApiMerchantPaymentExternalGatewayPaymentMarkPaidRes](docs/UnibeeApiMerchantPaymentExternalGatewayPaymentMarkPaidRes.md)
 - [UnibeeApiMerchantPaymentExternalGatewayPaymentUpdateLinkReq](docs/UnibeeApiMerchantPaymentExternalGatewayPaymentUpdateLinkReq.md)
 - [UnibeeApiMerchantPaymentExternalGatewayPaymentUpdateLinkRes](docs/UnibeeApiMerchantPaymentExternalGatewayPaymentUpdateLinkRes.md)
 - [UnibeeApiMerchantPaymentExternalGatewayRefundMarkFailedReq](docs/UnibeeApiMerchantPaymentExternalGatewayRefundMarkFailedReq.md)
 - [UnibeeApiMerchantPaymentExternalGatewayRefundMarkFailedRes](docs/UnibeeApiMerchantPaymentExternalGatewayRefundMarkFailedRes.md)
 - [UnibeeApiMerchantPaymentExternalGatewayRefundMarkSuccessReq](docs/UnibeeApiMerchantPaymentExternalGatewayRefundMarkSuccessReq.md)
 - [UnibeeApiMerchantPaymentExternalGatewayRefundMarkSuccessRes](docs/UnibeeApiMerchantPaymentExternalGatewayRefundMarkSuccessRes.md)
 ...
 - [UnibeeApiMerchantPlanActivePriceChangeConfirmReq](docs/UnibeeApiMerchantPlanActivePriceChangeConfirmReq.md)
 - [UnibeeApiMerchantPlanActivePriceChangeConfirmRes](docs/UnibeeApiMerchantPlanActivePriceChangeConfirmRes.md)
 - [UnibeeApiMerchantPlanActivePriceChangePreviewReq](docs/UnibeeApiMerchantPlanActivePriceChangePreviewReq.md)
 - [UnibeeApiMerchantPlanActivePriceChangePreviewRes](docs/UnibeeApiMerchantPlanActivePriceChangePreviewRes.md)
 ...
 - [UnibeeApiMerchantPlanMetricLimitOverrideReq](docs/UnibeeApiMerchantPlanMetricLimitOverrideReq.md)
 - [UnibeeApiMerchantPlanMetricLimitOverrideRes](docs/UnibeeApiMerchantPlanMetricLimitOverrideRes.md)
 ...
 - [UnibeeApiMerchantProfileAmountMultiCurrenciesExchangeReq](docs/UnibeeApiMerchantProfileAmountMultiCurrenciesExchangeReq.md)
 - [UnibeeApiMerchantProfileAmountMultiCurrenciesExchangeRes](docs/UnibeeApiMerchantProfileAmountMultiCurrenciesExchangeRes.md)
 ...
 - [UnibeeApiMerchantProfileEditTotpConfigReq](docs/UnibeeApiMerchantProfileEditTotpConfigReq.md)
 - [UnibeeApiMerchantProfileGetExchangeRateReq](docs/UnibeeApiMerchantProfileGetExchangeRateReq.md)
 - [UnibeeApiMerchantProfileGetExchangeRateRes](docs/UnibeeApiMerchantProfileGetExchangeRateRes.md)
 ...
 - [UnibeeApiMerchantProfileGetOverviewStatisticsRes](docs/UnibeeApiMerchantProfileGetOverviewStatisticsRes.md)
 ...
 - [UnibeeApiMerchantProfileSetupMultiCurrenciesReq](docs/UnibeeApiMerchantProfileSetupMultiCurrenciesReq.md)
 - [UnibeeApiMerchantProfileSetupMultiCurrenciesRes](docs/UnibeeApiMerchantProfileSetupMultiCurrenciesRes.md)
 - [UnibeeApiMerchantProfileUpdateCnameDomainReq](docs/UnibeeApiMerchantProfileUpdateCnameDomainReq.md)
 - [UnibeeApiMerchantProfileUpdatePortalHostReq](docs/UnibeeApiMerchantProfileUpdatePortalHostReq.md)
 ...
 - [UnibeeApiMerchantSessionCustomerPortalUrlReq](docs/UnibeeApiMerchantSessionCustomerPortalUrlReq.md)
 - [UnibeeApiMerchantSessionCustomerPortalUrlRes](docs/UnibeeApiMerchantSessionCustomerPortalUrlRes.md)
 ...
 - [UnibeeApiMerchantSubscriptionActiveSubscriptionImportReq](docs/UnibeeApiMerchantSubscriptionActiveSubscriptionImportReq.md)
 - [UnibeeApiMerchantSubscriptionActiveSubscriptionImportRes](docs/UnibeeApiMerchantSubscriptionActiveSubscriptionImportRes.md)
 ...
 - [UnibeeApiMerchantSubscriptionApplySubscriptionNextInvoiceReq](docs/UnibeeApiMerchantSubscriptionApplySubscriptionNextInvoiceReq.md)
 - [UnibeeApiMerchantSubscriptionApplySubscriptionNextInvoiceRes](docs/UnibeeApiMerchantSubscriptionApplySubscriptionNextInvoiceRes.md)
 ...
 - [UnibeeApiMerchantSubscriptionChangeCurrencyReq](docs/UnibeeApiMerchantSubscriptionChangeCurrencyReq.md)
 - [UnibeeApiMerchantSubscriptionChangeDueDayReq](docs/UnibeeApiMerchantSubscriptionChangeDueDayReq.md)
 ...
 - [UnibeeApiMerchantSubscriptionHistorySubscriptionImportReq](docs/UnibeeApiMerchantSubscriptionHistorySubscriptionImportReq.md)
 - [UnibeeApiMerchantSubscriptionHistorySubscriptionImportRes](docs/UnibeeApiMerchantSubscriptionHistorySubscriptionImportRes.md)
 ...
 - [UnibeeApiMerchantSubscriptionOnetimeAddonPreviewReq](docs/UnibeeApiMerchantSubscriptionOnetimeAddonPreviewReq.md)
 - [UnibeeApiMerchantSubscriptionOnetimeAddonPreviewRes](docs/UnibeeApiMerchantSubscriptionOnetimeAddonPreviewRes.md)
 - [UnibeeApiMerchantSubscriptionOnetimeAddonPurchaseListReq](docs/UnibeeApiMerchantSubscriptionOnetimeAddonPurchaseListReq.md)
 - [UnibeeApiMerchantSubscriptionOnetimeAddonPurchaseListRes](docs/UnibeeApiMerchantSubscriptionOnetimeAddonPurchaseListRes.md)
 ...
 - [UnibeeApiMerchantSubscriptionRenewPreviewReq](docs/UnibeeApiMerchantSubscriptionRenewPreviewReq.md)
 - [UnibeeApiMerchantSubscriptionRenewPreviewRes](docs/UnibeeApiMerchantSubscriptionRenewPreviewRes.md)
 ...
 - [UnibeeApiMerchantSubscriptionUpdateMetadataReq](docs/UnibeeApiMerchantSubscriptionUpdateMetadataReq.md)
 ...
 - [UnibeeApiMerchantUserDeleteReq](docs/UnibeeApiMerchantUserDeleteReq.md)
 ...
 - [UnibeeApiMerchantUserUpdateExternalUserIdReq](docs/UnibeeApiMerchantUserUpdateExternalUserIdReq.md)
 - [UnibeeApiMerchantUserUpdateExternalUserIdRes](docs/UnibeeApiMerchantUserUpdateExternalUserIdRes.md)
 ...
 - [UnibeeApiMerchantVatNumberValidateHistoryActivateReq](docs/UnibeeApiMerchantVatNumberValidateHistoryActivateReq.md)
 - [UnibeeApiMerchantVatNumberValidateHistoryDeactivateReq](docs/UnibeeApiMerchantVatNumberValidateHistoryDeactivateReq.md)
 - [UnibeeApiMerchantVatNumberValidateHistoryReq](docs/UnibeeApiMerchantVatNumberValidateHistoryReq.md)
 - [UnibeeApiMerchantVatNumberValidateHistoryRes](docs/UnibeeApiMerchantVatNumberValidateHistoryRes.md)
 ...
 - [UnibeeApiMerchantVatSetupGlobalUSVATConfigReq](docs/UnibeeApiMerchantVatSetupGlobalUSVATConfigReq.md)
 - [UnibeeApiMerchantVatSetupUSVATGatewayReq](docs/UnibeeApiMerchantVatSetupUSVATGatewayReq.md)
 - [UnibeeApiMerchantVatUSVATCategoryListRes](docs/UnibeeApiMerchantVatUSVATCategoryListRes.md)
 - [UnibeeApiMerchantVatUSVATUploadHistoryListReq](docs/UnibeeApiMerchantVatUSVATUploadHistoryListReq.md)
 - [UnibeeApiMerchantVatUSVATUploadHistoryListRes](docs/UnibeeApiMerchantVatUSVATUploadHistoryListRes.md)
 - [UnibeeApiMerchantVatUSVATValidateAddressReq](docs/UnibeeApiMerchantVatUSVATValidateAddressReq.md)
 - [UnibeeApiMerchantVatUSVATValidateAddressRes](docs/UnibeeApiMerchantVatUSVATValidateAddressRes.md)
 ...
 - [UnibeeApiMerchantWebhookGetWebhookSecretRes](docs/UnibeeApiMerchantWebhookGetWebhookSecretRes.md)
 - [UnibeeApiMerchantWebhookGetWebhookZapierConnectURLReq](docs/UnibeeApiMerchantWebhookGetWebhookZapierConnectURLReq.md)
 - [UnibeeApiMerchantWebhookGetWebhookZapierConnectURLRes](docs/UnibeeApiMerchantWebhookGetWebhookZapierConnectURLRes.md)
 ...
 - [UnibeeApiSystemInformationLanguage](docs/UnibeeApiSystemInformationLanguage.md)
 - [UnibeeApiSystemInformationOAuthConfig](docs/UnibeeApiSystemInformationOAuthConfig.md)
 - [UnibeeApiSystemInformationSendMockMQReq](docs/UnibeeApiSystemInformationSendMockMQReq.md)
 - [UnibeeApiSystemInvoiceBatchSendInvoiceWebhookEventReq](docs/UnibeeApiSystemInvoiceBatchSendInvoiceWebhookEventReq.md)
 ...
 - [UnibeeApiSystemInvoiceCreateNextSplitPaymentReq](docs/UnibeeApiSystemInvoiceCreateNextSplitPaymentReq.md)
 - [UnibeeApiSystemInvoiceCreateNextSplitPaymentRes](docs/UnibeeApiSystemInvoiceCreateNextSplitPaymentRes.md)
 - [UnibeeApiSystemInvoiceCreatePaymentReq](docs/UnibeeApiSystemInvoiceCreatePaymentReq.md)
 - [UnibeeApiSystemInvoiceCreatePaymentRes](docs/UnibeeApiSystemInvoiceCreatePaymentRes.md)
 - [UnibeeApiSystemInvoiceDetailReq](docs/UnibeeApiSystemInvoiceDetailReq.md)
 - [UnibeeApiSystemInvoiceDetailRes](docs/UnibeeApiSystemInvoiceDetailRes.md)
 - [UnibeeApiSystemInvoiceGetSplitPaymentsReq](docs/UnibeeApiSystemInvoiceGetSplitPaymentsReq.md)
 - [UnibeeApiSystemInvoiceGetSplitPaymentsRes](docs/UnibeeApiSystemInvoiceGetSplitPaymentsRes.md)
 ...
 - [UnibeeApiSystemInvoiceQuickbooksSyncReq](docs/UnibeeApiSystemInvoiceQuickbooksSyncReq.md)
 - [UnibeeApiSystemMcpdocEndpointItem](docs/UnibeeApiSystemMcpdocEndpointItem.md)
 - [UnibeeApiSystemMcpdocEndpointReq](docs/UnibeeApiSystemMcpdocEndpointReq.md)
 - [UnibeeApiSystemMcpdocEndpointRes](docs/UnibeeApiSystemMcpdocEndpointRes.md)
 - [UnibeeApiSystemMcpdocExampleCurlReq](docs/UnibeeApiSystemMcpdocExampleCurlReq.md)
 - [UnibeeApiSystemMcpdocExampleCurlRes](docs/UnibeeApiSystemMcpdocExampleCurlRes.md)
 - [UnibeeApiSystemMcpdocPlaybookReq](docs/UnibeeApiSystemMcpdocPlaybookReq.md)
 - [UnibeeApiSystemMcpdocPlaybookRes](docs/UnibeeApiSystemMcpdocPlaybookRes.md)
 - [UnibeeApiSystemMcpdocSearchReq](docs/UnibeeApiSystemMcpdocSearchReq.md)
 - [UnibeeApiSystemMcpdocSearchRes](docs/UnibeeApiSystemMcpdocSearchRes.md)
 - [UnibeeApiSystemMcpdocSourceRes](docs/UnibeeApiSystemMcpdocSourceRes.md)
 - [UnibeeApiSystemPaymentDetailReq](docs/UnibeeApiSystemPaymentDetailReq.md)
 - [UnibeeApiSystemPaymentDetailRes](docs/UnibeeApiSystemPaymentDetailRes.md)
 - [UnibeeApiSystemPaymentGetPaymentExchangeRateReq](docs/UnibeeApiSystemPaymentGetPaymentExchangeRateReq.md)
 - [UnibeeApiSystemPaymentGetPaymentExchangeRateRes](docs/UnibeeApiSystemPaymentGetPaymentExchangeRateRes.md)
 ...
 - [UnibeeApiSystemSubscriptionBatchSendSubActivateWebhookEventReq](docs/UnibeeApiSystemSubscriptionBatchSendSubActivateWebhookEventReq.md)
 - [UnibeeApiSystemSubscriptionBatchSendSubUpdateWebhookEventReq](docs/UnibeeApiSystemSubscriptionBatchSendSubUpdateWebhookEventReq.md)
 - [UnibeeApiSystemSubscriptionClearSubscriptionBlacklistReq](docs/UnibeeApiSystemSubscriptionClearSubscriptionBlacklistReq.md)
 - [UnibeeApiSystemSubscriptionClearSubscriptionBlacklistRes](docs/UnibeeApiSystemSubscriptionClearSubscriptionBlacklistRes.md)
 - [UnibeeApiSystemSubscriptionInternalWebhookSyncReq](docs/UnibeeApiSystemSubscriptionInternalWebhookSyncReq.md)
 - [UnibeeApiSystemSubscriptionInternalWebhookSyncRes](docs/UnibeeApiSystemSubscriptionInternalWebhookSyncRes.md)
 - [UnibeeApiSystemSubscriptionManualTriggerPendingUpdatePaymentSuccessReq](docs/UnibeeApiSystemSubscriptionManualTriggerPendingUpdatePaymentSuccessReq.md)
 - [UnibeeApiSystemSubscriptionManualTriggerPendingUpdatePaymentSuccessRes](docs/UnibeeApiSystemSubscriptionManualTriggerPendingUpdatePaymentSuccessRes.md)
 - [UnibeeApiSystemSubscriptionQuerySubscriptionBlacklistReq](docs/UnibeeApiSystemSubscriptionQuerySubscriptionBlacklistReq.md)
 - [UnibeeApiSystemSubscriptionQuerySubscriptionBlacklistRes](docs/UnibeeApiSystemSubscriptionQuerySubscriptionBlacklistRes.md)
 - [UnibeeApiSystemSubscriptionSendUserSubUpdateWebhookEventReq](docs/UnibeeApiSystemSubscriptionSendUserSubUpdateWebhookEventReq.md)
 - [UnibeeApiSystemSubscriptionSendUserSubUpdateWebhookEventRes](docs/UnibeeApiSystemSubscriptionSendUserSubUpdateWebhookEventRes.md)
 - [UnibeeApiSystemSubscriptionSubscriptionEndpointBlacklistStatus](docs/UnibeeApiSystemSubscriptionSubscriptionEndpointBlacklistStatus.md)
 ...
 - [UnibeeInternalLogicMiddlewareLicenseLicense](docs/UnibeeInternalLogicMiddlewareLicenseLicense.md)
 - [UnibeeInternalLogicMiddlewareLicenseMerchantVersion](docs/UnibeeInternalLogicMiddlewareLicenseMerchantVersion.md)
 - [UnibeeInternalLogicMiddlewareLicensePlan](docs/UnibeeInternalLogicMiddlewareLicensePlan.md)
