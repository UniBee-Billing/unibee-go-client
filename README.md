...
*MetricEvent* | [**MetricEventCurrentValuePost**](docs/MetricEvent.md#metriceventcurrentvaluepost) | **Post** /merchant/metric/event/current_value | Merchant Metric Event Current Value
