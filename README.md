...
*Task* | [**TaskDeleteExportTemplatePost**](docs/Task.md#taskdeleteexporttemplatepost) | **Post** /merchant/task/delete_export_template | DeleteExportTemplate
*Task* | [**TaskEditExportTemplatePost**](docs/Task.md#taskeditexporttemplatepost) | **Post** /merchant/task/edit_export_template | EditExportTemplate
*Task* | [**TaskExportColumnListPost**](docs/Task.md#taskexportcolumnlistpost) | **Post** /merchant/task/export_column_list | ExportColumnList
*Task* | [**TaskExportTemplateListGet**](docs/Task.md#taskexporttemplatelistget) | **Get** /merchant/task/export_template_list | GetExportTemplateList
*Task* | [**TaskExportTemplateListPost**](docs/Task.md#taskexporttemplatelistpost) | **Post** /merchant/task/export_template_list | GetExportTemplateList
*Task* | [**TaskListGet**](docs/Task.md#tasklistget) | **Get** /merchant/task/list | GetTaskList
*Task* | [**TaskListPost**](docs/Task.md#tasklistpost) | **Post** /merchant/task/list | GetTaskList
*Task* | [**TaskNewExportPost**](docs/Task.md#tasknewexportpost) | **Post** /merchant/task/new_export | NewExport
*Task* | [**TaskNewExportTemplatePost**](docs/Task.md#tasknewexporttemplatepost) | **Post** /merchant/task/new_export_template | NewExportTemplate
*Task* | [**TaskNewImportPost**](docs/Task.md#tasknewimportpost) | **Post** /merchant/task/new_import | NewImport
...
## Documentation For Models
 ...
 - [MerchantTaskEditExportTemplatePost200Response](docs/MerchantTaskEditExportTemplatePost200Response.md)
 - [MerchantTaskEditExportTemplatePost200ResponseData](docs/MerchantTaskEditExportTemplatePost200ResponseData.md)
 - [MerchantTaskExportColumnListPost200Response](docs/MerchantTaskExportColumnListPost200Response.md)
 - [MerchantTaskExportColumnListPost200ResponseData](docs/MerchantTaskExportColumnListPost200ResponseData.md)
 - [MerchantTaskExportTemplateListGet200Response](docs/MerchantTaskExportTemplateListGet200Response.md)
 - [MerchantTaskExportTemplateListGet200ResponseData](docs/MerchantTaskExportTemplateListGet200ResponseData.md)
 - [MerchantTaskListGet200Response](docs/MerchantTaskListGet200Response.md)
 - [MerchantTaskListGet200ResponseData](docs/MerchantTaskListGet200ResponseData.md)
 ...
 - [UnibeeApiMerchantTaskDeleteTemplateReq](docs/UnibeeApiMerchantTaskDeleteTemplateReq.md)
 - [UnibeeApiMerchantTaskEditTemplateReq](docs/UnibeeApiMerchantTaskEditTemplateReq.md)
 - [UnibeeApiMerchantTaskEditTemplateRes](docs/UnibeeApiMerchantTaskEditTemplateRes.md)
 - [UnibeeApiMerchantTaskExportColumnListReq](docs/UnibeeApiMerchantTaskExportColumnListReq.md)
 - [UnibeeApiMerchantTaskExportColumnListRes](docs/UnibeeApiMerchantTaskExportColumnListRes.md)
 - [UnibeeApiMerchantTaskExportTemplateListReq](docs/UnibeeApiMerchantTaskExportTemplateListReq.md)
 - [UnibeeApiMerchantTaskExportTemplateListRes](docs/UnibeeApiMerchantTaskExportTemplateListRes.md)
 - [UnibeeApiMerchantTaskListReq](docs/UnibeeApiMerchantTaskListReq.md)
 - [UnibeeApiMerchantTaskListRes](docs/UnibeeApiMerchantTaskListRes.md)
 - [UnibeeApiMerchantTaskNewReq](docs/UnibeeApiMerchantTaskNewReq.md)
 - [UnibeeApiMerchantTaskNewTemplateReq](docs/UnibeeApiMerchantTaskNewTemplateReq.md)
 - [UnibeeApiMerchantTaskNewTemplateRes](docs/UnibeeApiMerchantTaskNewTemplateRes.md)
