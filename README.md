...
*Plan* | [**PlanExpirePost**](docs/Plan.md#planexpirepost) | **Post** /merchant/plan/expire | Expire Plan
...
```go
auth := context.WithValue(context.Background(), unibee.ContextAccessToken, "BEARER_TOKEN_STRING")
