...
type UnibeeApiBeanInvoice struct {
	...
	CreditPayout *UnibeeApiBeanCreditPayout `json:"creditPayout,omitempty"`
	// crypto_amount, cent
	...
	PromoCreditAccount *UnibeeApiBeanCreditAccount `json:"promoCreditAccount,omitempty"`
	// promo credit discount amount
	PromoCreditDiscountAmount *int64 `json:"promoCreditDiscountAmount,omitempty"`
	PromoCreditPayout *UnibeeApiBeanCreditPayout `json:"promoCreditPayout,omitempty"`
...
// GetCreditPayout returns the CreditPayout field value if set, zero value otherwise.
func (o *UnibeeApiBeanInvoice) GetCreditPayout() UnibeeApiBeanCreditPayout {
	if o == nil || IsNil(o.CreditPayout) {
		var ret UnibeeApiBeanCreditPayout
		return ret
	}
	return *o.CreditPayout
}

// GetCreditPayoutOk returns a tuple with the CreditPayout field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UnibeeApiBeanInvoice) GetCreditPayoutOk() (*UnibeeApiBeanCreditPayout, bool) {
	if o == nil || IsNil(o.CreditPayout) {
		return nil, false
	}
	return o.CreditPayout, true
}
...
// SetCreditPayout gets a reference to the given UnibeeApiBeanCreditPayout and assigns it to the CreditPayout field.
...
func (o *UnibeeApiBeanInvoice) GetMetadata() map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *UnibeeApiBeanInvoice) GetMetadataOk() (*map[string]interface{}, bool) {
	if o == nil || IsNil(o.Metadata) {
		return nil, false
	}
...
func (o *UnibeeApiBeanInvoice) SetMetadata(v map[string]interface{}) {
	o.Metadata = &v
}
...
// GetPromoCreditAccount returns the PromoCreditAccount field value if set, zero value otherwise.
func (o *UnibeeApiBeanInvoice) GetPromoCreditAccount() UnibeeApiBeanCreditAccount {
	if o == nil || IsNil(o.PromoCreditAccount) {
		var ret UnibeeApiBeanCreditAccount
		return ret
	}
	return *o.PromoCreditAccount
}

// GetPromoCreditAccountOk returns a tuple with the PromoCreditAccount field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UnibeeApiBeanInvoice) GetPromoCreditAccountOk() (*UnibeeApiBeanCreditAccount, bool) {
	if o == nil || IsNil(o.PromoCreditAccount) {
		return nil, false
	}
	return o.PromoCreditAccount, true
}
...
// SetPromoCreditAccount gets a reference to the given UnibeeApiBeanCreditAccount and assigns it to the PromoCreditAccount field.
func (o *UnibeeApiBeanInvoice) SetPromoCreditAccount(v UnibeeApiBeanCreditAccount) {
	o.PromoCreditAccount = &v
}
...
// GetPromoCreditPayout returns the PromoCreditPayout field value if set, zero value otherwise.
func (o *UnibeeApiBeanInvoice) GetPromoCreditPayout() UnibeeApiBeanCreditPayout {
	if o == nil || IsNil(o.PromoCreditPayout) {
		var ret UnibeeApiBeanCreditPayout
		return ret
	}
	return *o.PromoCreditPayout
}

// GetPromoCreditPayoutOk returns a tuple with the PromoCreditPayout field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UnibeeApiBeanInvoice) GetPromoCreditPayoutOk() (*UnibeeApiBeanCreditPayout, bool) {
	if o == nil || IsNil(o.PromoCreditPayout) {
		return nil, false
	}
	return o.PromoCreditPayout, true
}
...
// SetPromoCreditPayout gets a reference to the given UnibeeApiBeanCreditPayout and assigns it to the PromoCreditPayout field.
func (o *UnibeeApiBeanInvoice) SetPromoCreditPayout(v UnibeeApiBeanCreditPayout) {
	o.PromoCreditPayout = &v
}
...
func (o UnibeeApiBeanInvoice) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.CreditPayout) {
		toSerialize["creditPayout"] = o.CreditPayout
	}
	...
	if !IsNil(o.PromoCreditAccount) {
		toSerialize["promoCreditAccount"] = o.PromoCreditAccount
	}
	if !IsNil(o.PromoCreditDiscountAmount) {
		toSerialize["promoCreditDiscountAmount"] = o.PromoCreditDiscountAmount
	}
	if !IsNil(o.PromoCreditPayout) {
		toSerialize["promoCreditPayout"] = o.PromoCreditPayout
	}
