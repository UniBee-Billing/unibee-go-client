...
// checks if the MerchantPaymentListGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantPaymentListGet200Response{}

// MerchantPaymentListGet200Response struct for MerchantPaymentListGet200Response
type MerchantPaymentListGet200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantPaymentListGet200ResponseData `json:"data,omitempty"`
...
func NewMerchantPaymentListGet200Response() *MerchantPaymentListGet200Response {
	this := MerchantPaymentListGet200Response{}
	return &this
}
...
func (o *MerchantPaymentListGet200Response) GetData() MerchantPaymentListGet200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantPaymentListGet200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantPaymentListGet200ResponseData and assigns it to the Data field.
...
func (o MerchantPaymentListGet200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantPaymentListGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantPaymentListGet200Response struct {
	value *MerchantPaymentListGet200Response
	isSet bool
}

func (v NullableMerchantPaymentListGet200Response) Get() *MerchantPaymentListGet200Response {
	return v.value
}

func (v *NullableMerchantPaymentListGet200Response) Set(val *MerchantPaymentListGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantPaymentListGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantPaymentListGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantPaymentListGet200Response(val *MerchantPaymentListGet200Response) *NullableMerchantPaymentListGet200Response {
	return &NullableMerchantPaymentListGet200Response{value: val, isSet: true}
}

func (v NullableMerchantPaymentListGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantPaymentListGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
