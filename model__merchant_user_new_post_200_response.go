...
// checks if the MerchantUserNewPost200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantUserNewPost200Response{}

// MerchantUserNewPost200Response struct for MerchantUserNewPost200Response
type MerchantUserNewPost200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantUserNewPost200ResponseData `json:"data,omitempty"`
...
func NewMerchantUserNewPost200Response() *MerchantUserNewPost200Response {
	this := MerchantUserNewPost200Response{}
	return &this
}
...
func (o *MerchantUserNewPost200Response) GetData() MerchantUserNewPost200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantUserNewPost200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantUserNewPost200ResponseData and assigns it to the Data field.
...
func (o MerchantUserNewPost200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantUserNewPost200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantUserNewPost200Response struct {
	value *MerchantUserNewPost200Response
	isSet bool
}

func (v NullableMerchantUserNewPost200Response) Get() *MerchantUserNewPost200Response {
	return v.value
}

func (v *NullableMerchantUserNewPost200Response) Set(val *MerchantUserNewPost200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantUserNewPost200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantUserNewPost200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantUserNewPost200Response(val *MerchantUserNewPost200Response) *NullableMerchantUserNewPost200Response {
	return &NullableMerchantUserNewPost200Response{value: val, isSet: true}
}

func (v NullableMerchantUserNewPost200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantUserNewPost200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
