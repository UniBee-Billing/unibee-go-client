...
// checks if the MerchantRoleListGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantRoleListGet200Response{}

// MerchantRoleListGet200Response struct for MerchantRoleListGet200Response
type MerchantRoleListGet200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantRoleListGet200ResponseData `json:"data,omitempty"`
...
func NewMerchantRoleListGet200Response() *MerchantRoleListGet200Response {
	this := MerchantRoleListGet200Response{}
	return &this
}
...
func (o *MerchantRoleListGet200Response) GetData() MerchantRoleListGet200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantRoleListGet200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantRoleListGet200ResponseData and assigns it to the Data field.
func (o *MerchantRoleListGet200Response) SetData(v MerchantRoleListGet200ResponseData) {
	o.Data = &v
}

// GetMerchantId returns the MerchantId field value if set, zero value otherwise.
func (o *MerchantRoleListGet200Response) GetMerchantId() int64 {
...
// and a boolean to check if the value has been set.
func (o *MerchantRoleListGet200Response) GetMerchantIdOk() (*int64, bool) {
	if o == nil || IsNil(o.MerchantId) {
		return nil, false
	}
...
func (o *MerchantRoleListGet200Response) HasMerchantId() bool {
	if o != nil && !IsNil(o.MerchantId) {
		return true
	}
...
func (o *MerchantRoleListGet200Response) SetMerchantId(v int64) {
	o.MerchantId = &v
}
...
func (o MerchantRoleListGet200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantRoleListGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantRoleListGet200Response struct {
	value *MerchantRoleListGet200Response
	isSet bool
}

func (v NullableMerchantRoleListGet200Response) Get() *MerchantRoleListGet200Response {
	return v.value
}

func (v *NullableMerchantRoleListGet200Response) Set(val *MerchantRoleListGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantRoleListGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantRoleListGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantRoleListGet200Response(val *MerchantRoleListGet200Response) *NullableMerchantRoleListGet200Response {
	return &NullableMerchantRoleListGet200Response{value: val, isSet: true}
}

func (v NullableMerchantRoleListGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantRoleListGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
