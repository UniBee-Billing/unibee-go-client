...
type AdminMemberMemberUpdateOauthPostRequest struct {
	ctx context.Context
	ApiService *AdminMemberService
	unibeeApiMerchantMemberUpdateOAuthReq *UnibeeApiMerchantMemberUpdateOAuthReq
}

func (r AdminMemberMemberUpdateOauthPostRequest) UnibeeApiMerchantMemberUpdateOAuthReq(unibeeApiMerchantMemberUpdateOAuthReq UnibeeApiMerchantMemberUpdateOAuthReq) AdminMemberMemberUpdateOauthPostRequest {
	r.unibeeApiMerchantMemberUpdateOAuthReq = &unibeeApiMerchantMemberUpdateOAuthReq
	return r
}
...
func (a *AdminMemberService) MemberUpdateOauthPostExecute(r AdminMemberMemberUpdateOauthPostRequest) (*MerchantAuthSsoClearTotpPost200Response, *http.Response, error) {
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.unibeeApiMerchantMemberUpdateOAuthReq == nil {
		return localVarReturnValue, nil, reportError("unibeeApiMerchantMemberUpdateOAuthReq is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.unibeeApiMerchantMemberUpdateOAuthReq
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
