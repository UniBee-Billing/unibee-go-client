...
// checks if the MerchantSubscriptionCreatePreviewPost200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantSubscriptionCreatePreviewPost200Response{}

// MerchantSubscriptionCreatePreviewPost200Response struct for MerchantSubscriptionCreatePreviewPost200Response
type MerchantSubscriptionCreatePreviewPost200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantSubscriptionCreatePreviewPost200ResponseData `json:"data,omitempty"`
...
func NewMerchantSubscriptionCreatePreviewPost200Response() *MerchantSubscriptionCreatePreviewPost200Response {
	this := MerchantSubscriptionCreatePreviewPost200Response{}
	return &this
}
...
func (o *MerchantSubscriptionCreatePreviewPost200Response) GetData() MerchantSubscriptionCreatePreviewPost200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantSubscriptionCreatePreviewPost200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantSubscriptionCreatePreviewPost200ResponseData and assigns it to the Data field.
...
func (o MerchantSubscriptionCreatePreviewPost200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantSubscriptionCreatePreviewPost200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantSubscriptionCreatePreviewPost200Response struct {
	value *MerchantSubscriptionCreatePreviewPost200Response
	isSet bool
}

func (v NullableMerchantSubscriptionCreatePreviewPost200Response) Get() *MerchantSubscriptionCreatePreviewPost200Response {
	return v.value
}

func (v *NullableMerchantSubscriptionCreatePreviewPost200Response) Set(val *MerchantSubscriptionCreatePreviewPost200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantSubscriptionCreatePreviewPost200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantSubscriptionCreatePreviewPost200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantSubscriptionCreatePreviewPost200Response(val *MerchantSubscriptionCreatePreviewPost200Response) *NullableMerchantSubscriptionCreatePreviewPost200Response {
	return &NullableMerchantSubscriptionCreatePreviewPost200Response{value: val, isSet: true}
}

func (v NullableMerchantSubscriptionCreatePreviewPost200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantSubscriptionCreatePreviewPost200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
