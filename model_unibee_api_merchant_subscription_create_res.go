...
type UnibeeApiMerchantSubscriptionCreateRes struct {
	...
	// ID of the first invoice generated for this subscription.
	InvoiceId *string `json:"invoiceId,omitempty"`
	// Hosted payment or invoice link. When paid=false, redirect the customer to this link to complete payment.
	Link                           *string                                `json:"link,omitempty"`
	OtherPendingCryptoSubscription *UnibeeApiBeanDetailSubscriptionDetail `json:"otherPendingCryptoSubscription,omitempty"`
	// Whether the first invoice has been successfully paid at the time of response.
	Paid *bool `json:"paid,omitempty"`
	// ID of the payment created for the first invoice, if any.
	PaymentId    *string                    `json:"paymentId,omitempty"`
	Subscription *UnibeeApiBeanSubscription `json:"subscription,omitempty"`
	// Portal authentication token for the user, used by admin portal flows.
