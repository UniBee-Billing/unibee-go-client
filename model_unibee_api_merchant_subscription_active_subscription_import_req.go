...
// UnibeeApiMerchantSubscriptionActiveSubscriptionImportReq struct for UnibeeApiMerchantSubscriptionActiveSubscriptionImportReq
type UnibeeApiMerchantSubscriptionActiveSubscriptionImportReq struct {
	...
	// The TaxPercentage of user, valid when system vat gateway enabled, ，1000 = 10%
