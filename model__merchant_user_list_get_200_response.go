...
// checks if the MerchantUserListGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantUserListGet200Response{}

// MerchantUserListGet200Response struct for MerchantUserListGet200Response
type MerchantUserListGet200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantUserListGet200ResponseData `json:"data,omitempty"`
...
func NewMerchantUserListGet200Response() *MerchantUserListGet200Response {
	this := MerchantUserListGet200Response{}
	return &this
}
...
func (o *MerchantUserListGet200Response) GetData() MerchantUserListGet200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantUserListGet200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantUserListGet200ResponseData and assigns it to the Data field.
...
func (o MerchantUserListGet200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantUserListGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantUserListGet200Response struct {
	value *MerchantUserListGet200Response
	isSet bool
}

func (v NullableMerchantUserListGet200Response) Get() *MerchantUserListGet200Response {
	return v.value
}

func (v *NullableMerchantUserListGet200Response) Set(val *MerchantUserListGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantUserListGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantUserListGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantUserListGet200Response(val *MerchantUserListGet200Response) *NullableMerchantUserListGet200Response {
	return &NullableMerchantUserListGet200Response{value: val, isSet: true}
}

func (v NullableMerchantUserListGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantUserListGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
