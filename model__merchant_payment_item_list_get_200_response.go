...
// checks if the MerchantPaymentItemListGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantPaymentItemListGet200Response{}

// MerchantPaymentItemListGet200Response struct for MerchantPaymentItemListGet200Response
type MerchantPaymentItemListGet200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantPaymentItemListGet200ResponseData `json:"data,omitempty"`
...
func NewMerchantPaymentItemListGet200Response() *MerchantPaymentItemListGet200Response {
	this := MerchantPaymentItemListGet200Response{}
	return &this
}
...
func (o *MerchantPaymentItemListGet200Response) GetData() MerchantPaymentItemListGet200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantPaymentItemListGet200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantPaymentItemListGet200ResponseData and assigns it to the Data field.
...
func (o MerchantPaymentItemListGet200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantPaymentItemListGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantPaymentItemListGet200Response struct {
	value *MerchantPaymentItemListGet200Response
	isSet bool
}

func (v NullableMerchantPaymentItemListGet200Response) Get() *MerchantPaymentItemListGet200Response {
	return v.value
}

func (v *NullableMerchantPaymentItemListGet200Response) Set(val *MerchantPaymentItemListGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantPaymentItemListGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantPaymentItemListGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantPaymentItemListGet200Response(val *MerchantPaymentItemListGet200Response) *NullableMerchantPaymentItemListGet200Response {
	return &NullableMerchantPaymentItemListGet200Response{value: val, isSet: true}
}

func (v NullableMerchantPaymentItemListGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantPaymentItemListGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
