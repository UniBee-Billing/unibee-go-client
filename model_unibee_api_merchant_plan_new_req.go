...
type UnibeeApiMerchantPlanNewReq struct {
	...
	MetricMeteredCharge []UnibeeApiBeanMetricPlanChargeBindingParam `json:"metricMeteredCharge,omitempty"`
	// Plan's MetricRecurringCharge
	MetricRecurringCharge []UnibeeApiBeanMetricPlanChargeBindingParam `json:"metricRecurringCharge,omitempty"`
...
// SetMetricMeteredCharge gets a reference to the given []UnibeeApiBeanMetricPlanChargeBindingParam and assigns it to the MetricMeteredCharge field.
...
// SetMetricRecurringCharge gets a reference to the given []UnibeeApiBeanMetricPlanChargeBindingParam and assigns it to the MetricRecurringCharge field.
