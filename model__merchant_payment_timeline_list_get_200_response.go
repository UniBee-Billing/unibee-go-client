...
func (o *MerchantPaymentTimelineListGet200Response) GetMerchantId() int64 {
...
// and a boolean to check if the value has been set.
func (o *MerchantPaymentTimelineListGet200Response) GetMerchantIdOk() (*int64, bool) {
	if o == nil || IsNil(o.MerchantId) {
		return nil, false
	}
...
func (o *MerchantPaymentTimelineListGet200Response) HasMerchantId() bool {
	if o != nil && !IsNil(o.MerchantId) {
		return true
	}
...
func (o *MerchantPaymentTimelineListGet200Response) SetMerchantId(v int64) {
	o.MerchantId = &v
}
