...
// checks if the MerchantMemberGetTotpKeyPost200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantMemberGetTotpKeyPost200Response{}

// MerchantMemberGetTotpKeyPost200Response struct for MerchantMemberGetTotpKeyPost200Response
type MerchantMemberGetTotpKeyPost200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantMemberGetTotpKeyPost200ResponseData `json:"data,omitempty"`
...
func NewMerchantMemberGetTotpKeyPost200Response() *MerchantMemberGetTotpKeyPost200Response {
	this := MerchantMemberGetTotpKeyPost200Response{}
	return &this
}
...
func (o *MerchantMemberGetTotpKeyPost200Response) GetData() MerchantMemberGetTotpKeyPost200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantMemberGetTotpKeyPost200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantMemberGetTotpKeyPost200ResponseData and assigns it to the Data field.
...
func (o MerchantMemberGetTotpKeyPost200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantMemberGetTotpKeyPost200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantMemberGetTotpKeyPost200Response struct {
	value *MerchantMemberGetTotpKeyPost200Response
	isSet bool
}

func (v NullableMerchantMemberGetTotpKeyPost200Response) Get() *MerchantMemberGetTotpKeyPost200Response {
	return v.value
}

func (v *NullableMerchantMemberGetTotpKeyPost200Response) Set(val *MerchantMemberGetTotpKeyPost200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantMemberGetTotpKeyPost200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantMemberGetTotpKeyPost200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantMemberGetTotpKeyPost200Response(val *MerchantMemberGetTotpKeyPost200Response) *NullableMerchantMemberGetTotpKeyPost200Response {
	return &NullableMerchantMemberGetTotpKeyPost200Response{value: val, isSet: true}
}

func (v NullableMerchantMemberGetTotpKeyPost200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantMemberGetTotpKeyPost200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
