...
// checks if the MerchantSearchKeySearchGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantSearchKeySearchGet200Response{}

// MerchantSearchKeySearchGet200Response struct for MerchantSearchKeySearchGet200Response
type MerchantSearchKeySearchGet200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantSearchKeySearchGet200ResponseData `json:"data,omitempty"`
...
func NewMerchantSearchKeySearchGet200Response() *MerchantSearchKeySearchGet200Response {
	this := MerchantSearchKeySearchGet200Response{}
	return &this
}
...
func (o *MerchantSearchKeySearchGet200Response) GetData() MerchantSearchKeySearchGet200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantSearchKeySearchGet200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantSearchKeySearchGet200ResponseData and assigns it to the Data field.
...
func (o MerchantSearchKeySearchGet200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantSearchKeySearchGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantSearchKeySearchGet200Response struct {
	value *MerchantSearchKeySearchGet200Response
	isSet bool
}

func (v NullableMerchantSearchKeySearchGet200Response) Get() *MerchantSearchKeySearchGet200Response {
	return v.value
}

func (v *NullableMerchantSearchKeySearchGet200Response) Set(val *MerchantSearchKeySearchGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantSearchKeySearchGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantSearchKeySearchGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantSearchKeySearchGet200Response(val *MerchantSearchKeySearchGet200Response) *NullableMerchantSearchKeySearchGet200Response {
	return &NullableMerchantSearchKeySearchGet200Response{value: val, isSet: true}
}

func (v NullableMerchantSearchKeySearchGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantSearchKeySearchGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
