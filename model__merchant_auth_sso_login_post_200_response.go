...
// checks if the MerchantAuthSsoLoginPost200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantAuthSsoLoginPost200Response{}

// MerchantAuthSsoLoginPost200Response struct for MerchantAuthSsoLoginPost200Response
type MerchantAuthSsoLoginPost200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantAuthSsoLoginPost200ResponseData `json:"data,omitempty"`
...
func NewMerchantAuthSsoLoginPost200Response() *MerchantAuthSsoLoginPost200Response {
	this := MerchantAuthSsoLoginPost200Response{}
	return &this
}
...
func (o *MerchantAuthSsoLoginPost200Response) GetData() MerchantAuthSsoLoginPost200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantAuthSsoLoginPost200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantAuthSsoLoginPost200ResponseData and assigns it to the Data field.
...
func (o MerchantAuthSsoLoginPost200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantAuthSsoLoginPost200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantAuthSsoLoginPost200Response struct {
	value *MerchantAuthSsoLoginPost200Response
	isSet bool
}

func (v NullableMerchantAuthSsoLoginPost200Response) Get() *MerchantAuthSsoLoginPost200Response {
	return v.value
}

func (v *NullableMerchantAuthSsoLoginPost200Response) Set(val *MerchantAuthSsoLoginPost200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantAuthSsoLoginPost200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantAuthSsoLoginPost200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantAuthSsoLoginPost200Response(val *MerchantAuthSsoLoginPost200Response) *NullableMerchantAuthSsoLoginPost200Response {
	return &NullableMerchantAuthSsoLoginPost200Response{value: val, isSet: true}
}

func (v NullableMerchantAuthSsoLoginPost200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantAuthSsoLoginPost200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
