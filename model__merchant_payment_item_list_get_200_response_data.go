...
type MerchantPaymentItemListGet200ResponseData struct {
	...
	PaymentItems []UnibeeApiBeanPaymentItemSimplify `json:"paymentItems,omitempty"`
	// Total
...
func (o *MerchantPaymentItemListGet200ResponseData) GetPaymentItems() []UnibeeApiBeanPaymentItemSimplify {
	if o == nil || IsNil(o.PaymentItems) {
		var ret []UnibeeApiBeanPaymentItemSimplify
		return ret
	}
...
// SetPaymentItems gets a reference to the given []UnibeeApiBeanPaymentItemSimplify and assigns it to the PaymentItems field.
