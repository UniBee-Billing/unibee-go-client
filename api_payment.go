...
func (r PaymentPaymentCancelPostRequest) Execute() (*MerchantAuthSsoClearTotpPost200Response, *http.Response, error) {
...
func (a *PaymentService) PaymentCancelPostExecute(r PaymentPaymentCancelPostRequest) (*MerchantAuthSsoClearTotpPost200Response, *http.Response, error) {
	var (
...
func (r PaymentPaymentCapturePostRequest) Execute() (*MerchantAuthSsoClearTotpPost200Response, *http.Response, error) {
...
// Execute executes the request
//  @return MerchantAuthSsoClearTotpPost200Response
func (a *PaymentService) PaymentCapturePostExecute(r PaymentPaymentCapturePostRequest) (*MerchantAuthSsoClearTotpPost200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
/*
PaymentDetailGet Payment Detail
...
type PaymentPaymentExternalGatewayPaymentMarkFailedPostRequest struct {
	ctx context.Context
	ApiService *PaymentService
	unibeeApiMerchantPaymentExternalGatewayPaymentMarkFailedReq *UnibeeApiMerchantPaymentExternalGatewayPaymentMarkFailedReq
}

func (r PaymentPaymentExternalGatewayPaymentMarkFailedPostRequest) UnibeeApiMerchantPaymentExternalGatewayPaymentMarkFailedReq(unibeeApiMerchantPaymentExternalGatewayPaymentMarkFailedReq UnibeeApiMerchantPaymentExternalGatewayPaymentMarkFailedReq) PaymentPaymentExternalGatewayPaymentMarkFailedPostRequest {
	r.unibeeApiMerchantPaymentExternalGatewayPaymentMarkFailedReq = &unibeeApiMerchantPaymentExternalGatewayPaymentMarkFailedReq
	return r
}

func (r PaymentPaymentExternalGatewayPaymentMarkFailedPostRequest) Execute() (*MerchantPaymentExternalGatewayPaymentMarkFailedPost200Response, *http.Response, error) {
	return r.ApiService.PaymentExternalGatewayPaymentMarkFailedPostExecute(r)
}

/*
PaymentExternalGatewayPaymentMarkFailedPost Mark External Gateway Payment As Failed

Mark payment as failed using external gateway result. Auth: OpenAPI + signature (HMAC-SHA256, hex).

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return PaymentPaymentExternalGatewayPaymentMarkFailedPostRequest
*/
func (a *PaymentService) PaymentExternalGatewayPaymentMarkFailedPost(ctx context.Context) PaymentPaymentExternalGatewayPaymentMarkFailedPostRequest {
	return PaymentPaymentExternalGatewayPaymentMarkFailedPostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return MerchantPaymentExternalGatewayPaymentMarkFailedPost200Response
func (a *PaymentService) PaymentExternalGatewayPaymentMarkFailedPostExecute(r PaymentPaymentExternalGatewayPaymentMarkFailedPostRequest) (*MerchantPaymentExternalGatewayPaymentMarkFailedPost200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *MerchantPaymentExternalGatewayPaymentMarkFailedPost200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PaymentService.PaymentExternalGatewayPaymentMarkFailedPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/merchant/payment/external_gateway_payment/mark_failed"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.unibeeApiMerchantPaymentExternalGatewayPaymentMarkFailedReq == nil {
		return localVarReturnValue, nil, reportError("unibeeApiMerchantPaymentExternalGatewayPaymentMarkFailedReq is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.unibeeApiMerchantPaymentExternalGatewayPaymentMarkFailedReq
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
type PaymentPaymentExternalGatewayPaymentMarkPaidPostRequest struct {
	ctx context.Context
	ApiService *PaymentService
	unibeeApiMerchantPaymentExternalGatewayPaymentMarkPaidReq *UnibeeApiMerchantPaymentExternalGatewayPaymentMarkPaidReq
}

func (r PaymentPaymentExternalGatewayPaymentMarkPaidPostRequest) UnibeeApiMerchantPaymentExternalGatewayPaymentMarkPaidReq(unibeeApiMerchantPaymentExternalGatewayPaymentMarkPaidReq UnibeeApiMerchantPaymentExternalGatewayPaymentMarkPaidReq) PaymentPaymentExternalGatewayPaymentMarkPaidPostRequest {
	r.unibeeApiMerchantPaymentExternalGatewayPaymentMarkPaidReq = &unibeeApiMerchantPaymentExternalGatewayPaymentMarkPaidReq
	return r
}

func (r PaymentPaymentExternalGatewayPaymentMarkPaidPostRequest) Execute() (*MerchantPaymentExternalGatewayPaymentMarkPaidPost200Response, *http.Response, error) {
	return r.ApiService.PaymentExternalGatewayPaymentMarkPaidPostExecute(r)
}

/*
PaymentExternalGatewayPaymentMarkPaidPost Mark External Gateway Payment As Paid

Mark payment as paid using external gateway result. Auth: OpenAPI + signature (HMAC-SHA256, hex).

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return PaymentPaymentExternalGatewayPaymentMarkPaidPostRequest
*/
func (a *PaymentService) PaymentExternalGatewayPaymentMarkPaidPost(ctx context.Context) PaymentPaymentExternalGatewayPaymentMarkPaidPostRequest {
	return PaymentPaymentExternalGatewayPaymentMarkPaidPostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return MerchantPaymentExternalGatewayPaymentMarkPaidPost200Response
func (a *PaymentService) PaymentExternalGatewayPaymentMarkPaidPostExecute(r PaymentPaymentExternalGatewayPaymentMarkPaidPostRequest) (*MerchantPaymentExternalGatewayPaymentMarkPaidPost200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *MerchantPaymentExternalGatewayPaymentMarkPaidPost200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PaymentService.PaymentExternalGatewayPaymentMarkPaidPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/merchant/payment/external_gateway_payment/mark_paid"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.unibeeApiMerchantPaymentExternalGatewayPaymentMarkPaidReq == nil {
		return localVarReturnValue, nil, reportError("unibeeApiMerchantPaymentExternalGatewayPaymentMarkPaidReq is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.unibeeApiMerchantPaymentExternalGatewayPaymentMarkPaidReq
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
type PaymentPaymentExternalGatewayPaymentUpdateLinkPostRequest struct {
	ctx context.Context
	ApiService *PaymentService
	unibeeApiMerchantPaymentExternalGatewayPaymentUpdateLinkReq *UnibeeApiMerchantPaymentExternalGatewayPaymentUpdateLinkReq
}

func (r PaymentPaymentExternalGatewayPaymentUpdateLinkPostRequest) UnibeeApiMerchantPaymentExternalGatewayPaymentUpdateLinkReq(unibeeApiMerchantPaymentExternalGatewayPaymentUpdateLinkReq UnibeeApiMerchantPaymentExternalGatewayPaymentUpdateLinkReq) PaymentPaymentExternalGatewayPaymentUpdateLinkPostRequest {
	r.unibeeApiMerchantPaymentExternalGatewayPaymentUpdateLinkReq = &unibeeApiMerchantPaymentExternalGatewayPaymentUpdateLinkReq
	return r
}

func (r PaymentPaymentExternalGatewayPaymentUpdateLinkPostRequest) Execute() (*MerchantPaymentExternalGatewayPaymentUpdateLinkPost200Response, *http.Response, error) {
	return r.ApiService.PaymentExternalGatewayPaymentUpdateLinkPostExecute(r)
}

/*
PaymentExternalGatewayPaymentUpdateLinkPost Update External Gateway Payment Link

Update external checkout link for a payment. Auth: OpenAPI + signature (HMAC-SHA256, hex).

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return PaymentPaymentExternalGatewayPaymentUpdateLinkPostRequest
*/
func (a *PaymentService) PaymentExternalGatewayPaymentUpdateLinkPost(ctx context.Context) PaymentPaymentExternalGatewayPaymentUpdateLinkPostRequest {
	return PaymentPaymentExternalGatewayPaymentUpdateLinkPostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return MerchantPaymentExternalGatewayPaymentUpdateLinkPost200Response
func (a *PaymentService) PaymentExternalGatewayPaymentUpdateLinkPostExecute(r PaymentPaymentExternalGatewayPaymentUpdateLinkPostRequest) (*MerchantPaymentExternalGatewayPaymentUpdateLinkPost200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *MerchantPaymentExternalGatewayPaymentUpdateLinkPost200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PaymentService.PaymentExternalGatewayPaymentUpdateLinkPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/merchant/payment/external_gateway_payment/update_link"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.unibeeApiMerchantPaymentExternalGatewayPaymentUpdateLinkReq == nil {
		return localVarReturnValue, nil, reportError("unibeeApiMerchantPaymentExternalGatewayPaymentUpdateLinkReq is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.unibeeApiMerchantPaymentExternalGatewayPaymentUpdateLinkReq
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
type PaymentPaymentExternalGatewayRefundMarkFailedPostRequest struct {
	ctx context.Context
	ApiService *PaymentService
	unibeeApiMerchantPaymentExternalGatewayRefundMarkFailedReq *UnibeeApiMerchantPaymentExternalGatewayRefundMarkFailedReq
}

func (r PaymentPaymentExternalGatewayRefundMarkFailedPostRequest) UnibeeApiMerchantPaymentExternalGatewayRefundMarkFailedReq(unibeeApiMerchantPaymentExternalGatewayRefundMarkFailedReq UnibeeApiMerchantPaymentExternalGatewayRefundMarkFailedReq) PaymentPaymentExternalGatewayRefundMarkFailedPostRequest {
	r.unibeeApiMerchantPaymentExternalGatewayRefundMarkFailedReq = &unibeeApiMerchantPaymentExternalGatewayRefundMarkFailedReq
	return r
}

func (r PaymentPaymentExternalGatewayRefundMarkFailedPostRequest) Execute() (*MerchantPaymentExternalGatewayRefundMarkFailedPost200Response, *http.Response, error) {
	return r.ApiService.PaymentExternalGatewayRefundMarkFailedPostExecute(r)
}

/*
PaymentExternalGatewayRefundMarkFailedPost Mark External Gateway Refund As Failed

Mark refund as failed using external gateway result. Auth: OpenAPI + signature (HMAC-SHA256, hex).

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return PaymentPaymentExternalGatewayRefundMarkFailedPostRequest
*/
func (a *PaymentService) PaymentExternalGatewayRefundMarkFailedPost(ctx context.Context) PaymentPaymentExternalGatewayRefundMarkFailedPostRequest {
	return PaymentPaymentExternalGatewayRefundMarkFailedPostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return MerchantPaymentExternalGatewayRefundMarkFailedPost200Response
func (a *PaymentService) PaymentExternalGatewayRefundMarkFailedPostExecute(r PaymentPaymentExternalGatewayRefundMarkFailedPostRequest) (*MerchantPaymentExternalGatewayRefundMarkFailedPost200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *MerchantPaymentExternalGatewayRefundMarkFailedPost200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PaymentService.PaymentExternalGatewayRefundMarkFailedPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/merchant/payment/external_gateway_refund/mark_failed"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.unibeeApiMerchantPaymentExternalGatewayRefundMarkFailedReq == nil {
		return localVarReturnValue, nil, reportError("unibeeApiMerchantPaymentExternalGatewayRefundMarkFailedReq is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.unibeeApiMerchantPaymentExternalGatewayRefundMarkFailedReq
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
type PaymentPaymentExternalGatewayRefundMarkSuccessPostRequest struct {
	ctx context.Context
	ApiService *PaymentService
	unibeeApiMerchantPaymentExternalGatewayRefundMarkSuccessReq *UnibeeApiMerchantPaymentExternalGatewayRefundMarkSuccessReq
}

func (r PaymentPaymentExternalGatewayRefundMarkSuccessPostRequest) UnibeeApiMerchantPaymentExternalGatewayRefundMarkSuccessReq(unibeeApiMerchantPaymentExternalGatewayRefundMarkSuccessReq UnibeeApiMerchantPaymentExternalGatewayRefundMarkSuccessReq) PaymentPaymentExternalGatewayRefundMarkSuccessPostRequest {
	r.unibeeApiMerchantPaymentExternalGatewayRefundMarkSuccessReq = &unibeeApiMerchantPaymentExternalGatewayRefundMarkSuccessReq
	return r
}

func (r PaymentPaymentExternalGatewayRefundMarkSuccessPostRequest) Execute() (*MerchantPaymentExternalGatewayRefundMarkSuccessPost200Response, *http.Response, error) {
	return r.ApiService.PaymentExternalGatewayRefundMarkSuccessPostExecute(r)
}

/*
PaymentExternalGatewayRefundMarkSuccessPost Mark External Gateway Refund As Success

Mark refund as success using external gateway result. Auth: OpenAPI + signature (HMAC-SHA256, hex).

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return PaymentPaymentExternalGatewayRefundMarkSuccessPostRequest
*/
func (a *PaymentService) PaymentExternalGatewayRefundMarkSuccessPost(ctx context.Context) PaymentPaymentExternalGatewayRefundMarkSuccessPostRequest {
	return PaymentPaymentExternalGatewayRefundMarkSuccessPostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return MerchantPaymentExternalGatewayRefundMarkSuccessPost200Response
func (a *PaymentService) PaymentExternalGatewayRefundMarkSuccessPostExecute(r PaymentPaymentExternalGatewayRefundMarkSuccessPostRequest) (*MerchantPaymentExternalGatewayRefundMarkSuccessPost200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *MerchantPaymentExternalGatewayRefundMarkSuccessPost200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PaymentService.PaymentExternalGatewayRefundMarkSuccessPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/merchant/payment/external_gateway_refund/mark_success"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.unibeeApiMerchantPaymentExternalGatewayRefundMarkSuccessReq == nil {
		return localVarReturnValue, nil, reportError("unibeeApiMerchantPaymentExternalGatewayRefundMarkSuccessReq is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.unibeeApiMerchantPaymentExternalGatewayRefundMarkSuccessReq
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
/*
PaymentItemListGet Get OneTime Payment Item List
...
/*
PaymentListGet Get Payment List
...
func (r PaymentPaymentMethodDeletePostRequest) Execute() (*MerchantAuthSsoClearTotpPost200Response, *http.Response, error) {
	return r.ApiService.PaymentMethodDeletePostExecute(r)
}

/*
PaymentMethodDeletePost Delete Payment Method
...
// Execute executes the request
//  @return MerchantAuthSsoClearTotpPost200Response
func (a *PaymentService) PaymentMethodDeletePostExecute(r PaymentPaymentMethodDeletePostRequest) (*MerchantAuthSsoClearTotpPost200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
/*
PaymentMethodGetGet Payment Method
...
/*
PaymentMethodListGet Payment Method List
...
/*
PaymentMethodNewPost Create New Payment Method
...
func (r PaymentPaymentRefundCancelPostRequest) Execute() (*MerchantAuthSsoClearTotpPost200Response, *http.Response, error) {
...
// Execute executes the request
//  @return MerchantAuthSsoClearTotpPost200Response
func (a *PaymentService) PaymentRefundCancelPostExecute(r PaymentPaymentRefundCancelPostRequest) (*MerchantAuthSsoClearTotpPost200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
/*
PaymentRefundDetailGet Payment Refund Detail
...
/*
PaymentRefundListGet Get Payment Refund List
...
func (r PaymentPaymentTimelineListGetRequest) SearchKey(searchKey string) PaymentPaymentTimelineListGetRequest {
...
/*
PaymentTimelineListGet Get Payment TimeLine List
...
type PaymentPaymentTimelineListPostRequest struct {
	ctx context.Context
	ApiService *PaymentService
	unibeeApiMerchantPaymentTimeLineListReq *UnibeeApiMerchantPaymentTimeLineListReq
}

func (r PaymentPaymentTimelineListPostRequest) UnibeeApiMerchantPaymentTimeLineListReq(unibeeApiMerchantPaymentTimeLineListReq UnibeeApiMerchantPaymentTimeLineListReq) PaymentPaymentTimelineListPostRequest {
	r.unibeeApiMerchantPaymentTimeLineListReq = &unibeeApiMerchantPaymentTimeLineListReq
	return r
}

func (r PaymentPaymentTimelineListPostRequest) Execute() (*MerchantPaymentTimelineListGet200Response, *http.Response, error) {
	return r.ApiService.PaymentTimelineListPostExecute(r)
}

/*
PaymentTimelineListPost Get Payment TimeLine List

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return PaymentPaymentTimelineListPostRequest
*/
func (a *PaymentService) PaymentTimelineListPost(ctx context.Context) PaymentPaymentTimelineListPostRequest {
	return PaymentPaymentTimelineListPostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return MerchantPaymentTimelineListGet200Response
func (a *PaymentService) PaymentTimelineListPostExecute(r PaymentPaymentTimelineListPostRequest) (*MerchantPaymentTimelineListGet200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PaymentService.PaymentTimelineListPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
