...
// checks if the UnibeeApiBeanDetailPlanMetricLimitDetail type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UnibeeApiBeanDetailPlanMetricLimitDetail{}

// UnibeeApiBeanDetailPlanMetricLimitDetail struct for UnibeeApiBeanDetailPlanMetricLimitDetail
type UnibeeApiBeanDetailPlanMetricLimitDetail struct {
	MerchantId *int64 `json:"MerchantId,omitempty"`
	MetricId *int64 `json:"MetricId,omitempty"`
	PlanLimits []UnibeeApiBeanDetailMerchantMetricPlanLimitDetail `json:"PlanLimits,omitempty"`
	...
	// Quota adjustments (carryover + manual)
	QuotaAdjustments []UnibeeApiBeanDetailMetricLimitQuotaDetail `json:"quotaAdjustments,omitempty"`
...
func NewUnibeeApiBeanDetailPlanMetricLimitDetail() *UnibeeApiBeanDetailPlanMetricLimitDetail {
	this := UnibeeApiBeanDetailPlanMetricLimitDetail{}
	return &this
}
...
// SetPlanLimits gets a reference to the given []UnibeeApiBeanDetailMerchantMetricPlanLimitDetail and assigns it to the PlanLimits field.
...
// GetQuotaAdjustments returns the QuotaAdjustments field value if set, zero value otherwise.
func (o *UnibeeApiBeanDetailPlanMetricLimitDetail) GetQuotaAdjustments() []UnibeeApiBeanDetailMetricLimitQuotaDetail {
	if o == nil || IsNil(o.QuotaAdjustments) {
		var ret []UnibeeApiBeanDetailMetricLimitQuotaDetail
		return ret
	}
	return o.QuotaAdjustments
}

// GetQuotaAdjustmentsOk returns a tuple with the QuotaAdjustments field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UnibeeApiBeanDetailPlanMetricLimitDetail) GetQuotaAdjustmentsOk() ([]UnibeeApiBeanDetailMetricLimitQuotaDetail, bool) {
	if o == nil || IsNil(o.QuotaAdjustments) {
		return nil, false
	}
	return o.QuotaAdjustments, true
}
...
// SetQuotaAdjustments gets a reference to the given []UnibeeApiBeanDetailMetricLimitQuotaDetail and assigns it to the QuotaAdjustments field.
func (o *UnibeeApiBeanDetailPlanMetricLimitDetail) SetQuotaAdjustments(v []UnibeeApiBeanDetailMetricLimitQuotaDetail) {
	o.QuotaAdjustments = v
}
...
func (o UnibeeApiBeanDetailPlanMetricLimitDetail) MarshalJSON() ([]byte, error) {
...
func (o UnibeeApiBeanDetailPlanMetricLimitDetail) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.QuotaAdjustments) {
		toSerialize["quotaAdjustments"] = o.QuotaAdjustments
	}
	if !IsNil(o.Type) {
...
type NullableUnibeeApiBeanDetailPlanMetricLimitDetail struct {
	value *UnibeeApiBeanDetailPlanMetricLimitDetail
	isSet bool
}

func (v NullableUnibeeApiBeanDetailPlanMetricLimitDetail) Get() *UnibeeApiBeanDetailPlanMetricLimitDetail {
	return v.value
}

func (v *NullableUnibeeApiBeanDetailPlanMetricLimitDetail) Set(val *UnibeeApiBeanDetailPlanMetricLimitDetail) {
	v.value = val
	v.isSet = true
}

func (v NullableUnibeeApiBeanDetailPlanMetricLimitDetail) IsSet() bool {
	return v.isSet
}

func (v *NullableUnibeeApiBeanDetailPlanMetricLimitDetail) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUnibeeApiBeanDetailPlanMetricLimitDetail(val *UnibeeApiBeanDetailPlanMetricLimitDetail) *NullableUnibeeApiBeanDetailPlanMetricLimitDetail {
	return &NullableUnibeeApiBeanDetailPlanMetricLimitDetail{value: val, isSet: true}
}

func (v NullableUnibeeApiBeanDetailPlanMetricLimitDetail) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUnibeeApiBeanDetailPlanMetricLimitDetail) UnmarshalJSON(src []byte) error {
	v.isSet = true
