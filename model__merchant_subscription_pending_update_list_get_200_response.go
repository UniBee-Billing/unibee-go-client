...
// checks if the MerchantSubscriptionPendingUpdateListGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantSubscriptionPendingUpdateListGet200Response{}

// MerchantSubscriptionPendingUpdateListGet200Response struct for MerchantSubscriptionPendingUpdateListGet200Response
type MerchantSubscriptionPendingUpdateListGet200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantSubscriptionPendingUpdateListGet200ResponseData `json:"data,omitempty"`
...
func NewMerchantSubscriptionPendingUpdateListGet200Response() *MerchantSubscriptionPendingUpdateListGet200Response {
	this := MerchantSubscriptionPendingUpdateListGet200Response{}
	return &this
}
...
func (o *MerchantSubscriptionPendingUpdateListGet200Response) GetData() MerchantSubscriptionPendingUpdateListGet200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantSubscriptionPendingUpdateListGet200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantSubscriptionPendingUpdateListGet200ResponseData and assigns it to the Data field.
...
func (o *MerchantSubscriptionPendingUpdateListGet200Response) GetMerchantId() int64 {
...
// and a boolean to check if the value has been set.
func (o *MerchantSubscriptionPendingUpdateListGet200Response) GetMerchantIdOk() (*int64, bool) {
	if o == nil || IsNil(o.MerchantId) {
		return nil, false
	}
...
func (o *MerchantSubscriptionPendingUpdateListGet200Response) HasMerchantId() bool {
	if o != nil && !IsNil(o.MerchantId) {
		return true
	}
...
func (o *MerchantSubscriptionPendingUpdateListGet200Response) SetMerchantId(v int64) {
	o.MerchantId = &v
}
...
func (o MerchantSubscriptionPendingUpdateListGet200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantSubscriptionPendingUpdateListGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantSubscriptionPendingUpdateListGet200Response struct {
	value *MerchantSubscriptionPendingUpdateListGet200Response
	isSet bool
}

func (v NullableMerchantSubscriptionPendingUpdateListGet200Response) Get() *MerchantSubscriptionPendingUpdateListGet200Response {
	return v.value
}

func (v *NullableMerchantSubscriptionPendingUpdateListGet200Response) Set(val *MerchantSubscriptionPendingUpdateListGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantSubscriptionPendingUpdateListGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantSubscriptionPendingUpdateListGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantSubscriptionPendingUpdateListGet200Response(val *MerchantSubscriptionPendingUpdateListGet200Response) *NullableMerchantSubscriptionPendingUpdateListGet200Response {
	return &NullableMerchantSubscriptionPendingUpdateListGet200Response{value: val, isSet: true}
}

func (v NullableMerchantSubscriptionPendingUpdateListGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantSubscriptionPendingUpdateListGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
