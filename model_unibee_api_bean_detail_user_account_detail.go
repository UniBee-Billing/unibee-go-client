...
type UnibeeApiBeanDetailUserAccountDetail struct {
	...
	// creditAccounts
	CreditAccounts []UnibeeApiBeanCreditAccount `json:"creditAccounts,omitempty"`
	// custom
	...
	// promoCreditAccounts
	PromoCreditAccounts []UnibeeApiBeanCreditAccount `json:"promoCreditAccounts,omitempty"`
...
// SetCreditAccounts gets a reference to the given []UnibeeApiBeanCreditAccount and assigns it to the CreditAccounts field.
...
// GetPromoCreditAccounts returns the PromoCreditAccounts field value if set, zero value otherwise.
func (o *UnibeeApiBeanDetailUserAccountDetail) GetPromoCreditAccounts() []UnibeeApiBeanCreditAccount {
	if o == nil || IsNil(o.PromoCreditAccounts) {
		var ret []UnibeeApiBeanCreditAccount
		return ret
	}
	return o.PromoCreditAccounts
}

// GetPromoCreditAccountsOk returns a tuple with the PromoCreditAccounts field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UnibeeApiBeanDetailUserAccountDetail) GetPromoCreditAccountsOk() ([]UnibeeApiBeanCreditAccount, bool) {
	if o == nil || IsNil(o.PromoCreditAccounts) {
		return nil, false
	}
	return o.PromoCreditAccounts, true
}
...
// SetPromoCreditAccounts gets a reference to the given []UnibeeApiBeanCreditAccount and assigns it to the PromoCreditAccounts field.
func (o *UnibeeApiBeanDetailUserAccountDetail) SetPromoCreditAccounts(v []UnibeeApiBeanCreditAccount) {
	o.PromoCreditAccounts = v
}
...
func (o UnibeeApiBeanDetailUserAccountDetail) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.PromoCreditAccounts) {
		toSerialize["promoCreditAccounts"] = o.PromoCreditAccounts
	}
