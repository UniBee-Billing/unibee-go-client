...
type UnibeeApiBeanDetailSubscriptionPendingUpdateDetail struct {
	...
	// Pending update invoice-name intent (mirrors DB column name)
...
func (o *UnibeeApiBeanDetailSubscriptionPendingUpdateDetail) GetMetadata() map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *UnibeeApiBeanDetailSubscriptionPendingUpdateDetail) GetMetadataOk() (*map[string]interface{}, bool) {
	if o == nil || IsNil(o.Metadata) {
		return nil, false
	}
...
func (o *UnibeeApiBeanDetailSubscriptionPendingUpdateDetail) SetMetadata(v map[string]interface{}) {
	o.Metadata = &v
}
