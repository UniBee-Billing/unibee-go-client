...
type UnibeeApiMerchantMemberNewMemberReq struct {
	// Email, email of member, member otp login needs
	Email string `json:"email"`
	// FirstName, member firstName, invoice needs
	FirstName *string `json:"firstName,omitempty"`
	// LastName, member firstName, invoice needs
	LastName *string `json:"lastName,omitempty"`
	// Role, permission role of member
