...
// GetGithubClientSecret returns the GithubClientSecret field value if set, zero value otherwise.
func (o *UnibeeApiSystemInformationOAuthConfig) GetGithubClientSecret() string {
	if o == nil || IsNil(o.GithubClientSecret) {
		var ret string
		return ret
	}
	return *o.GithubClientSecret
}

// GetGithubClientSecretOk returns a tuple with the GithubClientSecret field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UnibeeApiSystemInformationOAuthConfig) GetGithubClientSecretOk() (*string, bool) {
	if o == nil || IsNil(o.GithubClientSecret) {
		return nil, false
	}
	return o.GithubClientSecret, true
}
...
// SetGithubClientSecret gets a reference to the given string and assigns it to the GithubClientSecret field.
func (o *UnibeeApiSystemInformationOAuthConfig) SetGithubClientSecret(v string) {
	o.GithubClientSecret = &v
}
...
func (o UnibeeApiSystemInformationOAuthConfig) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.GithubClientSecret) {
		toSerialize["githubClientSecret"] = o.GithubClientSecret
	}
