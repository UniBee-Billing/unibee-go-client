...
// UnibeeApiMerchantInvoiceMarkExternalGatewayInvoiceAsRefundedReq Deprecated placeholder. External refund flow will be redesigned. Do not use this invoice-level API for new integrations.
