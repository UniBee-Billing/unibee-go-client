...
// checks if the MerchantCreditPromoCreditDecrementPost200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantCreditPromoCreditDecrementPost200Response{}

// MerchantCreditPromoCreditDecrementPost200Response struct for MerchantCreditPromoCreditDecrementPost200Response
type MerchantCreditPromoCreditDecrementPost200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantCreditPromoCreditDecrementPost200ResponseData `json:"data,omitempty"`
...
func NewMerchantCreditPromoCreditDecrementPost200Response() *MerchantCreditPromoCreditDecrementPost200Response {
	this := MerchantCreditPromoCreditDecrementPost200Response{}
	return &this
}
...
func (o *MerchantCreditPromoCreditDecrementPost200Response) GetData() MerchantCreditPromoCreditDecrementPost200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantCreditPromoCreditDecrementPost200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantCreditPromoCreditDecrementPost200ResponseData and assigns it to the Data field.
...
func (o *MerchantCreditPromoCreditDecrementPost200Response) GetMerchantId() int64 {
...
// and a boolean to check if the value has been set.
func (o *MerchantCreditPromoCreditDecrementPost200Response) GetMerchantIdOk() (*int64, bool) {
	if o == nil || IsNil(o.MerchantId) {
		return nil, false
	}
...
func (o *MerchantCreditPromoCreditDecrementPost200Response) HasMerchantId() bool {
	if o != nil && !IsNil(o.MerchantId) {
		return true
	}
...
func (o *MerchantCreditPromoCreditDecrementPost200Response) SetMerchantId(v int64) {
	o.MerchantId = &v
}
...
func (o MerchantCreditPromoCreditDecrementPost200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantCreditPromoCreditDecrementPost200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantCreditPromoCreditDecrementPost200Response struct {
	value *MerchantCreditPromoCreditDecrementPost200Response
	isSet bool
}

func (v NullableMerchantCreditPromoCreditDecrementPost200Response) Get() *MerchantCreditPromoCreditDecrementPost200Response {
	return v.value
}

func (v *NullableMerchantCreditPromoCreditDecrementPost200Response) Set(val *MerchantCreditPromoCreditDecrementPost200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantCreditPromoCreditDecrementPost200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantCreditPromoCreditDecrementPost200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantCreditPromoCreditDecrementPost200Response(val *MerchantCreditPromoCreditDecrementPost200Response) *NullableMerchantCreditPromoCreditDecrementPost200Response {
	return &NullableMerchantCreditPromoCreditDecrementPost200Response{value: val, isSet: true}
}

func (v NullableMerchantCreditPromoCreditDecrementPost200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantCreditPromoCreditDecrementPost200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
