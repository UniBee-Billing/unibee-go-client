...
// checks if the MerchantCreditConfigListGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantCreditConfigListGet200Response{}

// MerchantCreditConfigListGet200Response struct for MerchantCreditConfigListGet200Response
type MerchantCreditConfigListGet200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantCreditConfigListGet200ResponseData `json:"data,omitempty"`
...
func NewMerchantCreditConfigListGet200Response() *MerchantCreditConfigListGet200Response {
	this := MerchantCreditConfigListGet200Response{}
	return &this
}
...
func (o *MerchantCreditConfigListGet200Response) GetData() MerchantCreditConfigListGet200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantCreditConfigListGet200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantCreditConfigListGet200ResponseData and assigns it to the Data field.
...
func (o MerchantCreditConfigListGet200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantCreditConfigListGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantCreditConfigListGet200Response struct {
	value *MerchantCreditConfigListGet200Response
	isSet bool
}

func (v NullableMerchantCreditConfigListGet200Response) Get() *MerchantCreditConfigListGet200Response {
	return v.value
}

func (v *NullableMerchantCreditConfigListGet200Response) Set(val *MerchantCreditConfigListGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantCreditConfigListGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantCreditConfigListGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantCreditConfigListGet200Response(val *MerchantCreditConfigListGet200Response) *NullableMerchantCreditConfigListGet200Response {
	return &NullableMerchantCreditConfigListGet200Response{value: val, isSet: true}
}

func (v NullableMerchantCreditConfigListGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantCreditConfigListGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
