...
type UnibeeApiBeanDetailMerchantDiscountCodeDetail struct {
	...
	Plans []UnibeeApiBeanPlanSimplify `json:"plans,omitempty"`
...
// SetPlans gets a reference to the given []UnibeeApiBeanPlanSimplify and assigns it to the Plans field.
