...
type UnibeeApiBeanDetailSubscriptionDetail struct {
	...
	// Previous subscription status before this subscription status transition
...
// SetPreviousStatus gets a reference to the given int32 and assigns it to the PreviousStatus field.
