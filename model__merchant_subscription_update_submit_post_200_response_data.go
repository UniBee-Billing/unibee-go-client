...
type MerchantSubscriptionUpdateSubmitPost200ResponseData struct {
	...
	// ID of the invoice generated by this update (proration or next-period invoice, depending on effectImmediate).
	InvoiceId *string `json:"invoiceId,omitempty"`
	// Hosted payment or invoice link. When paid=false and an invoice exists, redirect the customer to this link to complete payment.
	Link *string `json:"link,omitempty"`
	// Additional message describing the update result, used for internal or merchant-facing explanations.
	Note *string `json:"note,omitempty"`
	// Whether the update invoice has been successfully paid at the time of response.
	Paid *bool `json:"paid,omitempty"`
	// ID of the payment created for the update invoice, if any.
