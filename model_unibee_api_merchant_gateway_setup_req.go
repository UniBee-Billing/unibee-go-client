...
func (o *UnibeeApiMerchantGatewaySetupReq) GetMetadata() map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *UnibeeApiMerchantGatewaySetupReq) GetMetadataOk() (*map[string]interface{}, bool) {
	if o == nil || IsNil(o.Metadata) {
		return nil, false
	}
...
func (o *UnibeeApiMerchantGatewaySetupReq) SetMetadata(v map[string]interface{}) {
	o.Metadata = &v
}
