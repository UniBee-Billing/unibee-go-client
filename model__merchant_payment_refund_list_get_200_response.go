...
// checks if the MerchantPaymentRefundListGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantPaymentRefundListGet200Response{}

// MerchantPaymentRefundListGet200Response struct for MerchantPaymentRefundListGet200Response
type MerchantPaymentRefundListGet200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantPaymentRefundListGet200ResponseData `json:"data,omitempty"`
...
func NewMerchantPaymentRefundListGet200Response() *MerchantPaymentRefundListGet200Response {
	this := MerchantPaymentRefundListGet200Response{}
	return &this
}
...
func (o *MerchantPaymentRefundListGet200Response) GetData() MerchantPaymentRefundListGet200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantPaymentRefundListGet200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantPaymentRefundListGet200ResponseData and assigns it to the Data field.
...
func (o MerchantPaymentRefundListGet200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantPaymentRefundListGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantPaymentRefundListGet200Response struct {
	value *MerchantPaymentRefundListGet200Response
	isSet bool
}

func (v NullableMerchantPaymentRefundListGet200Response) Get() *MerchantPaymentRefundListGet200Response {
	return v.value
}

func (v *NullableMerchantPaymentRefundListGet200Response) Set(val *MerchantPaymentRefundListGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantPaymentRefundListGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantPaymentRefundListGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantPaymentRefundListGet200Response(val *MerchantPaymentRefundListGet200Response) *NullableMerchantPaymentRefundListGet200Response {
	return &NullableMerchantPaymentRefundListGet200Response{value: val, isSet: true}
}

func (v NullableMerchantPaymentRefundListGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantPaymentRefundListGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
