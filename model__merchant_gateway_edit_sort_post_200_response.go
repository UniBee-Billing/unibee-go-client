...
// checks if the MerchantGatewayEditSortPost200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantGatewayEditSortPost200Response{}

// MerchantGatewayEditSortPost200Response struct for MerchantGatewayEditSortPost200Response
type MerchantGatewayEditSortPost200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantGatewayEditSortPost200ResponseData `json:"data,omitempty"`
...
func NewMerchantGatewayEditSortPost200Response() *MerchantGatewayEditSortPost200Response {
	this := MerchantGatewayEditSortPost200Response{}
	return &this
}
...
func (o *MerchantGatewayEditSortPost200Response) GetData() MerchantGatewayEditSortPost200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantGatewayEditSortPost200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantGatewayEditSortPost200ResponseData and assigns it to the Data field.
...
func (o MerchantGatewayEditSortPost200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantGatewayEditSortPost200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantGatewayEditSortPost200Response struct {
	value *MerchantGatewayEditSortPost200Response
	isSet bool
}

func (v NullableMerchantGatewayEditSortPost200Response) Get() *MerchantGatewayEditSortPost200Response {
	return v.value
}

func (v *NullableMerchantGatewayEditSortPost200Response) Set(val *MerchantGatewayEditSortPost200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantGatewayEditSortPost200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantGatewayEditSortPost200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantGatewayEditSortPost200Response(val *MerchantGatewayEditSortPost200Response) *NullableMerchantGatewayEditSortPost200Response {
	return &NullableMerchantGatewayEditSortPost200Response{value: val, isSet: true}
}

func (v NullableMerchantGatewayEditSortPost200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantGatewayEditSortPost200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
