...
type MerchantGetGet200ResponseData struct {
	...
	GlobalUSVATConfig *UnibeeApiBeanUSVATConfig `json:"globalUSVATConfig,omitempty"`
...
// SetGlobalUSVATConfig gets a reference to the given UnibeeApiBeanUSVATConfig and assigns it to the GlobalUSVATConfig field.
