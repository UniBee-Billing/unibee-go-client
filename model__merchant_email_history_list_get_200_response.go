...
// checks if the MerchantEmailHistoryListGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantEmailHistoryListGet200Response{}

// MerchantEmailHistoryListGet200Response struct for MerchantEmailHistoryListGet200Response
type MerchantEmailHistoryListGet200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantEmailHistoryListGet200ResponseData `json:"data,omitempty"`
...
func NewMerchantEmailHistoryListGet200Response() *MerchantEmailHistoryListGet200Response {
	this := MerchantEmailHistoryListGet200Response{}
	return &this
}
...
func (o *MerchantEmailHistoryListGet200Response) GetData() MerchantEmailHistoryListGet200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantEmailHistoryListGet200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantEmailHistoryListGet200ResponseData and assigns it to the Data field.
...
func (o MerchantEmailHistoryListGet200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantEmailHistoryListGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantEmailHistoryListGet200Response struct {
	value *MerchantEmailHistoryListGet200Response
	isSet bool
}

func (v NullableMerchantEmailHistoryListGet200Response) Get() *MerchantEmailHistoryListGet200Response {
	return v.value
}

func (v *NullableMerchantEmailHistoryListGet200Response) Set(val *MerchantEmailHistoryListGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantEmailHistoryListGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantEmailHistoryListGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantEmailHistoryListGet200Response(val *MerchantEmailHistoryListGet200Response) *NullableMerchantEmailHistoryListGet200Response {
	return &NullableMerchantEmailHistoryListGet200Response{value: val, isSet: true}
}

func (v NullableMerchantEmailHistoryListGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantEmailHistoryListGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
