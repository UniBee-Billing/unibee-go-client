...
// checks if the UnibeeInternalQueryEmailTemplateVo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UnibeeInternalQueryEmailTemplateVo{}

// UnibeeInternalQueryEmailTemplateVo struct for UnibeeInternalQueryEmailTemplateVo
type UnibeeInternalQueryEmailTemplateVo struct {
	// create utc time
...
func NewUnibeeInternalQueryEmailTemplateVo() *UnibeeInternalQueryEmailTemplateVo {
	this := UnibeeInternalQueryEmailTemplateVo{}
	return &this
}
...
func (o UnibeeInternalQueryEmailTemplateVo) MarshalJSON() ([]byte, error) {
...
func (o UnibeeInternalQueryEmailTemplateVo) ToMap() (map[string]interface{}, error) {
...
type NullableUnibeeInternalQueryEmailTemplateVo struct {
	value *UnibeeInternalQueryEmailTemplateVo
	isSet bool
}

func (v NullableUnibeeInternalQueryEmailTemplateVo) Get() *UnibeeInternalQueryEmailTemplateVo {
	return v.value
}

func (v *NullableUnibeeInternalQueryEmailTemplateVo) Set(val *UnibeeInternalQueryEmailTemplateVo) {
	v.value = val
	v.isSet = true
}

func (v NullableUnibeeInternalQueryEmailTemplateVo) IsSet() bool {
	return v.isSet
}

func (v *NullableUnibeeInternalQueryEmailTemplateVo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUnibeeInternalQueryEmailTemplateVo(val *UnibeeInternalQueryEmailTemplateVo) *NullableUnibeeInternalQueryEmailTemplateVo {
	return &NullableUnibeeInternalQueryEmailTemplateVo{value: val, isSet: true}
}

func (v NullableUnibeeInternalQueryEmailTemplateVo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUnibeeInternalQueryEmailTemplateVo) UnmarshalJSON(src []byte) error {
	v.isSet = true
