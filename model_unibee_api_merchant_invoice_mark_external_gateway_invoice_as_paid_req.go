...
// UnibeeApiMerchantInvoiceMarkExternalGatewayInvoiceAsPaidReq Mark invoice as paid. Auth: OpenAPI + signature (HMAC-SHA256 of invoiceId|externalTransactionId|timestamp with gateway API Key, hex).
