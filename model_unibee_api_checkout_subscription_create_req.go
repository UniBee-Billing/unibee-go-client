...
// GetSplitPayment returns the SplitPayment field value if set, zero value otherwise.
func (o *UnibeeApiCheckoutSubscriptionCreateReq) GetSplitPayment() bool {
	if o == nil || IsNil(o.SplitPayment) {
		var ret bool
		return ret
	}
...
// SetSplitPayment gets a reference to the given bool and assigns it to the SplitPayment field.
...
func (o UnibeeApiCheckoutSubscriptionCreateReq) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.SplitPayment) {
		toSerialize["splitPayment"] = o.SplitPayment
	}
