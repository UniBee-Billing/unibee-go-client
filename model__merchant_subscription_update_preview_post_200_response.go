...
func (o *MerchantSubscriptionUpdatePreviewPost200Response) GetMerchantId() int64 {
...
// and a boolean to check if the value has been set.
func (o *MerchantSubscriptionUpdatePreviewPost200Response) GetMerchantIdOk() (*int64, bool) {
	if o == nil || IsNil(o.MerchantId) {
		return nil, false
	}
...
func (o *MerchantSubscriptionUpdatePreviewPost200Response) HasMerchantId() bool {
	if o != nil && !IsNil(o.MerchantId) {
		return true
	}
...
func (o *MerchantSubscriptionUpdatePreviewPost200Response) SetMerchantId(v int64) {
	o.MerchantId = &v
}
