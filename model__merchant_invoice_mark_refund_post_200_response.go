...
// checks if the MerchantInvoiceMarkRefundPost200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantInvoiceMarkRefundPost200Response{}

// MerchantInvoiceMarkRefundPost200Response struct for MerchantInvoiceMarkRefundPost200Response
type MerchantInvoiceMarkRefundPost200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantInvoiceMarkRefundPost200ResponseData `json:"data,omitempty"`
...
func NewMerchantInvoiceMarkRefundPost200Response() *MerchantInvoiceMarkRefundPost200Response {
	this := MerchantInvoiceMarkRefundPost200Response{}
	return &this
}
...
func (o *MerchantInvoiceMarkRefundPost200Response) GetData() MerchantInvoiceMarkRefundPost200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantInvoiceMarkRefundPost200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantInvoiceMarkRefundPost200ResponseData and assigns it to the Data field.
...
func (o MerchantInvoiceMarkRefundPost200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantInvoiceMarkRefundPost200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantInvoiceMarkRefundPost200Response struct {
	value *MerchantInvoiceMarkRefundPost200Response
	isSet bool
}

func (v NullableMerchantInvoiceMarkRefundPost200Response) Get() *MerchantInvoiceMarkRefundPost200Response {
	return v.value
}

func (v *NullableMerchantInvoiceMarkRefundPost200Response) Set(val *MerchantInvoiceMarkRefundPost200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantInvoiceMarkRefundPost200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantInvoiceMarkRefundPost200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantInvoiceMarkRefundPost200Response(val *MerchantInvoiceMarkRefundPost200Response) *NullableMerchantInvoiceMarkRefundPost200Response {
	return &NullableMerchantInvoiceMarkRefundPost200Response{value: val, isSet: true}
}

func (v NullableMerchantInvoiceMarkRefundPost200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantInvoiceMarkRefundPost200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
