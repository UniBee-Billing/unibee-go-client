...
// checks if the UnibeeApiBeanMerchantBatchExportTemplateSimplify type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UnibeeApiBeanMerchantBatchExportTemplateSimplify{}

// UnibeeApiBeanMerchantBatchExportTemplateSimplify struct for UnibeeApiBeanMerchantBatchExportTemplateSimplify
type UnibeeApiBeanMerchantBatchExportTemplateSimplify struct {
	// create utc time
...
func NewUnibeeApiBeanMerchantBatchExportTemplateSimplify() *UnibeeApiBeanMerchantBatchExportTemplateSimplify {
	this := UnibeeApiBeanMerchantBatchExportTemplateSimplify{}
	return &this
}
...
func (o UnibeeApiBeanMerchantBatchExportTemplateSimplify) MarshalJSON() ([]byte, error) {
...
func (o UnibeeApiBeanMerchantBatchExportTemplateSimplify) ToMap() (map[string]interface{}, error) {
...
type NullableUnibeeApiBeanMerchantBatchExportTemplateSimplify struct {
	value *UnibeeApiBeanMerchantBatchExportTemplateSimplify
	isSet bool
}

func (v NullableUnibeeApiBeanMerchantBatchExportTemplateSimplify) Get() *UnibeeApiBeanMerchantBatchExportTemplateSimplify {
	return v.value
}

func (v *NullableUnibeeApiBeanMerchantBatchExportTemplateSimplify) Set(val *UnibeeApiBeanMerchantBatchExportTemplateSimplify) {
	v.value = val
	v.isSet = true
}

func (v NullableUnibeeApiBeanMerchantBatchExportTemplateSimplify) IsSet() bool {
	return v.isSet
}

func (v *NullableUnibeeApiBeanMerchantBatchExportTemplateSimplify) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUnibeeApiBeanMerchantBatchExportTemplateSimplify(val *UnibeeApiBeanMerchantBatchExportTemplateSimplify) *NullableUnibeeApiBeanMerchantBatchExportTemplateSimplify {
	return &NullableUnibeeApiBeanMerchantBatchExportTemplateSimplify{value: val, isSet: true}
}

func (v NullableUnibeeApiBeanMerchantBatchExportTemplateSimplify) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUnibeeApiBeanMerchantBatchExportTemplateSimplify) UnmarshalJSON(src []byte) error {
	v.isSet = true
