...
type UnibeeApiBeanMerchantMetric struct {
	...
	// Enable carryover proration for this metric (false when not set)
	...
	// Enable proration refund for this metric, i.e. reclaim metric limit on upgrade (false when not set)
...
func (o *UnibeeApiBeanMerchantMetric) GetMetaData() map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *UnibeeApiBeanMerchantMetric) GetMetaDataOk() (*map[string]interface{}, bool) {
	if o == nil || IsNil(o.MetaData) {
		return nil, false
	}
...
func (o *UnibeeApiBeanMerchantMetric) SetMetaData(v map[string]interface{}) {
	o.MetaData = &v
}
