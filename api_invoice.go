...
func (r InvoiceInvoiceRefundPostRequest) Execute() (*MerchantInvoiceRefundPost200Response, *http.Response, error) {
	return r.ApiService.InvoiceRefundPostExecute(r)
}

/*
InvoiceRefundPost Admin Create Refund From Invoice
...
func (a *InvoiceService) InvoiceRefundPostExecute(r InvoiceInvoiceRefundPostRequest) (*MerchantInvoiceRefundPost200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
