...
type UnibeeApiMerchantSubscriptionCreatePreviewReq struct {
	...
	FreeTimeEnd *int32 `json:"freeTimeEnd,omitempty"`
...
// GetFreeTimeEnd returns the FreeTimeEnd field value if set, zero value otherwise.
func (o *UnibeeApiMerchantSubscriptionCreatePreviewReq) GetFreeTimeEnd() int32 {
	if o == nil || IsNil(o.FreeTimeEnd) {
		var ret int32
		return ret
	}
	return *o.FreeTimeEnd
}

// GetFreeTimeEndOk returns a tuple with the FreeTimeEnd field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UnibeeApiMerchantSubscriptionCreatePreviewReq) GetFreeTimeEndOk() (*int32, bool) {
	if o == nil || IsNil(o.FreeTimeEnd) {
		return nil, false
	}
	return o.FreeTimeEnd, true
}
...
// SetFreeTimeEnd gets a reference to the given int32 and assigns it to the FreeTimeEnd field.
...
func (o UnibeeApiMerchantSubscriptionCreatePreviewReq) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.FreeTimeEnd) {
		toSerialize["freeTimeEnd"] = o.FreeTimeEnd
	}
