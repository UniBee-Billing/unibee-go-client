...
type UnibeeApiBeanDetailUserMetric struct {
	...
	// OnetimeAddons
	OnetimeAddons []UnibeeApiBeanDetailUserOnetimeAddonDetail `json:"onetimeAddons,omitempty"`
...
func (o *UnibeeApiBeanDetailUserMetric) GetOnetimeAddons() []UnibeeApiBeanDetailUserOnetimeAddonDetail {
	if o == nil || IsNil(o.OnetimeAddons) {
		var ret []UnibeeApiBeanDetailUserOnetimeAddonDetail
		return ret
	}
...
// SetOnetimeAddons gets a reference to the given []UnibeeApiBeanDetailUserOnetimeAddonDetail and assigns it to the OnetimeAddons field.
