...
// checks if the MerchantSubscriptionPreviewSubscriptionNextInvoiceGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantSubscriptionPreviewSubscriptionNextInvoiceGet200Response{}

// MerchantSubscriptionPreviewSubscriptionNextInvoiceGet200Response struct for MerchantSubscriptionPreviewSubscriptionNextInvoiceGet200Response
type MerchantSubscriptionPreviewSubscriptionNextInvoiceGet200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantSubscriptionPreviewSubscriptionNextInvoiceGet200ResponseData `json:"data,omitempty"`
...
func NewMerchantSubscriptionPreviewSubscriptionNextInvoiceGet200Response() *MerchantSubscriptionPreviewSubscriptionNextInvoiceGet200Response {
	this := MerchantSubscriptionPreviewSubscriptionNextInvoiceGet200Response{}
	return &this
}
...
func (o *MerchantSubscriptionPreviewSubscriptionNextInvoiceGet200Response) GetData() MerchantSubscriptionPreviewSubscriptionNextInvoiceGet200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantSubscriptionPreviewSubscriptionNextInvoiceGet200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantSubscriptionPreviewSubscriptionNextInvoiceGet200ResponseData and assigns it to the Data field.
...
func (o MerchantSubscriptionPreviewSubscriptionNextInvoiceGet200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantSubscriptionPreviewSubscriptionNextInvoiceGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantSubscriptionPreviewSubscriptionNextInvoiceGet200Response struct {
	value *MerchantSubscriptionPreviewSubscriptionNextInvoiceGet200Response
	isSet bool
}

func (v NullableMerchantSubscriptionPreviewSubscriptionNextInvoiceGet200Response) Get() *MerchantSubscriptionPreviewSubscriptionNextInvoiceGet200Response {
	return v.value
}

func (v *NullableMerchantSubscriptionPreviewSubscriptionNextInvoiceGet200Response) Set(val *MerchantSubscriptionPreviewSubscriptionNextInvoiceGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantSubscriptionPreviewSubscriptionNextInvoiceGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantSubscriptionPreviewSubscriptionNextInvoiceGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantSubscriptionPreviewSubscriptionNextInvoiceGet200Response(val *MerchantSubscriptionPreviewSubscriptionNextInvoiceGet200Response) *NullableMerchantSubscriptionPreviewSubscriptionNextInvoiceGet200Response {
	return &NullableMerchantSubscriptionPreviewSubscriptionNextInvoiceGet200Response{value: val, isSet: true}
}

func (v NullableMerchantSubscriptionPreviewSubscriptionNextInvoiceGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantSubscriptionPreviewSubscriptionNextInvoiceGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
