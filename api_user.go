...
type UserUserDeletePostRequest struct {
	ctx context.Context
	ApiService *UserService
	unibeeApiMerchantUserDeleteReq *UnibeeApiMerchantUserDeleteReq
}

func (r UserUserDeletePostRequest) UnibeeApiMerchantUserDeleteReq(unibeeApiMerchantUserDeleteReq UnibeeApiMerchantUserDeleteReq) UserUserDeletePostRequest {
	r.unibeeApiMerchantUserDeleteReq = &unibeeApiMerchantUserDeleteReq
	return r
}

func (r UserUserDeletePostRequest) Execute() (*MerchantAuthSsoClearTotpPost200Response, *http.Response, error) {
	return r.ApiService.UserDeletePostExecute(r)
}

/*
UserDeletePost Delete User

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return UserUserDeletePostRequest
*/
func (a *UserService) UserDeletePost(ctx context.Context) UserUserDeletePostRequest {
	return UserUserDeletePostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return MerchantAuthSsoClearTotpPost200Response
func (a *UserService) UserDeletePostExecute(r UserUserDeletePostRequest) (*MerchantAuthSsoClearTotpPost200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UserService.UserDeletePost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/merchant/user/delete"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.unibeeApiMerchantUserDeleteReq == nil {
		return localVarReturnValue, nil, reportError("unibeeApiMerchantUserDeleteReq is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.unibeeApiMerchantUserDeleteReq
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
type UserUserUpdateExternalUserIdPostRequest struct {
	ctx context.Context
	ApiService *UserService
	unibeeApiMerchantUserUpdateExternalUserIdReq *UnibeeApiMerchantUserUpdateExternalUserIdReq
}

func (r UserUserUpdateExternalUserIdPostRequest) UnibeeApiMerchantUserUpdateExternalUserIdReq(unibeeApiMerchantUserUpdateExternalUserIdReq UnibeeApiMerchantUserUpdateExternalUserIdReq) UserUserUpdateExternalUserIdPostRequest {
	r.unibeeApiMerchantUserUpdateExternalUserIdReq = &unibeeApiMerchantUserUpdateExternalUserIdReq
	return r
}

func (r UserUserUpdateExternalUserIdPostRequest) Execute() (*MerchantUserGetGet200Response, *http.Response, error) {
	return r.ApiService.UserUpdateExternalUserIdPostExecute(r)
}

/*
UserUpdateExternalUserIdPost Update User ExternalUserId

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return UserUserUpdateExternalUserIdPostRequest
*/
func (a *UserService) UserUpdateExternalUserIdPost(ctx context.Context) UserUserUpdateExternalUserIdPostRequest {
	return UserUserUpdateExternalUserIdPostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return MerchantUserGetGet200Response
func (a *UserService) UserUpdateExternalUserIdPostExecute(r UserUserUpdateExternalUserIdPostRequest) (*MerchantUserGetGet200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UserService.UserUpdateExternalUserIdPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/merchant/user/update_external_user_id"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.unibeeApiMerchantUserUpdateExternalUserIdReq == nil {
		return localVarReturnValue, nil, reportError("unibeeApiMerchantUserUpdateExternalUserIdReq is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.unibeeApiMerchantUserUpdateExternalUserIdReq
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
