...
func (r GatewayGatewayEditPostRequest) Execute() (*MerchantAuthSsoLoginOTPPost200Response, *http.Response, error) {
	return r.ApiService.GatewayEditPostExecute(r)
}

/*
GatewayEditPost Gateway Webhook Edit
...
// Execute executes the request
//  @return MerchantAuthSsoLoginOTPPost200Response
func (a *GatewayService) GatewayEditPostExecute(r GatewayGatewayEditPostRequest) (*MerchantAuthSsoLoginOTPPost200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r GatewayGatewaySetupPostRequest) Execute() (*MerchantAuthSsoLoginOTPPost200Response, *http.Response, error) {
	return r.ApiService.GatewaySetupPostExecute(r)
}

/*
GatewaySetupPost Gateway Setup
...
// Execute executes the request
//  @return MerchantAuthSsoLoginOTPPost200Response
func (a *GatewayService) GatewaySetupPostExecute(r GatewayGatewaySetupPostRequest) (*MerchantAuthSsoLoginOTPPost200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
/*
GatewaySetupWebhookPost Gateway Webhook Setup
