...
type MerchantGetExchangeRatePostRequest struct {
	ctx context.Context
	ApiService *MerchantService
	unibeeApiMerchantProfileGetExchangeRateReq *UnibeeApiMerchantProfileGetExchangeRateReq
}

func (r MerchantGetExchangeRatePostRequest) UnibeeApiMerchantProfileGetExchangeRateReq(unibeeApiMerchantProfileGetExchangeRateReq UnibeeApiMerchantProfileGetExchangeRateReq) MerchantGetExchangeRatePostRequest {
	r.unibeeApiMerchantProfileGetExchangeRateReq = &unibeeApiMerchantProfileGetExchangeRateReq
	return r
}

func (r MerchantGetExchangeRatePostRequest) Execute() (*MerchantGetExchangeRatePost200Response, *http.Response, error) {
	return r.ApiService.GetExchangeRatePostExecute(r)
}

/*
GetExchangeRatePost Get Exchange Rate

Get raw exchange rate from the upstream provider, with shared Redis cache and cloud fallback. Ignores merchant's multi-currency fixed-rate settings.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return MerchantGetExchangeRatePostRequest
*/
func (a *MerchantService) GetExchangeRatePost(ctx context.Context) MerchantGetExchangeRatePostRequest {
	return MerchantGetExchangeRatePostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return MerchantGetExchangeRatePost200Response
func (a *MerchantService) GetExchangeRatePostExecute(r MerchantGetExchangeRatePostRequest) (*MerchantGetExchangeRatePost200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *MerchantGetExchangeRatePost200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MerchantService.GetExchangeRatePost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/merchant/get_exchange_rate"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.unibeeApiMerchantProfileGetExchangeRateReq == nil {
		return localVarReturnValue, nil, reportError("unibeeApiMerchantProfileGetExchangeRateReq is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.unibeeApiMerchantProfileGetExchangeRateReq
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
type MerchantOverviewStatisticsGetRequest struct {
	ctx context.Context
	ApiService *MerchantService
}

func (r MerchantOverviewStatisticsGetRequest) Execute() (*MerchantOverviewStatisticsGet200Response, *http.Response, error) {
	return r.ApiService.OverviewStatisticsGetExecute(r)
}

/*
OverviewStatisticsGet Get Merchant Overview Statistics

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return MerchantOverviewStatisticsGetRequest
*/
func (a *MerchantService) OverviewStatisticsGet(ctx context.Context) MerchantOverviewStatisticsGetRequest {
	return MerchantOverviewStatisticsGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *MerchantService) OverviewStatisticsGetExecute(r MerchantOverviewStatisticsGetRequest) (*MerchantOverviewStatisticsGet200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *MerchantOverviewStatisticsGet200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MerchantService.OverviewStatisticsGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/merchant/overview_statistics"
