...
type MetricMetricEventDeletePostRequest struct {
	ctx context.Context
	ApiService *MetricService
	unibeeApiMerchantMetricDeleteEventReq *UnibeeApiMerchantMetricDeleteEventReq
}

func (r MetricMetricEventDeletePostRequest) UnibeeApiMerchantMetricDeleteEventReq(unibeeApiMerchantMetricDeleteEventReq UnibeeApiMerchantMetricDeleteEventReq) MetricMetricEventDeletePostRequest {
	r.unibeeApiMerchantMetricDeleteEventReq = &unibeeApiMerchantMetricDeleteEventReq
	return r
}

func (r MetricMetricEventDeletePostRequest) Execute() (*MerchantAuthSsoLoginOTPPost200Response, *http.Response, error) {
...
MetricEventDeletePost Del Merchant Metric Event
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return MetricMetricEventDeletePostRequest
*/
func (a *MetricService) MetricEventDeletePost(ctx context.Context) MetricMetricEventDeletePostRequest {
	return MetricMetricEventDeletePostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *MetricService) MetricEventDeletePostExecute(r MetricMetricEventDeletePostRequest) (*MerchantAuthSsoLoginOTPPost200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MetricService.MetricEventDeletePost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type MetricMetricEventNewPostRequest struct {
	ctx context.Context
	ApiService *MetricService
	unibeeApiMerchantMetricNewEventReq *UnibeeApiMerchantMetricNewEventReq
}

func (r MetricMetricEventNewPostRequest) UnibeeApiMerchantMetricNewEventReq(unibeeApiMerchantMetricNewEventReq UnibeeApiMerchantMetricNewEventReq) MetricMetricEventNewPostRequest {
	r.unibeeApiMerchantMetricNewEventReq = &unibeeApiMerchantMetricNewEventReq
	return r
}

func (r MetricMetricEventNewPostRequest) Execute() (*MerchantMetricEventNewPost200Response, *http.Response, error) {
	return r.ApiService.MetricEventNewPostExecute(r)
}

/*
MetricEventNewPost Merchant Metric Event

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return MetricMetricEventNewPostRequest
*/
func (a *MetricService) MetricEventNewPost(ctx context.Context) MetricMetricEventNewPostRequest {
	return MetricMetricEventNewPostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *MetricService) MetricEventNewPostExecute(r MetricMetricEventNewPostRequest) (*MerchantMetricEventNewPost200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MetricService.MetricEventNewPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
/*
MetricListGet Merchant Metric list
