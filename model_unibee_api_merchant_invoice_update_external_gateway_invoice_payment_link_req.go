...
// UnibeeApiMerchantInvoiceUpdateExternalGatewayInvoicePaymentLinkReq Deprecated. Please use payment-level external gateway APIs: /merchant/payment/external_gateway_payment/update_link. This invoice-level API is kept for compatibility only.
