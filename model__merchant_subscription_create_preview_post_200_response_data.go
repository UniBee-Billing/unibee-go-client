...
type MerchantSubscriptionCreatePreviewPost200ResponseData struct {
	// Addon parameters used to compute the preview.
	AddonParams []UnibeeApiBeanPlanAddonParam `json:"addonParams,omitempty"`
	// Resolved addon plan details included in this preview.
	Addons []UnibeeApiBeanPlanAddonDetail `json:"addons,omitempty"`
	// Whether promo credit is effectively applied in this preview.
	ApplyPromoCredit *bool `json:"applyPromoCredit,omitempty"`
	// Currency used for this preview.
	Currency *string `json:"currency,omitempty"`
	Discount *UnibeeApiBeanMerchantDiscountCode `json:"discount,omitempty"`
	// Total discount amount applied in this preview, including promo credit if applicable.
	DiscountAmount *int64 `json:"discountAmount,omitempty"`
	// Human-readable message describing discount application result.
	DiscountMessage *string `json:"discountMessage,omitempty"`
	// Resolved user email used in this preview.
	Email *string `json:"email,omitempty"`
	Gateway *UnibeeApiBeanDetailGateway `json:"gateway,omitempty"`
	Invoice *UnibeeApiBeanInvoice `json:"invoice,omitempty"`
	// Original invoice amount before discounts and promo credit, in minor units.
	...
	// Quantity of the plan used in preview.
	Quantity *int64 `json:"quantity,omitempty"`
	// Discount code persisted for later billing cycles (e.g. after trial), when applicable.
	RecurringDiscountCode *string `json:"recurringDiscountCode,omitempty"`
	// Total subscription amount excluding tax for the previewed invoice, in minor units.
	SubscriptionAmountExcludingTax *int64 `json:"subscriptionAmountExcludingTax,omitempty"`
	// Total tax amount for the previewed invoice, in minor units.
	TaxAmount *int64 `json:"taxAmount,omitempty"`
	// Effective tax percentage applied in this preview, in basis points (e.g. 1000 = 10%%).
	TaxPercentage *int64 `json:"taxPercentage,omitempty"`
	// Final payable amount for the previewed invoice, including tax and after discounts, in minor units.
	TotalAmount *int64 `json:"totalAmount,omitempty"`
	// trial_end, utc time
	TrialEnd *int64 `json:"trialEnd,omitempty"`
	// Resolved user ID used in this preview.
	UserId *int64 `json:"userId,omitempty"`
	// Country code used for VAT calculation.
	VatCountryCode *string `json:"vatCountryCode,omitempty"`
	// Country name used for VAT calculation, when available.
	VatCountryName *string `json:"vatCountryName,omitempty"`
	// VAT number used in this preview, if any.
	VatNumber *string `json:"vatNumber,omitempty"`
	VatNumberValidate *UnibeeApiBeanValidResult `json:"vatNumberValidate,omitempty"`
	// Human-readable message for VAT number validation result.
...
// GetRecurringDiscountCode returns the RecurringDiscountCode field value if set, zero value otherwise.
func (o *MerchantSubscriptionCreatePreviewPost200ResponseData) GetRecurringDiscountCode() string {
	if o == nil || IsNil(o.RecurringDiscountCode) {
		var ret string
		return ret
	}
	return *o.RecurringDiscountCode
}

// GetRecurringDiscountCodeOk returns a tuple with the RecurringDiscountCode field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MerchantSubscriptionCreatePreviewPost200ResponseData) GetRecurringDiscountCodeOk() (*string, bool) {
	if o == nil || IsNil(o.RecurringDiscountCode) {
		return nil, false
	}
	return o.RecurringDiscountCode, true
}
...
// SetRecurringDiscountCode gets a reference to the given string and assigns it to the RecurringDiscountCode field.
func (o *MerchantSubscriptionCreatePreviewPost200ResponseData) SetRecurringDiscountCode(v string) {
	o.RecurringDiscountCode = &v
}
...
func (o MerchantSubscriptionCreatePreviewPost200ResponseData) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.RecurringDiscountCode) {
		toSerialize["recurringDiscountCode"] = o.RecurringDiscountCode
	}
