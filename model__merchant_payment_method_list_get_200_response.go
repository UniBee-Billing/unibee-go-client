...
// checks if the MerchantPaymentMethodListGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantPaymentMethodListGet200Response{}

// MerchantPaymentMethodListGet200Response struct for MerchantPaymentMethodListGet200Response
type MerchantPaymentMethodListGet200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantPaymentMethodListGet200ResponseData `json:"data,omitempty"`
...
func NewMerchantPaymentMethodListGet200Response() *MerchantPaymentMethodListGet200Response {
	this := MerchantPaymentMethodListGet200Response{}
	return &this
}
...
func (o *MerchantPaymentMethodListGet200Response) GetData() MerchantPaymentMethodListGet200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantPaymentMethodListGet200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantPaymentMethodListGet200ResponseData and assigns it to the Data field.
...
func (o MerchantPaymentMethodListGet200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantPaymentMethodListGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantPaymentMethodListGet200Response struct {
	value *MerchantPaymentMethodListGet200Response
	isSet bool
}

func (v NullableMerchantPaymentMethodListGet200Response) Get() *MerchantPaymentMethodListGet200Response {
	return v.value
}

func (v *NullableMerchantPaymentMethodListGet200Response) Set(val *MerchantPaymentMethodListGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantPaymentMethodListGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantPaymentMethodListGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantPaymentMethodListGet200Response(val *MerchantPaymentMethodListGet200Response) *NullableMerchantPaymentMethodListGet200Response {
	return &NullableMerchantPaymentMethodListGet200Response{value: val, isSet: true}
}

func (v NullableMerchantPaymentMethodListGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantPaymentMethodListGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
