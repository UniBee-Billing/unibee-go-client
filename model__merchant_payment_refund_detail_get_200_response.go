...
// checks if the MerchantPaymentRefundDetailGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantPaymentRefundDetailGet200Response{}

// MerchantPaymentRefundDetailGet200Response struct for MerchantPaymentRefundDetailGet200Response
type MerchantPaymentRefundDetailGet200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantPaymentRefundDetailGet200ResponseData `json:"data,omitempty"`
...
func NewMerchantPaymentRefundDetailGet200Response() *MerchantPaymentRefundDetailGet200Response {
	this := MerchantPaymentRefundDetailGet200Response{}
	return &this
}
...
func (o *MerchantPaymentRefundDetailGet200Response) GetData() MerchantPaymentRefundDetailGet200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantPaymentRefundDetailGet200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantPaymentRefundDetailGet200ResponseData and assigns it to the Data field.
...
func (o MerchantPaymentRefundDetailGet200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantPaymentRefundDetailGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantPaymentRefundDetailGet200Response struct {
	value *MerchantPaymentRefundDetailGet200Response
	isSet bool
}

func (v NullableMerchantPaymentRefundDetailGet200Response) Get() *MerchantPaymentRefundDetailGet200Response {
	return v.value
}

func (v *NullableMerchantPaymentRefundDetailGet200Response) Set(val *MerchantPaymentRefundDetailGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantPaymentRefundDetailGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantPaymentRefundDetailGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantPaymentRefundDetailGet200Response(val *MerchantPaymentRefundDetailGet200Response) *NullableMerchantPaymentRefundDetailGet200Response {
	return &NullableMerchantPaymentRefundDetailGet200Response{value: val, isSet: true}
}

func (v NullableMerchantPaymentRefundDetailGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantPaymentRefundDetailGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
