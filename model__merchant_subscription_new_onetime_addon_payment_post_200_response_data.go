...
type MerchantSubscriptionNewOnetimeAddonPaymentPost200ResponseData struct {
	...
	SubscriptionOnetimeAddon *UnibeeApiBeanSubscriptionOnetimeAddonSimplify `json:"subscriptionOnetimeAddon,omitempty"`
}
...
func (o *MerchantSubscriptionNewOnetimeAddonPaymentPost200ResponseData) GetSubscriptionOnetimeAddon() UnibeeApiBeanSubscriptionOnetimeAddonSimplify {
	if o == nil || IsNil(o.SubscriptionOnetimeAddon) {
		var ret UnibeeApiBeanSubscriptionOnetimeAddonSimplify
		return ret
	}
...
// SetSubscriptionOnetimeAddon gets a reference to the given UnibeeApiBeanSubscriptionOnetimeAddonSimplify and assigns it to the SubscriptionOnetimeAddon field.
