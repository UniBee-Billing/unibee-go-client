...
// checks if the MerchantProductCopyPost200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantProductCopyPost200Response{}

// MerchantProductCopyPost200Response struct for MerchantProductCopyPost200Response
type MerchantProductCopyPost200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantProductCopyPost200ResponseData `json:"data,omitempty"`
...
func NewMerchantProductCopyPost200Response() *MerchantProductCopyPost200Response {
	this := MerchantProductCopyPost200Response{}
	return &this
}
...
func (o *MerchantProductCopyPost200Response) GetData() MerchantProductCopyPost200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantProductCopyPost200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantProductCopyPost200ResponseData and assigns it to the Data field.
func (o *MerchantProductCopyPost200Response) SetData(v MerchantProductCopyPost200ResponseData) {
	o.Data = &v
}

// GetMerchantId returns the MerchantId field value if set, zero value otherwise.
func (o *MerchantProductCopyPost200Response) GetMerchantId() int64 {
...
// and a boolean to check if the value has been set.
func (o *MerchantProductCopyPost200Response) GetMerchantIdOk() (*int64, bool) {
	if o == nil || IsNil(o.MerchantId) {
		return nil, false
	}
...
func (o *MerchantProductCopyPost200Response) HasMerchantId() bool {
	if o != nil && !IsNil(o.MerchantId) {
		return true
	}
...
func (o *MerchantProductCopyPost200Response) SetMerchantId(v int64) {
	o.MerchantId = &v
}
...
func (o MerchantProductCopyPost200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantProductCopyPost200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantProductCopyPost200Response struct {
	value *MerchantProductCopyPost200Response
	isSet bool
}

func (v NullableMerchantProductCopyPost200Response) Get() *MerchantProductCopyPost200Response {
	return v.value
}

func (v *NullableMerchantProductCopyPost200Response) Set(val *MerchantProductCopyPost200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantProductCopyPost200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantProductCopyPost200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantProductCopyPost200Response(val *MerchantProductCopyPost200Response) *NullableMerchantProductCopyPost200Response {
	return &NullableMerchantProductCopyPost200Response{value: val, isSet: true}
}

func (v NullableMerchantProductCopyPost200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantProductCopyPost200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
