...
type UnibeeApiBeanSubscriptionConfig struct {
	...
	DowngradeNonImmediatelyEffectBeforePeriodEnd *int64 `json:"downgradeNonImmediatelyEffectBeforePeriodEnd,omitempty"`
	FiatExchangeApiKey *string `json:"fiatExchangeApiKey,omitempty"`
...
// SetDowngradeNonImmediatelyEffectBeforePeriodEnd gets a reference to the given int64 and assigns it to the DowngradeNonImmediatelyEffectBeforePeriodEnd field.
...
// GetFiatExchangeApiKey returns the FiatExchangeApiKey field value if set, zero value otherwise.
func (o *UnibeeApiBeanSubscriptionConfig) GetFiatExchangeApiKey() string {
	if o == nil || IsNil(o.FiatExchangeApiKey) {
		var ret string
		return ret
	}
	return *o.FiatExchangeApiKey
}

// GetFiatExchangeApiKeyOk returns a tuple with the FiatExchangeApiKey field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UnibeeApiBeanSubscriptionConfig) GetFiatExchangeApiKeyOk() (*string, bool) {
	if o == nil || IsNil(o.FiatExchangeApiKey) {
		return nil, false
	}
	return o.FiatExchangeApiKey, true
}
...
// SetFiatExchangeApiKey gets a reference to the given string and assigns it to the FiatExchangeApiKey field.
func (o *UnibeeApiBeanSubscriptionConfig) SetFiatExchangeApiKey(v string) {
	o.FiatExchangeApiKey = &v
}
...
func (o UnibeeApiBeanSubscriptionConfig) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.FiatExchangeApiKey) {
		toSerialize["fiatExchangeApiKey"] = o.FiatExchangeApiKey
	}
