...
func (o *UnibeeApiMerchantGatewayEditReq) GetMetadata() map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *UnibeeApiMerchantGatewayEditReq) GetMetadataOk() (*map[string]interface{}, bool) {
	if o == nil || IsNil(o.Metadata) {
		return nil, false
	}
...
func (o *UnibeeApiMerchantGatewayEditReq) SetMetadata(v map[string]interface{}) {
	o.Metadata = &v
}
