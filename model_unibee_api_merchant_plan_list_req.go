...
// GetBillingIntervalMin returns the BillingIntervalMin field value if set, zero value otherwise.
func (o *UnibeeApiMerchantPlanListReq) GetBillingIntervalMin() string {
	if o == nil || IsNil(o.BillingIntervalMin) {
		var ret string
		return ret
	}
	return *o.BillingIntervalMin
}

// GetBillingIntervalMinOk returns a tuple with the BillingIntervalMin field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UnibeeApiMerchantPlanListReq) GetBillingIntervalMinOk() (*string, bool) {
	if o == nil || IsNil(o.BillingIntervalMin) {
		return nil, false
	}
	return o.BillingIntervalMin, true
}
...
// SetBillingIntervalMin gets a reference to the given string and assigns it to the BillingIntervalMin field.
func (o *UnibeeApiMerchantPlanListReq) SetBillingIntervalMin(v string) {
	o.BillingIntervalMin = &v
}
...
// GetIntervalCounts returns the IntervalCounts field value if set, zero value otherwise.
func (o *UnibeeApiMerchantPlanListReq) GetIntervalCounts() []int32 {
	if o == nil || IsNil(o.IntervalCounts) {
		var ret []int32
		return ret
	}
	return o.IntervalCounts
}

// GetIntervalCountsOk returns a tuple with the IntervalCounts field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UnibeeApiMerchantPlanListReq) GetIntervalCountsOk() ([]int32, bool) {
	if o == nil || IsNil(o.IntervalCounts) {
		return nil, false
	}
	return o.IntervalCounts, true
}
...
// SetIntervalCounts gets a reference to the given []int32 and assigns it to the IntervalCounts field.
func (o *UnibeeApiMerchantPlanListReq) SetIntervalCounts(v []int32) {
	o.IntervalCounts = v
}

// GetIntervalUnits returns the IntervalUnits field value if set, zero value otherwise.
func (o *UnibeeApiMerchantPlanListReq) GetIntervalUnits() []string {
	if o == nil || IsNil(o.IntervalUnits) {
		var ret []string
		return ret
	}
	return o.IntervalUnits
}

// GetIntervalUnitsOk returns a tuple with the IntervalUnits field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UnibeeApiMerchantPlanListReq) GetIntervalUnitsOk() ([]string, bool) {
	if o == nil || IsNil(o.IntervalUnits) {
		return nil, false
	}
	return o.IntervalUnits, true
}
...
// SetIntervalUnits gets a reference to the given []string and assigns it to the IntervalUnits field.
...
func (o UnibeeApiMerchantPlanListReq) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.BillingIntervalMin) {
		toSerialize["billingIntervalMin"] = o.BillingIntervalMin
	}
	if !IsNil(o.Count) {
	...
	if !IsNil(o.IntervalCounts) {
		toSerialize["intervalCounts"] = o.IntervalCounts
	}
	if !IsNil(o.IntervalUnits) {
		toSerialize["intervalUnits"] = o.IntervalUnits
	}
	if !IsNil(o.Page) {
