...
type UnibeeApiMerchantPlanListReq struct {
	...
	Tqype []int32 `json:"tqype,omitempty"`
}
...
// GetTqype returns the Tqype field value if set, zero value otherwise.
func (o *UnibeeApiMerchantPlanListReq) GetTqype() []int32 {
	if o == nil || IsNil(o.Tqype) {
		var ret []int32
		return ret
	}
	return o.Tqype
...
// GetTqypeOk returns a tuple with the Tqype field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetTqype gets a reference to the given []int32 and assigns it to the Tqype field.
