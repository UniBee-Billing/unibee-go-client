...
// checks if the MerchantCreditCreditTransactionListGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantCreditCreditTransactionListGet200Response{}

// MerchantCreditCreditTransactionListGet200Response struct for MerchantCreditCreditTransactionListGet200Response
type MerchantCreditCreditTransactionListGet200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantCreditCreditTransactionListGet200ResponseData `json:"data,omitempty"`
...
func NewMerchantCreditCreditTransactionListGet200Response() *MerchantCreditCreditTransactionListGet200Response {
	this := MerchantCreditCreditTransactionListGet200Response{}
	return &this
}
...
func (o *MerchantCreditCreditTransactionListGet200Response) GetData() MerchantCreditCreditTransactionListGet200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantCreditCreditTransactionListGet200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantCreditCreditTransactionListGet200ResponseData and assigns it to the Data field.
...
func (o *MerchantCreditCreditTransactionListGet200Response) GetMerchantId() int64 {
...
// and a boolean to check if the value has been set.
func (o *MerchantCreditCreditTransactionListGet200Response) GetMerchantIdOk() (*int64, bool) {
	if o == nil || IsNil(o.MerchantId) {
		return nil, false
	}
...
func (o *MerchantCreditCreditTransactionListGet200Response) HasMerchantId() bool {
	if o != nil && !IsNil(o.MerchantId) {
		return true
	}
...
func (o *MerchantCreditCreditTransactionListGet200Response) SetMerchantId(v int64) {
	o.MerchantId = &v
}
...
func (o MerchantCreditCreditTransactionListGet200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantCreditCreditTransactionListGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantCreditCreditTransactionListGet200Response struct {
	value *MerchantCreditCreditTransactionListGet200Response
	isSet bool
}

func (v NullableMerchantCreditCreditTransactionListGet200Response) Get() *MerchantCreditCreditTransactionListGet200Response {
	return v.value
}

func (v *NullableMerchantCreditCreditTransactionListGet200Response) Set(val *MerchantCreditCreditTransactionListGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantCreditCreditTransactionListGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantCreditCreditTransactionListGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantCreditCreditTransactionListGet200Response(val *MerchantCreditCreditTransactionListGet200Response) *NullableMerchantCreditCreditTransactionListGet200Response {
	return &NullableMerchantCreditCreditTransactionListGet200Response{value: val, isSet: true}
}

func (v NullableMerchantCreditCreditTransactionListGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantCreditCreditTransactionListGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
