...
func (r ProductProductActivatePostRequest) Execute() (*MerchantAuthSsoClearTotpPost200Response, *http.Response, error) {
	return r.ApiService.ProductActivatePostExecute(r)
}

/*
ProductActivatePost Activate Product
...
func (a *ProductService) ProductActivatePostExecute(r ProductProductActivatePostRequest) (*MerchantAuthSsoClearTotpPost200Response, *http.Response, error) {
	var (
...
func (r ProductProductDeletePostRequest) Execute() (*MerchantAuthSsoClearTotpPost200Response, *http.Response, error) {
	return r.ApiService.ProductDeletePostExecute(r)
}

/*
ProductDeletePost Delete Product
...
// Execute executes the request
//  @return MerchantAuthSsoClearTotpPost200Response
func (a *ProductService) ProductDeletePostExecute(r ProductProductDeletePostRequest) (*MerchantAuthSsoClearTotpPost200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
/*
ProductDetailGet Product Detail
...
/*
ProductDetailPost Product Detail
...
func (r ProductProductInactivatePostRequest) Execute() (*MerchantAuthSsoClearTotpPost200Response, *http.Response, error) {
	return r.ApiService.ProductInactivatePostExecute(r)
}

/*
ProductInactivatePost Inactivate Product
...
// Execute executes the request
//  @return MerchantAuthSsoClearTotpPost200Response
func (a *ProductService) ProductInactivatePostExecute(r ProductProductInactivatePostRequest) (*MerchantAuthSsoClearTotpPost200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
/*
ProductListGet Get Product List
...
/*
ProductListPost Get Product List
