...
// checks if the MerchantOssFilePost200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantOssFilePost200Response{}

// MerchantOssFilePost200Response struct for MerchantOssFilePost200Response
type MerchantOssFilePost200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantOssFilePost200ResponseData `json:"data,omitempty"`
...
func NewMerchantOssFilePost200Response() *MerchantOssFilePost200Response {
	this := MerchantOssFilePost200Response{}
	return &this
}
...
func (o *MerchantOssFilePost200Response) GetData() MerchantOssFilePost200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantOssFilePost200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantOssFilePost200ResponseData and assigns it to the Data field.
...
func (o MerchantOssFilePost200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantOssFilePost200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantOssFilePost200Response struct {
	value *MerchantOssFilePost200Response
	isSet bool
}

func (v NullableMerchantOssFilePost200Response) Get() *MerchantOssFilePost200Response {
	return v.value
}

func (v *NullableMerchantOssFilePost200Response) Set(val *MerchantOssFilePost200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantOssFilePost200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantOssFilePost200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantOssFilePost200Response(val *MerchantOssFilePost200Response) *NullableMerchantOssFilePost200Response {
	return &NullableMerchantOssFilePost200Response{value: val, isSet: true}
}

func (v NullableMerchantOssFilePost200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantOssFilePost200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
