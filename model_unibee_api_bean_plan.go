...
type UnibeeApiBeanPlan struct {
	...
	// Target plan id for auto-upgrade; stored in additional settings JSON; 0 if unset
	AutoUpgradePlanId *int64 `json:"autoUpgradePlanId,omitempty"`
	...
	// Checkout template id, stored in plan additional settings
	CheckoutTemplateId *int64 `json:"checkoutTemplateId,omitempty"`
	// CheckoutUrl built from checkoutTemplateId and planId
	CheckoutUrl *string `json:"checkoutUrl,omitempty"`
	// optional compare-at / strikethrough display price for regular plan amount in minor units (plan currency); UI only, not used in billing; stored in plan additional settings JSON with multiTrials
	...
	// 1=auto-charge off; for main recurring plans with amount>0 also 0=may auto-charge. Always 1 when amount=0 or plan type is not main (those plans never use subscription auto-charge).
	DisableAutoCharge *int32 `json:"disableAutoCharge,omitempty"`
	// external_user_id
	...
	MultiCurrencies []UnibeeApiBeanPlanMultiCurrency `json:"multiCurrencies,omitempty"`
	// multi-step trials for this plan; when non-empty, the first item also defines the effective trialAmount & trialDurationTime
	MultiTrials []UnibeeApiBeanPlanMultiTrial `json:"multiTrials,omitempty"`
	// PlanName
	...
	// price of trial period; may be overridden by multiTrials[0].trialPrice
	TrialAmount *int64 `json:"trialAmount,omitempty"`
	TrialDemand *string `json:"trialDemand,omitempty"`
	// duration of trial (seconds); may be overridden by multiTrials[0].trialDuration
...
// GetAutoUpgradePlanId returns the AutoUpgradePlanId field value if set, zero value otherwise.
func (o *UnibeeApiBeanPlan) GetAutoUpgradePlanId() int64 {
	if o == nil || IsNil(o.AutoUpgradePlanId) {
		var ret int64
		return ret
	}
	return *o.AutoUpgradePlanId
}

// GetAutoUpgradePlanIdOk returns a tuple with the AutoUpgradePlanId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UnibeeApiBeanPlan) GetAutoUpgradePlanIdOk() (*int64, bool) {
	if o == nil || IsNil(o.AutoUpgradePlanId) {
		return nil, false
	}
	return o.AutoUpgradePlanId, true
}
...
// SetAutoUpgradePlanId gets a reference to the given int64 and assigns it to the AutoUpgradePlanId field.
func (o *UnibeeApiBeanPlan) SetAutoUpgradePlanId(v int64) {
	o.AutoUpgradePlanId = &v
}
...
// GetCheckoutTemplateId returns the CheckoutTemplateId field value if set, zero value otherwise.
func (o *UnibeeApiBeanPlan) GetCheckoutTemplateId() int64 {
	if o == nil || IsNil(o.CheckoutTemplateId) {
		var ret int64
		return ret
	}
	return *o.CheckoutTemplateId
}

// GetCheckoutTemplateIdOk returns a tuple with the CheckoutTemplateId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UnibeeApiBeanPlan) GetCheckoutTemplateIdOk() (*int64, bool) {
	if o == nil || IsNil(o.CheckoutTemplateId) {
		return nil, false
	}
	return o.CheckoutTemplateId, true
}
...
// SetCheckoutTemplateId gets a reference to the given int64 and assigns it to the CheckoutTemplateId field.
func (o *UnibeeApiBeanPlan) SetCheckoutTemplateId(v int64) {
	o.CheckoutTemplateId = &v
}
...
// GetCompareAtAmount returns the CompareAtAmount field value if set, zero value otherwise.
func (o *UnibeeApiBeanPlan) GetCompareAtAmount() int64 {
	if o == nil || IsNil(o.CompareAtAmount) {
		var ret int64
		return ret
	}
	return *o.CompareAtAmount
}

// GetCompareAtAmountOk returns a tuple with the CompareAtAmount field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UnibeeApiBeanPlan) GetCompareAtAmountOk() (*int64, bool) {
	if o == nil || IsNil(o.CompareAtAmount) {
		return nil, false
	}
	return o.CompareAtAmount, true
}
...
// SetCompareAtAmount gets a reference to the given int64 and assigns it to the CompareAtAmount field.
...
// GetDisableAutoCharge returns the DisableAutoCharge field value if set, zero value otherwise.
func (o *UnibeeApiBeanPlan) GetDisableAutoCharge() int32 {
	if o == nil || IsNil(o.DisableAutoCharge) {
		var ret int32
		return ret
	}
	return *o.DisableAutoCharge
}

// GetDisableAutoChargeOk returns a tuple with the DisableAutoCharge field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UnibeeApiBeanPlan) GetDisableAutoChargeOk() (*int32, bool) {
	if o == nil || IsNil(o.DisableAutoCharge) {
		return nil, false
	}
	return o.DisableAutoCharge, true
}
...
// SetDisableAutoCharge gets a reference to the given int32 and assigns it to the DisableAutoCharge field.
func (o *UnibeeApiBeanPlan) SetDisableAutoCharge(v int32) {
	o.DisableAutoCharge = &v
}
...
// GetMultiCurrencies returns the MultiCurrencies field value if set, zero value otherwise.
func (o *UnibeeApiBeanPlan) GetMultiCurrencies() []UnibeeApiBeanPlanMultiCurrency {
	if o == nil || IsNil(o.MultiCurrencies) {
		var ret []UnibeeApiBeanPlanMultiCurrency
		return ret
	}
	return o.MultiCurrencies
}

// GetMultiCurrenciesOk returns a tuple with the MultiCurrencies field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UnibeeApiBeanPlan) GetMultiCurrenciesOk() ([]UnibeeApiBeanPlanMultiCurrency, bool) {
	if o == nil || IsNil(o.MultiCurrencies) {
		return nil, false
	}
	return o.MultiCurrencies, true
}
...
// SetMultiCurrencies gets a reference to the given []UnibeeApiBeanPlanMultiCurrency and assigns it to the MultiCurrencies field.
func (o *UnibeeApiBeanPlan) SetMultiCurrencies(v []UnibeeApiBeanPlanMultiCurrency) {
	o.MultiCurrencies = v
}

// GetMultiTrials returns the MultiTrials field value if set, zero value otherwise.
func (o *UnibeeApiBeanPlan) GetMultiTrials() []UnibeeApiBeanPlanMultiTrial {
	if o == nil || IsNil(o.MultiTrials) {
		var ret []UnibeeApiBeanPlanMultiTrial
		return ret
	}
	return o.MultiTrials
}

// GetMultiTrialsOk returns a tuple with the MultiTrials field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UnibeeApiBeanPlan) GetMultiTrialsOk() ([]UnibeeApiBeanPlanMultiTrial, bool) {
	if o == nil || IsNil(o.MultiTrials) {
		return nil, false
	}
	return o.MultiTrials, true
}
...
// SetMultiTrials gets a reference to the given []UnibeeApiBeanPlanMultiTrial and assigns it to the MultiTrials field.
...
func (o UnibeeApiBeanPlan) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.AutoUpgradePlanId) {
		toSerialize["autoUpgradePlanId"] = o.AutoUpgradePlanId
	}
	...
	if !IsNil(o.CheckoutTemplateId) {
		toSerialize["checkoutTemplateId"] = o.CheckoutTemplateId
	}
	if !IsNil(o.CheckoutUrl) {
		toSerialize["checkoutUrl"] = o.CheckoutUrl
	}
	if !IsNil(o.CompareAtAmount) {
		toSerialize["compareAtAmount"] = o.CompareAtAmount
	}
	...
	if !IsNil(o.DisableAutoCharge) {
		toSerialize["disableAutoCharge"] = o.DisableAutoCharge
	}
	...
	if !IsNil(o.MultiCurrencies) {
		toSerialize["multiCurrencies"] = o.MultiCurrencies
	}
	if !IsNil(o.MultiTrials) {
		toSerialize["multiTrials"] = o.MultiTrials
	}
	if !IsNil(o.PlanName) {
