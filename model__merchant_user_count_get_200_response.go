...
// checks if the MerchantUserCountGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantUserCountGet200Response{}

// MerchantUserCountGet200Response struct for MerchantUserCountGet200Response
type MerchantUserCountGet200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantUserCountGet200ResponseData `json:"data,omitempty"`
...
func NewMerchantUserCountGet200Response() *MerchantUserCountGet200Response {
	this := MerchantUserCountGet200Response{}
	return &this
}
...
func (o *MerchantUserCountGet200Response) GetData() MerchantUserCountGet200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantUserCountGet200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantUserCountGet200ResponseData and assigns it to the Data field.
func (o *MerchantUserCountGet200Response) SetData(v MerchantUserCountGet200ResponseData) {
	o.Data = &v
}

// GetMerchantId returns the MerchantId field value if set, zero value otherwise.
func (o *MerchantUserCountGet200Response) GetMerchantId() int64 {
...
// and a boolean to check if the value has been set.
func (o *MerchantUserCountGet200Response) GetMerchantIdOk() (*int64, bool) {
	if o == nil || IsNil(o.MerchantId) {
		return nil, false
	}
...
func (o *MerchantUserCountGet200Response) HasMerchantId() bool {
	if o != nil && !IsNil(o.MerchantId) {
		return true
	}
...
func (o *MerchantUserCountGet200Response) SetMerchantId(v int64) {
	o.MerchantId = &v
}
...
func (o MerchantUserCountGet200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantUserCountGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantUserCountGet200Response struct {
	value *MerchantUserCountGet200Response
	isSet bool
}

func (v NullableMerchantUserCountGet200Response) Get() *MerchantUserCountGet200Response {
	return v.value
}

func (v *NullableMerchantUserCountGet200Response) Set(val *MerchantUserCountGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantUserCountGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantUserCountGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantUserCountGet200Response(val *MerchantUserCountGet200Response) *NullableMerchantUserCountGet200Response {
	return &NullableMerchantUserCountGet200Response{value: val, isSet: true}
}

func (v NullableMerchantUserCountGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantUserCountGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
