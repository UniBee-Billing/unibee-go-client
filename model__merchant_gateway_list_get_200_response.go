...
// checks if the MerchantGatewayListGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantGatewayListGet200Response{}

// MerchantGatewayListGet200Response struct for MerchantGatewayListGet200Response
type MerchantGatewayListGet200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantGatewayListGet200ResponseData `json:"data,omitempty"`
...
func NewMerchantGatewayListGet200Response() *MerchantGatewayListGet200Response {
	this := MerchantGatewayListGet200Response{}
	return &this
}
...
func (o *MerchantGatewayListGet200Response) GetData() MerchantGatewayListGet200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantGatewayListGet200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantGatewayListGet200ResponseData and assigns it to the Data field.
...
func (o MerchantGatewayListGet200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantGatewayListGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantGatewayListGet200Response struct {
	value *MerchantGatewayListGet200Response
	isSet bool
}

func (v NullableMerchantGatewayListGet200Response) Get() *MerchantGatewayListGet200Response {
	return v.value
}

func (v *NullableMerchantGatewayListGet200Response) Set(val *MerchantGatewayListGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantGatewayListGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantGatewayListGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantGatewayListGet200Response(val *MerchantGatewayListGet200Response) *NullableMerchantGatewayListGet200Response {
	return &NullableMerchantGatewayListGet200Response{value: val, isSet: true}
}

func (v NullableMerchantGatewayListGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantGatewayListGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
