...
// checks if the MerchantCreditGetPromoConfigStatisticsGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantCreditGetPromoConfigStatisticsGet200Response{}

// MerchantCreditGetPromoConfigStatisticsGet200Response struct for MerchantCreditGetPromoConfigStatisticsGet200Response
type MerchantCreditGetPromoConfigStatisticsGet200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantCreditGetPromoConfigStatisticsGet200ResponseData `json:"data,omitempty"`
...
func NewMerchantCreditGetPromoConfigStatisticsGet200Response() *MerchantCreditGetPromoConfigStatisticsGet200Response {
	this := MerchantCreditGetPromoConfigStatisticsGet200Response{}
	return &this
}
...
func (o *MerchantCreditGetPromoConfigStatisticsGet200Response) GetData() MerchantCreditGetPromoConfigStatisticsGet200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantCreditGetPromoConfigStatisticsGet200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantCreditGetPromoConfigStatisticsGet200ResponseData and assigns it to the Data field.
...
func (o MerchantCreditGetPromoConfigStatisticsGet200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantCreditGetPromoConfigStatisticsGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantCreditGetPromoConfigStatisticsGet200Response struct {
	value *MerchantCreditGetPromoConfigStatisticsGet200Response
	isSet bool
}

func (v NullableMerchantCreditGetPromoConfigStatisticsGet200Response) Get() *MerchantCreditGetPromoConfigStatisticsGet200Response {
	return v.value
}

func (v *NullableMerchantCreditGetPromoConfigStatisticsGet200Response) Set(val *MerchantCreditGetPromoConfigStatisticsGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantCreditGetPromoConfigStatisticsGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantCreditGetPromoConfigStatisticsGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantCreditGetPromoConfigStatisticsGet200Response(val *MerchantCreditGetPromoConfigStatisticsGet200Response) *NullableMerchantCreditGetPromoConfigStatisticsGet200Response {
	return &NullableMerchantCreditGetPromoConfigStatisticsGet200Response{value: val, isSet: true}
}

func (v NullableMerchantCreditGetPromoConfigStatisticsGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantCreditGetPromoConfigStatisticsGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
