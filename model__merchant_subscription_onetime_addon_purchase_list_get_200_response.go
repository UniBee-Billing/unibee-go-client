...
// checks if the MerchantSubscriptionOnetimeAddonPurchaseListGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantSubscriptionOnetimeAddonPurchaseListGet200Response{}

// MerchantSubscriptionOnetimeAddonPurchaseListGet200Response struct for MerchantSubscriptionOnetimeAddonPurchaseListGet200Response
type MerchantSubscriptionOnetimeAddonPurchaseListGet200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantSubscriptionOnetimeAddonPurchaseListGet200ResponseData `json:"data,omitempty"`
...
func NewMerchantSubscriptionOnetimeAddonPurchaseListGet200Response() *MerchantSubscriptionOnetimeAddonPurchaseListGet200Response {
	this := MerchantSubscriptionOnetimeAddonPurchaseListGet200Response{}
	return &this
}
...
func (o *MerchantSubscriptionOnetimeAddonPurchaseListGet200Response) GetData() MerchantSubscriptionOnetimeAddonPurchaseListGet200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantSubscriptionOnetimeAddonPurchaseListGet200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantSubscriptionOnetimeAddonPurchaseListGet200ResponseData and assigns it to the Data field.
...
func (o MerchantSubscriptionOnetimeAddonPurchaseListGet200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantSubscriptionOnetimeAddonPurchaseListGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantSubscriptionOnetimeAddonPurchaseListGet200Response struct {
	value *MerchantSubscriptionOnetimeAddonPurchaseListGet200Response
	isSet bool
}

func (v NullableMerchantSubscriptionOnetimeAddonPurchaseListGet200Response) Get() *MerchantSubscriptionOnetimeAddonPurchaseListGet200Response {
	return v.value
}

func (v *NullableMerchantSubscriptionOnetimeAddonPurchaseListGet200Response) Set(val *MerchantSubscriptionOnetimeAddonPurchaseListGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantSubscriptionOnetimeAddonPurchaseListGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantSubscriptionOnetimeAddonPurchaseListGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantSubscriptionOnetimeAddonPurchaseListGet200Response(val *MerchantSubscriptionOnetimeAddonPurchaseListGet200Response) *NullableMerchantSubscriptionOnetimeAddonPurchaseListGet200Response {
	return &NullableMerchantSubscriptionOnetimeAddonPurchaseListGet200Response{value: val, isSet: true}
}

func (v NullableMerchantSubscriptionOnetimeAddonPurchaseListGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantSubscriptionOnetimeAddonPurchaseListGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
