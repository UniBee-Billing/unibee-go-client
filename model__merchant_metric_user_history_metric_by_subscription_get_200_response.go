...
// checks if the MerchantMetricUserHistoryMetricBySubscriptionGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantMetricUserHistoryMetricBySubscriptionGet200Response{}

// MerchantMetricUserHistoryMetricBySubscriptionGet200Response struct for MerchantMetricUserHistoryMetricBySubscriptionGet200Response
type MerchantMetricUserHistoryMetricBySubscriptionGet200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantMetricUserHistoryMetricBySubscriptionGet200ResponseData `json:"data,omitempty"`
...
func NewMerchantMetricUserHistoryMetricBySubscriptionGet200Response() *MerchantMetricUserHistoryMetricBySubscriptionGet200Response {
	this := MerchantMetricUserHistoryMetricBySubscriptionGet200Response{}
	return &this
}
...
func (o *MerchantMetricUserHistoryMetricBySubscriptionGet200Response) GetData() MerchantMetricUserHistoryMetricBySubscriptionGet200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantMetricUserHistoryMetricBySubscriptionGet200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantMetricUserHistoryMetricBySubscriptionGet200ResponseData and assigns it to the Data field.
...
func (o MerchantMetricUserHistoryMetricBySubscriptionGet200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantMetricUserHistoryMetricBySubscriptionGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantMetricUserHistoryMetricBySubscriptionGet200Response struct {
	value *MerchantMetricUserHistoryMetricBySubscriptionGet200Response
	isSet bool
}

func (v NullableMerchantMetricUserHistoryMetricBySubscriptionGet200Response) Get() *MerchantMetricUserHistoryMetricBySubscriptionGet200Response {
	return v.value
}

func (v *NullableMerchantMetricUserHistoryMetricBySubscriptionGet200Response) Set(val *MerchantMetricUserHistoryMetricBySubscriptionGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantMetricUserHistoryMetricBySubscriptionGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantMetricUserHistoryMetricBySubscriptionGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantMetricUserHistoryMetricBySubscriptionGet200Response(val *MerchantMetricUserHistoryMetricBySubscriptionGet200Response) *NullableMerchantMetricUserHistoryMetricBySubscriptionGet200Response {
	return &NullableMerchantMetricUserHistoryMetricBySubscriptionGet200Response{value: val, isSet: true}
}

func (v NullableMerchantMetricUserHistoryMetricBySubscriptionGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantMetricUserHistoryMetricBySubscriptionGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
