...
// checks if the MerchantCountryConfigListPost200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantCountryConfigListPost200Response{}

// MerchantCountryConfigListPost200Response struct for MerchantCountryConfigListPost200Response
type MerchantCountryConfigListPost200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantCountryConfigListPost200ResponseData `json:"data,omitempty"`
...
func NewMerchantCountryConfigListPost200Response() *MerchantCountryConfigListPost200Response {
	this := MerchantCountryConfigListPost200Response{}
	return &this
}
...
func (o *MerchantCountryConfigListPost200Response) GetData() MerchantCountryConfigListPost200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantCountryConfigListPost200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantCountryConfigListPost200ResponseData and assigns it to the Data field.
...
func (o MerchantCountryConfigListPost200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantCountryConfigListPost200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantCountryConfigListPost200Response struct {
	value *MerchantCountryConfigListPost200Response
	isSet bool
}

func (v NullableMerchantCountryConfigListPost200Response) Get() *MerchantCountryConfigListPost200Response {
	return v.value
}

func (v *NullableMerchantCountryConfigListPost200Response) Set(val *MerchantCountryConfigListPost200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantCountryConfigListPost200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantCountryConfigListPost200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantCountryConfigListPost200Response(val *MerchantCountryConfigListPost200Response) *NullableMerchantCountryConfigListPost200Response {
	return &NullableMerchantCountryConfigListPost200Response{value: val, isSet: true}
}

func (v NullableMerchantCountryConfigListPost200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantCountryConfigListPost200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
