...
type UnibeeApiBeanInvoiceItemSimplify struct {
	...
	PlanMetricChargeConfigs []UnibeeApiBeanInvoiceMetricCharge `json:"planMetricChargeConfigs,omitempty"`
	// Metric limit configurations bound to this plan/addon
	PlanMetricLimitConfigs []UnibeeApiBeanInvoiceMetricLimit `json:"planMetricLimitConfigs,omitempty"`
	...
	UstaxAlert *string `json:"ustaxAlert,omitempty"`
}
...
// GetPlanMetricChargeConfigs returns the PlanMetricChargeConfigs field value if set, zero value otherwise.
func (o *UnibeeApiBeanInvoiceItemSimplify) GetPlanMetricChargeConfigs() []UnibeeApiBeanInvoiceMetricCharge {
	if o == nil || IsNil(o.PlanMetricChargeConfigs) {
		var ret []UnibeeApiBeanInvoiceMetricCharge
		return ret
	}
	return o.PlanMetricChargeConfigs
}

// GetPlanMetricChargeConfigsOk returns a tuple with the PlanMetricChargeConfigs field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UnibeeApiBeanInvoiceItemSimplify) GetPlanMetricChargeConfigsOk() ([]UnibeeApiBeanInvoiceMetricCharge, bool) {
	if o == nil || IsNil(o.PlanMetricChargeConfigs) {
		return nil, false
	}
	return o.PlanMetricChargeConfigs, true
}
...
// SetPlanMetricChargeConfigs gets a reference to the given []UnibeeApiBeanInvoiceMetricCharge and assigns it to the PlanMetricChargeConfigs field.
func (o *UnibeeApiBeanInvoiceItemSimplify) SetPlanMetricChargeConfigs(v []UnibeeApiBeanInvoiceMetricCharge) {
	o.PlanMetricChargeConfigs = v
}

// GetPlanMetricLimitConfigs returns the PlanMetricLimitConfigs field value if set, zero value otherwise.
func (o *UnibeeApiBeanInvoiceItemSimplify) GetPlanMetricLimitConfigs() []UnibeeApiBeanInvoiceMetricLimit {
	if o == nil || IsNil(o.PlanMetricLimitConfigs) {
		var ret []UnibeeApiBeanInvoiceMetricLimit
		return ret
	}
	return o.PlanMetricLimitConfigs
}

// GetPlanMetricLimitConfigsOk returns a tuple with the PlanMetricLimitConfigs field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UnibeeApiBeanInvoiceItemSimplify) GetPlanMetricLimitConfigsOk() ([]UnibeeApiBeanInvoiceMetricLimit, bool) {
	if o == nil || IsNil(o.PlanMetricLimitConfigs) {
		return nil, false
	}
	return o.PlanMetricLimitConfigs, true
}
...
// SetPlanMetricLimitConfigs gets a reference to the given []UnibeeApiBeanInvoiceMetricLimit and assigns it to the PlanMetricLimitConfigs field.
func (o *UnibeeApiBeanInvoiceItemSimplify) SetPlanMetricLimitConfigs(v []UnibeeApiBeanInvoiceMetricLimit) {
	o.PlanMetricLimitConfigs = v
}
...
// GetUstaxAlert returns the UstaxAlert field value if set, zero value otherwise.
func (o *UnibeeApiBeanInvoiceItemSimplify) GetUstaxAlert() string {
	if o == nil || IsNil(o.UstaxAlert) {
		var ret string
		return ret
	}
	return *o.UstaxAlert
...
// GetUstaxAlertOk returns a tuple with the UstaxAlert field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UnibeeApiBeanInvoiceItemSimplify) GetUstaxAlertOk() (*string, bool) {
	if o == nil || IsNil(o.UstaxAlert) {
		return nil, false
	}
	return o.UstaxAlert, true
}
...
// SetUstaxAlert gets a reference to the given string and assigns it to the UstaxAlert field.
...
func (o UnibeeApiBeanInvoiceItemSimplify) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.PlanMetricChargeConfigs) {
		toSerialize["planMetricChargeConfigs"] = o.PlanMetricChargeConfigs
	}
	if !IsNil(o.PlanMetricLimitConfigs) {
		toSerialize["planMetricLimitConfigs"] = o.PlanMetricLimitConfigs
	}
	...
	if !IsNil(o.UstaxAlert) {
		toSerialize["ustaxAlert"] = o.UstaxAlert
	}
