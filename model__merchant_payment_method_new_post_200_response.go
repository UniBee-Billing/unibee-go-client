...
// checks if the MerchantPaymentMethodNewPost200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantPaymentMethodNewPost200Response{}

// MerchantPaymentMethodNewPost200Response struct for MerchantPaymentMethodNewPost200Response
type MerchantPaymentMethodNewPost200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantPaymentMethodNewPost200ResponseData `json:"data,omitempty"`
...
func NewMerchantPaymentMethodNewPost200Response() *MerchantPaymentMethodNewPost200Response {
	this := MerchantPaymentMethodNewPost200Response{}
	return &this
}
...
func (o *MerchantPaymentMethodNewPost200Response) GetData() MerchantPaymentMethodNewPost200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantPaymentMethodNewPost200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantPaymentMethodNewPost200ResponseData and assigns it to the Data field.
func (o *MerchantPaymentMethodNewPost200Response) SetData(v MerchantPaymentMethodNewPost200ResponseData) {
	o.Data = &v
}

// GetMerchantId returns the MerchantId field value if set, zero value otherwise.
func (o *MerchantPaymentMethodNewPost200Response) GetMerchantId() int64 {
...
// and a boolean to check if the value has been set.
func (o *MerchantPaymentMethodNewPost200Response) GetMerchantIdOk() (*int64, bool) {
	if o == nil || IsNil(o.MerchantId) {
		return nil, false
	}
...
func (o *MerchantPaymentMethodNewPost200Response) HasMerchantId() bool {
	if o != nil && !IsNil(o.MerchantId) {
		return true
	}
...
func (o *MerchantPaymentMethodNewPost200Response) SetMerchantId(v int64) {
	o.MerchantId = &v
}
...
func (o MerchantPaymentMethodNewPost200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantPaymentMethodNewPost200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantPaymentMethodNewPost200Response struct {
	value *MerchantPaymentMethodNewPost200Response
	isSet bool
}

func (v NullableMerchantPaymentMethodNewPost200Response) Get() *MerchantPaymentMethodNewPost200Response {
	return v.value
}

func (v *NullableMerchantPaymentMethodNewPost200Response) Set(val *MerchantPaymentMethodNewPost200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantPaymentMethodNewPost200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantPaymentMethodNewPost200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantPaymentMethodNewPost200Response(val *MerchantPaymentMethodNewPost200Response) *NullableMerchantPaymentMethodNewPost200Response {
	return &NullableMerchantPaymentMethodNewPost200Response{value: val, isSet: true}
}

func (v NullableMerchantPaymentMethodNewPost200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantPaymentMethodNewPost200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
