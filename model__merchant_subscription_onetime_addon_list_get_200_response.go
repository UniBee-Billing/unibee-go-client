...
// checks if the MerchantSubscriptionOnetimeAddonListGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantSubscriptionOnetimeAddonListGet200Response{}

// MerchantSubscriptionOnetimeAddonListGet200Response struct for MerchantSubscriptionOnetimeAddonListGet200Response
type MerchantSubscriptionOnetimeAddonListGet200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantSubscriptionOnetimeAddonListGet200ResponseData `json:"data,omitempty"`
...
func NewMerchantSubscriptionOnetimeAddonListGet200Response() *MerchantSubscriptionOnetimeAddonListGet200Response {
	this := MerchantSubscriptionOnetimeAddonListGet200Response{}
	return &this
}
...
func (o *MerchantSubscriptionOnetimeAddonListGet200Response) GetData() MerchantSubscriptionOnetimeAddonListGet200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantSubscriptionOnetimeAddonListGet200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantSubscriptionOnetimeAddonListGet200ResponseData and assigns it to the Data field.
...
func (o MerchantSubscriptionOnetimeAddonListGet200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantSubscriptionOnetimeAddonListGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantSubscriptionOnetimeAddonListGet200Response struct {
	value *MerchantSubscriptionOnetimeAddonListGet200Response
	isSet bool
}

func (v NullableMerchantSubscriptionOnetimeAddonListGet200Response) Get() *MerchantSubscriptionOnetimeAddonListGet200Response {
	return v.value
}

func (v *NullableMerchantSubscriptionOnetimeAddonListGet200Response) Set(val *MerchantSubscriptionOnetimeAddonListGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantSubscriptionOnetimeAddonListGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantSubscriptionOnetimeAddonListGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantSubscriptionOnetimeAddonListGet200Response(val *MerchantSubscriptionOnetimeAddonListGet200Response) *NullableMerchantSubscriptionOnetimeAddonListGet200Response {
	return &NullableMerchantSubscriptionOnetimeAddonListGet200Response{value: val, isSet: true}
}

func (v NullableMerchantSubscriptionOnetimeAddonListGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantSubscriptionOnetimeAddonListGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
