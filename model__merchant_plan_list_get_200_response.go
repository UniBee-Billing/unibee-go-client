...
// checks if the MerchantPlanListGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantPlanListGet200Response{}

// MerchantPlanListGet200Response struct for MerchantPlanListGet200Response
type MerchantPlanListGet200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantPlanListGet200ResponseData `json:"data,omitempty"`
...
func NewMerchantPlanListGet200Response() *MerchantPlanListGet200Response {
	this := MerchantPlanListGet200Response{}
	return &this
}
...
func (o *MerchantPlanListGet200Response) GetData() MerchantPlanListGet200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantPlanListGet200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantPlanListGet200ResponseData and assigns it to the Data field.
...
func (o MerchantPlanListGet200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantPlanListGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantPlanListGet200Response struct {
	value *MerchantPlanListGet200Response
	isSet bool
}

func (v NullableMerchantPlanListGet200Response) Get() *MerchantPlanListGet200Response {
	return v.value
}

func (v *NullableMerchantPlanListGet200Response) Set(val *MerchantPlanListGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantPlanListGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantPlanListGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantPlanListGet200Response(val *MerchantPlanListGet200Response) *NullableMerchantPlanListGet200Response {
	return &NullableMerchantPlanListGet200Response{value: val, isSet: true}
}

func (v NullableMerchantPlanListGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantPlanListGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
