...
type UnibeeApiMerchantSubscriptionCreateReq struct {
	...
	// CancelUrl, back to cancelUrl if creation cancelled
	...
	// Is free or not for the first period, true or false, high priority higher then trialEnd
	...
	// ReturnUrl, back to returnUrl if creation completed
