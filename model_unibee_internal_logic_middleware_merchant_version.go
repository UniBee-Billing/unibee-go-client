...
// checks if the UnibeeInternalLogicMiddlewareMerchantVersion type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UnibeeInternalLogicMiddlewareMerchantVersion{}

// UnibeeInternalLogicMiddlewareMerchantVersion struct for UnibeeInternalLogicMiddlewareMerchantVersion
type UnibeeInternalLogicMiddlewareMerchantVersion struct {
	...
	Plan *UnibeeInternalLogicMiddlewarePlan `json:"plan,omitempty"`
...
func NewUnibeeInternalLogicMiddlewareMerchantVersion() *UnibeeInternalLogicMiddlewareMerchantVersion {
	this := UnibeeInternalLogicMiddlewareMerchantVersion{}
	return &this
}
...
func (o *UnibeeInternalLogicMiddlewareMerchantVersion) GetPlan() UnibeeInternalLogicMiddlewarePlan {
	if o == nil || IsNil(o.Plan) {
		var ret UnibeeInternalLogicMiddlewarePlan
		return ret
	}
	return *o.Plan
}
...
// SetPlan gets a reference to the given UnibeeInternalLogicMiddlewarePlan and assigns it to the Plan field.
...
func (o UnibeeInternalLogicMiddlewareMerchantVersion) MarshalJSON() ([]byte, error) {
...
func (o UnibeeInternalLogicMiddlewareMerchantVersion) ToMap() (map[string]interface{}, error) {
...
type NullableUnibeeInternalLogicMiddlewareMerchantVersion struct {
	value *UnibeeInternalLogicMiddlewareMerchantVersion
	isSet bool
}

func (v NullableUnibeeInternalLogicMiddlewareMerchantVersion) Get() *UnibeeInternalLogicMiddlewareMerchantVersion {
	return v.value
}

func (v *NullableUnibeeInternalLogicMiddlewareMerchantVersion) Set(val *UnibeeInternalLogicMiddlewareMerchantVersion) {
	v.value = val
	v.isSet = true
}

func (v NullableUnibeeInternalLogicMiddlewareMerchantVersion) IsSet() bool {
	return v.isSet
}

func (v *NullableUnibeeInternalLogicMiddlewareMerchantVersion) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUnibeeInternalLogicMiddlewareMerchantVersion(val *UnibeeInternalLogicMiddlewareMerchantVersion) *NullableUnibeeInternalLogicMiddlewareMerchantVersion {
	return &NullableUnibeeInternalLogicMiddlewareMerchantVersion{value: val, isSet: true}
}

func (v NullableUnibeeInternalLogicMiddlewareMerchantVersion) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUnibeeInternalLogicMiddlewareMerchantVersion) UnmarshalJSON(src []byte) error {
	v.isSet = true
