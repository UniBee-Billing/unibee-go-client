...
type UnibeeApiBeanSubscription struct {
	...
	CancelOrExpireTime *int64 `json:"cancelOrExpireTime,omitempty"`
	...
	CurrentPeriodPaid *int64 `json:"currentPeriodPaid,omitempty"`
	...
	MultiTrial *UnibeeApiBeanSubscriptionMultiTrial `json:"multiTrial,omitempty"`
	// original_period_end, utc time
	OriginalPeriodEnd *int64 `json:"originalPeriodEnd,omitempty"`
...
// GetCancelOrExpireTime returns the CancelOrExpireTime field value if set, zero value otherwise.
func (o *UnibeeApiBeanSubscription) GetCancelOrExpireTime() int64 {
	if o == nil || IsNil(o.CancelOrExpireTime) {
		var ret int64
		return ret
	}
	return *o.CancelOrExpireTime
}

// GetCancelOrExpireTimeOk returns a tuple with the CancelOrExpireTime field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UnibeeApiBeanSubscription) GetCancelOrExpireTimeOk() (*int64, bool) {
	if o == nil || IsNil(o.CancelOrExpireTime) {
		return nil, false
	}
	return o.CancelOrExpireTime, true
}
...
// SetCancelOrExpireTime gets a reference to the given int64 and assigns it to the CancelOrExpireTime field.
func (o *UnibeeApiBeanSubscription) SetCancelOrExpireTime(v int64) {
	o.CancelOrExpireTime = &v
}
...
// GetCurrentPeriodPaid returns the CurrentPeriodPaid field value if set, zero value otherwise.
func (o *UnibeeApiBeanSubscription) GetCurrentPeriodPaid() int64 {
	if o == nil || IsNil(o.CurrentPeriodPaid) {
		var ret int64
		return ret
	}
	return *o.CurrentPeriodPaid
}

// GetCurrentPeriodPaidOk returns a tuple with the CurrentPeriodPaid field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UnibeeApiBeanSubscription) GetCurrentPeriodPaidOk() (*int64, bool) {
	if o == nil || IsNil(o.CurrentPeriodPaid) {
		return nil, false
	}
	return o.CurrentPeriodPaid, true
}
...
// SetCurrentPeriodPaid gets a reference to the given int64 and assigns it to the CurrentPeriodPaid field.
func (o *UnibeeApiBeanSubscription) SetCurrentPeriodPaid(v int64) {
	o.CurrentPeriodPaid = &v
}
...
// GetMultiTrial returns the MultiTrial field value if set, zero value otherwise.
func (o *UnibeeApiBeanSubscription) GetMultiTrial() UnibeeApiBeanSubscriptionMultiTrial {
	if o == nil || IsNil(o.MultiTrial) {
		var ret UnibeeApiBeanSubscriptionMultiTrial
		return ret
	}
	return *o.MultiTrial
}

// GetMultiTrialOk returns a tuple with the MultiTrial field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UnibeeApiBeanSubscription) GetMultiTrialOk() (*UnibeeApiBeanSubscriptionMultiTrial, bool) {
	if o == nil || IsNil(o.MultiTrial) {
		return nil, false
	}
	return o.MultiTrial, true
}
...
// SetMultiTrial gets a reference to the given UnibeeApiBeanSubscriptionMultiTrial and assigns it to the MultiTrial field.
...
// SetOriginalPeriodEnd gets a reference to the given int64 and assigns it to the OriginalPeriodEnd field.
...
func (o UnibeeApiBeanSubscription) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.CancelOrExpireTime) {
		toSerialize["cancelOrExpireTime"] = o.CancelOrExpireTime
	}
	...
	if !IsNil(o.CurrentPeriodPaid) {
		toSerialize["currentPeriodPaid"] = o.CurrentPeriodPaid
	}
	...
	if !IsNil(o.MultiTrial) {
		toSerialize["multiTrial"] = o.MultiTrial
	}
	if !IsNil(o.OriginalPeriodEnd) {
		toSerialize["originalPeriodEnd"] = o.OriginalPeriodEnd
	}
