...
type UnibeeApiBeanInvoicePlanSnapshot struct {
	...
	// Invoice source flag. True means the invoice snapshot comes from system auto-renew/auto-billing flow (createFrom=AutoRenew), not the final payment result.
	...
	MultiCurrencySnapshot *UnibeeApiBeanPlanMultiCurrencySnapshot `json:"multiCurrencySnapshot,omitempty"`
...
// GetMultiCurrencySnapshot returns the MultiCurrencySnapshot field value if set, zero value otherwise.
func (o *UnibeeApiBeanInvoicePlanSnapshot) GetMultiCurrencySnapshot() UnibeeApiBeanPlanMultiCurrencySnapshot {
	if o == nil || IsNil(o.MultiCurrencySnapshot) {
		var ret UnibeeApiBeanPlanMultiCurrencySnapshot
		return ret
	}
	return *o.MultiCurrencySnapshot
}

// GetMultiCurrencySnapshotOk returns a tuple with the MultiCurrencySnapshot field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UnibeeApiBeanInvoicePlanSnapshot) GetMultiCurrencySnapshotOk() (*UnibeeApiBeanPlanMultiCurrencySnapshot, bool) {
	if o == nil || IsNil(o.MultiCurrencySnapshot) {
		return nil, false
	}
	return o.MultiCurrencySnapshot, true
}
...
// SetMultiCurrencySnapshot gets a reference to the given UnibeeApiBeanPlanMultiCurrencySnapshot and assigns it to the MultiCurrencySnapshot field.
func (o *UnibeeApiBeanInvoicePlanSnapshot) SetMultiCurrencySnapshot(v UnibeeApiBeanPlanMultiCurrencySnapshot) {
	o.MultiCurrencySnapshot = &v
}
...
func (o UnibeeApiBeanInvoicePlanSnapshot) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.MultiCurrencySnapshot) {
		toSerialize["multiCurrencySnapshot"] = o.MultiCurrencySnapshot
	}
	if !IsNil(o.Plan) {
