...
type UnibeeApiMerchantDiscountUserDiscountListReq struct {
	...
	ChildCode *string `json:"childCode,omitempty"`
	// Count Of Per Page
...
// GetChildCode returns the ChildCode field value if set, zero value otherwise.
func (o *UnibeeApiMerchantDiscountUserDiscountListReq) GetChildCode() string {
	if o == nil || IsNil(o.ChildCode) {
		var ret string
		return ret
	}
	return *o.ChildCode
...
// GetChildCodeOk returns a tuple with the ChildCode field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UnibeeApiMerchantDiscountUserDiscountListReq) GetChildCodeOk() (*string, bool) {
	if o == nil || IsNil(o.ChildCode) {
		return nil, false
	}
	return o.ChildCode, true
}
...
// SetChildCode gets a reference to the given string and assigns it to the ChildCode field.
...
func (o UnibeeApiMerchantDiscountUserDiscountListReq) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ChildCode) {
		toSerialize["childCode"] = o.ChildCode
	}
	if !IsNil(o.Count) {
