...
// checks if the MerchantSubscriptionPaymentNewPost200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantSubscriptionPaymentNewPost200Response{}

// MerchantSubscriptionPaymentNewPost200Response struct for MerchantSubscriptionPaymentNewPost200Response
type MerchantSubscriptionPaymentNewPost200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantSubscriptionPaymentNewPost200ResponseData `json:"data,omitempty"`
...
func NewMerchantSubscriptionPaymentNewPost200Response() *MerchantSubscriptionPaymentNewPost200Response {
	this := MerchantSubscriptionPaymentNewPost200Response{}
	return &this
}
...
func (o *MerchantSubscriptionPaymentNewPost200Response) GetData() MerchantSubscriptionPaymentNewPost200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantSubscriptionPaymentNewPost200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantSubscriptionPaymentNewPost200ResponseData and assigns it to the Data field.
...
func (o *MerchantSubscriptionPaymentNewPost200Response) GetMerchantId() int64 {
...
// and a boolean to check if the value has been set.
func (o *MerchantSubscriptionPaymentNewPost200Response) GetMerchantIdOk() (*int64, bool) {
	if o == nil || IsNil(o.MerchantId) {
		return nil, false
	}
...
func (o *MerchantSubscriptionPaymentNewPost200Response) HasMerchantId() bool {
	if o != nil && !IsNil(o.MerchantId) {
		return true
	}
...
func (o *MerchantSubscriptionPaymentNewPost200Response) SetMerchantId(v int64) {
	o.MerchantId = &v
}
...
func (o MerchantSubscriptionPaymentNewPost200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantSubscriptionPaymentNewPost200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantSubscriptionPaymentNewPost200Response struct {
	value *MerchantSubscriptionPaymentNewPost200Response
	isSet bool
}

func (v NullableMerchantSubscriptionPaymentNewPost200Response) Get() *MerchantSubscriptionPaymentNewPost200Response {
	return v.value
}

func (v *NullableMerchantSubscriptionPaymentNewPost200Response) Set(val *MerchantSubscriptionPaymentNewPost200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantSubscriptionPaymentNewPost200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantSubscriptionPaymentNewPost200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantSubscriptionPaymentNewPost200Response(val *MerchantSubscriptionPaymentNewPost200Response) *NullableMerchantSubscriptionPaymentNewPost200Response {
	return &NullableMerchantSubscriptionPaymentNewPost200Response{value: val, isSet: true}
}

func (v NullableMerchantSubscriptionPaymentNewPost200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantSubscriptionPaymentNewPost200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
