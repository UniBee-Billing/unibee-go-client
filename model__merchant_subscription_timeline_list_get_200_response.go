...
// checks if the MerchantSubscriptionTimelineListGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantSubscriptionTimelineListGet200Response{}

// MerchantSubscriptionTimelineListGet200Response struct for MerchantSubscriptionTimelineListGet200Response
type MerchantSubscriptionTimelineListGet200Response struct {
	Code *int32 `json:"code,omitempty"`
	Data *MerchantSubscriptionTimelineListGet200ResponseData `json:"data,omitempty"`
...
func NewMerchantSubscriptionTimelineListGet200Response() *MerchantSubscriptionTimelineListGet200Response {
	this := MerchantSubscriptionTimelineListGet200Response{}
	return &this
}
...
func (o *MerchantSubscriptionTimelineListGet200Response) GetData() MerchantSubscriptionTimelineListGet200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MerchantSubscriptionTimelineListGet200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MerchantSubscriptionTimelineListGet200ResponseData and assigns it to the Data field.
...
func (o MerchantSubscriptionTimelineListGet200Response) MarshalJSON() ([]byte, error) {
...
func (o MerchantSubscriptionTimelineListGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantSubscriptionTimelineListGet200Response struct {
	value *MerchantSubscriptionTimelineListGet200Response
	isSet bool
}

func (v NullableMerchantSubscriptionTimelineListGet200Response) Get() *MerchantSubscriptionTimelineListGet200Response {
	return v.value
}

func (v *NullableMerchantSubscriptionTimelineListGet200Response) Set(val *MerchantSubscriptionTimelineListGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantSubscriptionTimelineListGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantSubscriptionTimelineListGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantSubscriptionTimelineListGet200Response(val *MerchantSubscriptionTimelineListGet200Response) *NullableMerchantSubscriptionTimelineListGet200Response {
	return &NullableMerchantSubscriptionTimelineListGet200Response{value: val, isSet: true}
}

func (v NullableMerchantSubscriptionTimelineListGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantSubscriptionTimelineListGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
