...
type UnibeeApiBeanPlanMultiCurrency struct {
	// exchanged amount preview for this plan & currency; plan-level override not available in billing logic
	Amount *int64 `json:"amount,omitempty"`
	// using https://app.exchangerate-api.com/ to update exchange rate if true, the exchange APIKey need setup first; plan-level override not available
	AutoExchange *bool `json:"autoExchange,omitempty"`
	// target currency
	Currency *string `json:"currency,omitempty"`
	// disable currency exchange for this plan & currency
	Disable *bool `json:"disable,omitempty"`
	// exchange rate; plan-level override not available, real billing FX always comes from merchant's multi-currency config
	ExchangeRate *float32 `json:"exchangeRate,omitempty"`
	// locked billing amount for this plan & currency; when > 0, locks the main plan price only
