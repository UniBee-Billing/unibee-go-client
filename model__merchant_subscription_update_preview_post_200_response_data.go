...
type MerchantSubscriptionUpdatePreviewPost200ResponseData struct {
	// Whether promo credit is effectively applied in this update preview.
	ApplyPromoCredit *bool `json:"applyPromoCredit,omitempty"`
	// Currency used for the update preview.
	Currency *string                            `json:"currency,omitempty"`
	Discount *UnibeeApiBeanMerchantDiscountCode `json:"discount,omitempty"`
	// Total discount amount applied to the update invoice, including promo credit if applicable.
	DiscountAmount *int64 `json:"discountAmount,omitempty"`
	// Human-readable message describing discount application result for the update.
	...
	// Original invoice amount before discounts and promo credit for the update, in minor units.
	OriginAmount *int64 `json:"originAmount,omitempty"`
	// Effective proration start time used in this preview, as UTC timestamp (seconds).
	ProrationDate *int64 `json:"prorationDate,omitempty"`
	// Final payable amount for the update invoice, including tax and after discounts, in minor units.
